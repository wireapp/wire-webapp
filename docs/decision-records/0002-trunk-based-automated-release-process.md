...
- Supersession discovery and cancellation are scoped to Release WebApp workflow runs in this repository. Unexpected or missing GitHub Actions state, or a failed cancellation request, fails closed and prevents later E2E or Production promotion rather than force-cancelling an uncertain run.
