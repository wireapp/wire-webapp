...
export function generateConfig(params: ConfigGeneratorParams, env: Env) {
  ...
  return {
    ...
    URL: {
      ...
      SUBPATH: {
        CREATE_TEAM: env.URL_SUBPATH_CREATE_TEAM,
        MANAGE_SERVICES: env.URL_SUBPATH_MANAGE_SERVICES,
        MANAGE_TEAM: env.URL_SUBPATH_MANAGE_TEAM,
        PASSWORD_RESET: env.URL_SUBPATH_PASSWORD_RESET,
        SUPPORT_USERNAME: env.URL_SUBPATH_SUPPORT_USERNAME,
      },
      SUPPORT: {
        ...
        PRIVACY_HOW: env.URL_SUPPORT_PRIVACY_HOW,
