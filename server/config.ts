...
const config: ServerConfig = {
  CLIENT: {
    ...
    OIDC_OAUTH_AUTHORIZATION_URI: process.env.OIDC_OAUTH_AUTHORIZATION_URI,
    OIDC_OAUTH_CLIENT_ID: process.env.OIDC_OAUTH_CLIENT_ID,
    OIDC_OAUTH_CLIENT_SECRET: process.env.OIDC_OAUTH_CLIENT_SECRET,
    OIDC_OAUTH_TOKEN_URI: process.env.OIDC_OAUTH_TOKEN_URI,
    URL: {
