...
describe('StringUtil', () => {
  ...
  describe('uuidToBytes', () => {
    it('converts a UUID to bytes', () => {
      ...
      // prettier-ignore
      const expected = Buffer.from([0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff])
  ...
  describe('bytesToUUID', () => {
    it('converts a UUID to bytes', () => {
      ...
      // prettier-ignore
      const uuid = Buffer.from([0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff])
