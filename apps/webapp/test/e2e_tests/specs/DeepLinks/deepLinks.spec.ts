...
test.describe('Deep Links', () => {
  ...
  test('Opening profile deep links as a team member', {tag: ['@TC-590', '@regression']}, async ({createTeam, createUser, createPage}) => {
  ...
  test('Opening profile deep links as a personal account', {tag: ['@TC-591', '@regression']}, async ({createTeam, createUser, createPage}) => {
