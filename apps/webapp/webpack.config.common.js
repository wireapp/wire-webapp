...
module.exports = {
  ...
  plugins: [
    ...
    new CopyPlugin({
      patterns: [
        ...
        // Copy the CoreCrypto browser wasm where initWasmModule('/min/index_bg.wasm') expects it.
        {
          from: path.resolve(ROOT_PATH, 'node_modules/@wireapp/core-crypto/dist/browser/autogenerated/wasm-bindgen/index_bg.wasm'),
  ...
  resolve: {
    alias: {
      '@wireapp/core-crypto/browser': path.resolve(
        ROOT_PATH,
        'node_modules/@wireapp/core-crypto/dist/browser/corecrypto.js',
      ),
