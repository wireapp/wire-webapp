...
const mockDesktopSettings = (isHardwareAccelerationEnabled: boolean): DesktopSettingsMock => ({
  isHardwareAccelerationEnabled: jest.fn().mockReturnValue(isHardwareAccelerationEnabled),
...
const setupDesktop = (isHardwareAccelerationEnabled: boolean): DesktopSettingsMock => {
  const desktopSettings = mockDesktopSettings(isHardwareAccelerationEnabled);
...
describe('CallOptions — hardware acceleration checkbox', () => {
  it('is not shown in a browser (non-desktop)', () => {
    ...
    const {queryByTestId} = render(withTheme(<CallOptions {...getDefaultProps()} />), {wrapper: rootProviderWrapper});
  ...
  it('is shown and checked when hardware acceleration is enabled', () => {
    ...
    const {getByTestId} = render(withTheme(<CallOptions {...getDefaultProps()} />), {wrapper: rootProviderWrapper});
