...
import {type Translate, t} from './localizerUtil';
...
const durationUnits = (translate: Translate = t) => [
  {
 ...
 */
const mapUnits = (duration: number, rounded: boolean, translate: Translate = t): DiscreteTimeUnit[] => {
 ...
 */
export const formatDuration = (duration: number, translate: Translate = t): DurationUnit => {
 ...
 */
export const formatDurationCaption = (duration: number, translate: Translate = t): string => {
...
export const formatDelayTime = (delayTimeInMS: number, translate: Translate = t): string => {
 ...
 */
export const formatCoarseDuration = (duration: number, translate: Translate = t) => {
 ...
 */
export const getDayPrefix = (daysDiff: number, timestamp: number, translate: Translate = t): string => {
  if (daysDiff === 0) {
