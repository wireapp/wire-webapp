...
const durationUnits = (translate: typeof t = t) => [
  {
 ...
 */
const mapUnits = (duration: number, rounded: boolean, translate: typeof t = t): DiscreteTimeUnit[] => {
 ...
 */
export const formatDuration = (duration: number, translate: typeof t = t): DurationUnit => {
 ...
 */
export const formatDurationCaption = (duration: number, translate: typeof t = t): string => {
...
export const formatDelayTime = (delayTimeInMS: number, translate: typeof t = t): string => {
 ...
 */
export const formatCoarseDuration = (duration: number, translate: typeof t = t) => {
 ...
 */
export const getDayPrefix = (daysDiff: number, timestamp: number, translate: typeof t = t): string => {
  if (daysDiff === 0) {
