...
describe('useMeetingNotificationStore', () => {
  ...
  it('stores every event independently in arrival order', () => {
    ...
    addNotification({kind: MeetingNotificationKind.CANCELLED, meetingTitle: 'Canceled meeting', organizer: 'Organizer', meetingTime: 'Jun 01, 09:00 AM'});
    addNotification({kind: MeetingNotificationKind.UPDATE, meetingTitle: 'Updated meeting', meetingTime: 'Jun 01, 09:00 AM'});
    addNotification({kind: MeetingNotificationKind.INVITE, meetingTitle: 'New meeting', organizer: 'Organizer', meetingTime: 'Jun 01, 09:00 AM'});
    addNotification({kind: MeetingNotificationKind.INVITE, meetingTitle: 'Another meeting', organizer: 'Organizer', meetingTime: 'Jun 01, 09:00 AM'});
    addNotification({kind: MeetingNotificationKind.UPDATE, meetingTitle: 'Updated meeting', meetingTime: 'Jun 01, 09:00 AM'});
    addNotification({kind: MeetingNotificationKind.CANCELLED, meetingTitle: 'Canceled meeting', organizer: 'Organizer', meetingTime: 'Jun 01, 09:00 AM'});
  ...
  it('dismisses only the selected notification by ID', () => {
    ...
    store.addNotification({kind: MeetingNotificationKind.INVITE, meetingTitle: 'Meeting', organizer: 'Organizer', meetingTime: 'Jun 01, 09:00 AM'});
    store.addNotification({kind: MeetingNotificationKind.INVITE, meetingTitle: 'Meeting', organizer: 'Organizer', meetingTime: 'Jun 01, 09:00 AM'});
