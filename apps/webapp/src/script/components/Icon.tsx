...
export const AboutIcon = (props: IconProps) => {
    return <svg width="16" height="14" viewBox="0 0 16 14" aria-hidden="true" {...props}>
...
export const AnimatedCheckIcon = (props: IconProps) => {
    return <svg width="16" height="12" viewBox="0 0 16 12" aria-hidden="true" {...props}>
...
export const ArchiveOutline = (props: IconProps) => {
	...
	<path stroke="#34373D" strokeWidth="1.25" d="M1.778 6.063v7.261c0 .926.796 1.676 1.778 1.676h8.889c.981 0 1.777-.75 1.777-1.676V6.063"></path>
	<path stroke="#34373D" strokeWidth="1.25" d="M3.196 2h9.608c.723 0 1.016.08 1.3.23.286.151.51.372.662.653.153.282.234.57.234 1.283v2.15H1v-2.15c0-.713.081-1.001.234-1.283a1.58 1.58 0 0 1 .661-.652C2.18 2.08 2.473 2 3.195 2Z" clipRule="evenodd"></path>
	<rect width="4" height="1" x="6" y="10" fill="#34373D" rx=".5"></rect>

      </svg>;
  };
export const ArrowDownLongIcon = (props: IconProps) => {
    return <svg width="16" height="53" viewBox="0 0 16 53" aria-hidden="true" {...props}>
...
export const ArrowLeftIcon = (props: IconProps) => {
    return <svg width="14" height="16" viewBox="0 0 14 16" aria-hidden="true" {...props}>
...
export const AudioIcon = (props: IconProps) => {
    return <svg width="12" height="16" viewBox="0 0 12 16" aria-hidden="true" {...props}>
...
export const AvailabilityAvailableIcon = (props: IconProps) => {
    return <svg width="10" height="10" viewBox="0 0 10 10" aria-hidden="true" {...props}>
...
export const ChevronIcon = (props: IconProps) => {
    return <svg width="7" height="4" viewBox="0 0 7 4" aria-hidden="true" {...props}>
...
export const ChevronRight = (props: IconProps) => {
    return <svg width="16" height="16" viewBox="0 0 16 16" aria-hidden="true" {...props}>
      <path clipRule="evenodd" d="m12.5355 8.03553-7.65681-7.656855-1.41421 1.414215 6.24264 6.24264-6.24264 6.24267 1.41421 1.4142z" fill="#000" fillRule="evenodd"></path>
      </svg>;
  };
...
<path fillRule="evenodd" clipRule="evenodd" d="M2.28571 1C1.65453 1 1.0831 1.22386 0.66947 1.58579C0.52867 1.70899 0.406153 1.84819 0.305788 2C0.129736 2.2663 0.0218406 2.57141 0.00297416 2.89708C0.000999365 2.93117 0 2.96548 0 3V13C0 14.1046 1.02335 15 2.28571 15H13.7143C14.9767 15 16 14.1046 16 13L16 3C16 1.89543 14.9767 1 13.7143 1H2.28571ZM2 8V3L14 3V13L9 13V9C9 8.44772 8.55229 8 8 8H2Z" fill="black"></path>
</g>
<defs >
...
export const CloseIcon = (props: IconProps) => {
    return <svg width="14" height="14" viewBox="0 0 14 14" aria-hidden="true" {...props}>
...
export const ConversationsOutline = (props: IconProps) => {
	...
	<path stroke="#34373D" strokeWidth="1.25" d="M12.22 1H3.78A2.78 2.78 0 0 0 1 3.78v5.012a2.78 2.78 0 0 0 2.78 2.78h.45v3.345c0 .234.272.363.454.216l4.393-3.56h3.142A2.78 2.78 0 0 0 15 8.792V3.781A2.78 2.78 0 0 0 12.22 1Z"></path>
...
export const DiscloseIcon = (props: IconProps) => {
    return <svg width="5" height="8" viewBox="0 0 5 8" aria-hidden="true" {...props}>
...
export const DraftMessageIcon = (props: IconProps) => {
    return <svg width="12" height="12" viewBox="0 0 12 12" aria-hidden="true" {...props}>
      
  <path d="M2.87689 5.43553L4.57879 7.13593C4.61703 7.17414 4.69352 7.17414 4.73177 7.13593L9.97132 1.8819C10.0096 1.84369 10.0096 1.76726 9.97132 1.72905L8.26942 0.0286583C8.23117 -0.00955278 8.15468 -0.00955278 8.11644 0.0286583L2.85777 5.28269C2.83865 5.3209 2.83865 5.39732 2.87689 5.43553Z" fill="#34373D"></path>
  <path d="M3.56544 8.1509L1.15601 8.99155C1.0604 9.02976 0.983907 8.93423 1.00303 8.8387L1.84442 6.4314C1.86354 6.35498 1.97827 6.33587 2.03564 6.39319L3.60368 7.95985C3.68017 8.01716 3.66105 8.11269 3.56544 8.1509Z" fill="#34373D"></path>
  <path d="M12 11.0462V11.959C12 11.9795 11.915 12 11.8301 12L0.169912 11.9949C0.0849558 11.9949 0 11.9744 0 11.9538V11.041C0 11.0205 0.0849558 11 0.169912 11L11.8513 11C11.915 11.0051 12 11.0256 12 11.0462Z" fill="#34373D"></path>
...
export const EllipsisIcon = (props: IconProps) => {
    return <svg width="16" height="4" viewBox="0 0 16 4" aria-hidden="true" {...props}>
...
<path fillRule="evenodd" clipRule="evenodd" d="M8 16C12.4183 16 16 12.4183 16 8C16 3.58172 12.4183 0 8 0C3.58172 0 0 3.58172 0 8C0 12.4183 3.58172 16 8 16ZM8 14C11.3137 14 14 11.3137 14 8C14 4.68629 11.3137 2 8 2C4.68629 2 2 4.68629 2 8C2 11.3137 4.68629 14 8 14ZM9 4V9H7V4H9ZM9 12V10H7V12H9Z" fill="#C20013"></path>
...
export const FoldersOutline = (props: IconProps) => {
	...
	<path stroke="#34373D" strokeWidth="1.25" d="M5.416 2.222H2.333a1 1 0 0 0-1 1v9a2 2 0 0 0 2 2h9.334a2 2 0 0 0 2-2V6.444a2 2 0 0 0-2-2h-3.86a1 1 0 0 1-.64-.231l-2.111-1.76a1 1 0 0 0-.64-.23Z"></path>
...
export const GifIcon = (props: IconProps) => {
    return <svg width="16" height="13" viewBox="0 0 16 13" aria-hidden="true" {...props}>
...
export const GroupAdminIcon = (props: IconProps) => {
  ...
  <path d="M13.82 0C15.02 0 16 .97 16 2.18v8.21c0 1.2-.97 2.18-2.18 2.18H4.26L0 16V2.18C0 .98.97 0 2.18 0zM6.37 2.37c-.12-.12-.23-.1-.33-.04l-.8.48c-.13.07-.17.16-.14.31.14.9-.17 1.67-.95 2.33a.87.87 0 01-.12.09c-.1.06-.23.1-.34.15l-.03.01a.5.5 0 00-.08.04c-.1.05-.14.13-.14.25v.61L3.43 7c0 .14.05.23.18.28.46.17.82.5 1.11 1.04.3.53.38 1.06.26 1.63-.03.12.01.21.12.28.3.2.56.37.83.53.03.03.08.04.12.05.04 0 .08 0 .11-.03a.32.32 0 00.07-.06c.1-.1.2-.18.31-.25.35-.2.84-.3 1.32-.25.5.05.93.25 1.18.54.03.04.08.07.13.1h.06c.06 0 .13-.01.18-.05l.38-.23.39-.22c.18-.11.17-.25.15-.36-.1-.39-.03-.88.2-1.35.21-.47.54-.86.9-1.07.12-.07.24-.12.36-.15.06-.01.13-.04.17-.13A62.17 62.17 0 0012 6.13c0-.12-.05-.2-.16-.25a2.1 2.1 0 01-1.16-1.1 2.3 2.3 0 01-.23-1.56c.03-.14-.01-.24-.13-.3l-.28-.2L10 2.7l-.46-.3a.25.25 0 00-.28 0 .51.51 0 00-.07.05l-.03.02c-.09.08-.19.16-.3.22a2.7 2.7 0 01-1.24.26 1.94 1.94 0 01-1.24-.57zm1.34 2.2a2 2 0 110 4 2 2 0 010-4z" fillRule="nonzero"></path>
...
export const HangupIcon = (props: IconProps) => {
    return <svg width="20" height="8" viewBox="0 0 20 8" aria-hidden="true" {...props}>
...
export const LogoFullIcon = (props: IconProps) => {
    return <svg width="78" height="25" viewBox="0 0 78 25" aria-hidden="true" {...props}>
...
export const LogoIcon = (props: IconProps) => {
    return <svg width="48" height="39" viewBox="0 0 48 39" aria-hidden="true" {...props}>
...
export const MarkdownIcon = (props: IconProps) => {
    return <svg width="15" height="14" viewBox="0 0 15 14" aria-hidden="true" {...props}>
...
export const MessageUnreadIcon = (props: IconProps) => {
    return <svg width="18" height="18" viewBox="0 0 18 18" aria-hidden="true" {...props}>
...
export const MinusIcon = (props: IconProps) => {
    return <svg width="16" height="2" viewBox="0 0 16 2" aria-hidden="true" {...props}>
...
export const NotVerifiedIcon = (props: IconProps) => {
  ...
  <path fill="#0097F8" d="M14 1.9V8c0 4-3 7-7 8-4-1-7-4-7-8V2l7-2 7 1.9zm-7-1L.8 2.5V8c0 3.4 2.5 6.3 6.2 7.2V.8z"></path>
...
<path fillRule="evenodd" clipRule="evenodd" d="M8 1C7.44772 1 7 1.44772 7 2V6C7 6.55228 7.44772 7 8 7H14C14.5523 7 15 6.55228 15 6V2C15 1.44772 14.5523 1 14 1H8ZM0.66947 3.58579C1.0831 3.22386 1.65453 3 2.28571 3H5V5H2V13H12V9H14V13C14 14.1046 12.9767 15 11.7143 15H2.28571C1.02335 15 0 14.1046 0 13V5C0 4.96548 0.000999365 4.93117 0.00297416 4.89708C0.0218406 4.57141 0.129736 4.2663 0.305788 4C0.406153 3.84819 0.52867 3.70899 0.66947 3.58579Z" fill="black"></path>
...
export const ReplyIcon = (props: IconProps) => {
    return <svg width="16" height="15" viewBox="0 0 16 15" aria-hidden="true" {...props}>
...
export const ServiceIcon = (props: IconProps) => {
    return <svg width="32" height="32" viewBox="0 0 32 32" aria-hidden="true" {...props}>
...
export const ShieldIcon = (props: IconProps) => {
    ...
    <path fillRule="evenodd" clipRule="evenodd" d="M14 8V1.87197L7 0L0 2V8C0 12 3.00718 15.0977 7 16C11.0344 15.0977 14 12 14 8ZM6.98678 1.55625L7 1.56002V14.4558L6.99817 14.4563C3.68611 13.589 1.5 11.0575 1.5 8L1.5 3.02354L6.98678 1.55625Z" fill="#34373D"></path>
...
export const TimerIcon = (props: IconProps) => {
    return <svg width="15" height="16" viewBox="0 0 15 16" aria-hidden="true" {...props}>
