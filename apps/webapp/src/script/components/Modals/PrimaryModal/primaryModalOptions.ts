...
type PrimaryModalOptionsParameters = {};

export function createPrimaryModalOptions(parameters: PrimaryModalOptionsParameters): ModalOptions {
  return {} as ModalOptions;
}
