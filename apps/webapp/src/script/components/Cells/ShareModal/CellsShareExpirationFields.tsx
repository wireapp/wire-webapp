...
export const CellsShareExpirationFields = ({
  ...
  const isExpirationInvalid = useMemo(
    () =>
      Boolean(selectedDateTime !== null && selectedDateTime !== undefined && selectedDateTime.getTime() < Date.now()),
    [selectedDateTime],
  );
      ...
      <div css={expirationFieldsRowStyles} role="group" aria-labelledby={labelId}>
        <I18nProvider locale="de-DE">
          <DatePicker aria-label={labels.dateAriaLabel} value={selectedDate} onChange={setSelectedDate}>
            ...
            <Popover
              ...
              shouldFlip={false}
              offset={8}
              {...(portalContainer !== null && portalContainer !== undefined ? {portalContainer} : {})}
            >
              <Dialog>
                <Calendar>
        ...
        <div css={timeSelectWrapperStyles}>
          ...
          <Select
            ...
            {...(portalContainer !== null && portalContainer !== undefined && {menuPortalTarget: portalContainer})}
            onChange={option => {
