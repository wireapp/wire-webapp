...
const markdownCharacterizationTestCases: MarkdownCharacterizationTestCase[] = [
  ...
  {
    description: 'inline formatting around punctuation',
    inputMarkdown: '**bold**, *italic*! ~~strike~~.',
    expectedMarkdown: '**bold**, *italic*! ~~strike~~.',
    expectedTextContent: 'bold, italic! strike.',
  },
  {
    description: 'Unicode and emoji inside inline formatting',
    inputMarkdown: '**café 😀**',
    expectedMarkdown: '**café 😀**',
    expectedTextContent: 'café 😀',
  },
  {
    description: 'escaped formatting markers',
    inputMarkdown: '\\*not italic\\*',
    expectedMarkdown: '\\*not italic\\*',
    expectedTextContent: '\\not italic\\',
  },
  {
    description: 'an unmatched formatting marker',
    inputMarkdown: '**unmatched',
    expectedMarkdown: '**unmatched',
    expectedTextContent: '**unmatched',
  },
  {
    description: 'empty formatting markers',
    inputMarkdown: '****',
    expectedMarkdown: '****',
    expectedTextContent: '****',
  },
  {
    description: 'formatting markers separated by a line break',
    inputMarkdown: '**first\nsecond**',
    expectedMarkdown: '**first\nsecond**',
    expectedTextContent: '**first\nsecond**',
  },
...
const markdownRoundTripCharacterizationTestCases: readonly MarkdownRoundTripCharacterizationTestCase[] = [
  ...
  },
  {
    description: 'inline formatting around punctuation',
    inputMarkdown: '**bold**, *italic*! ~~strike~~.',
    expectedCanonicalMarkdown: '**bold**, *italic*! ~~strike~~.',
    expectedTextContent: 'bold, italic! strike.',
  },
  {
    description: 'Unicode and emoji inside inline formatting',
    inputMarkdown: '**café 😀**',
    expectedCanonicalMarkdown: '**café 😀**',
    expectedTextContent: 'café 😀',
  },
  {
    description: 'escaped formatting markers',
    inputMarkdown: '\\*not italic\\*',
    expectedCanonicalMarkdown: '\\*not italic\\*',
    expectedTextContent: '\\not italic\\',
  },
  {
    description: 'an unmatched formatting marker',
    inputMarkdown: '**unmatched',
    expectedCanonicalMarkdown: '**unmatched',
    expectedTextContent: '**unmatched',
  },
  {
    description: 'empty formatting markers',
