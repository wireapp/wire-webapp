 ...
 *
 * BackgroundEffectsRenderingPipeline selection priority:
...
export class BackgroundEffectsController {
  ...
  private pipelineImpl: BackgroundEffectsRenderingPipeline | null = null;
  ...
  /** BackgroundEffectsRenderingPipeline to attempt to restore after context loss. */
