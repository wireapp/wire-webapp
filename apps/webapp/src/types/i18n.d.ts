...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'inviteMessage': `I’m on {brandName}, search for {username} or visit wire.com/en/app-download.`;
    'inviteMessageNoEmail': `I’m on {brandName}. Visit wire.com/en/app-download to connect with me.`;
