...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'cells.newItemMenu.document': `Document`;
    ...
    'meetings.scheduleModal.closeAriaLabel': `Close`;
    'meetings.scheduleModal.confirmChanges': `Confirm changes`;
    'meetings.scheduleModal.editTitle': `Edit Meeting`;
    'meetings.scheduleModal.endsLabel': `Ends`;
    'meetings.scheduleModal.error.endBeforeStart': `End time must be after start time`;
    'meetings.scheduleModal.error.titleRequired': `Title is required`;
    'meetings.scheduleModal.error.createFailedTitle': `Could not schedule meeting`;
    'meetings.scheduleModal.error.createFailed': `Something went wrong while scheduling the meeting. Please try again.`;
    'meetings.scheduleModal.error.participantMissingEmail': `One or more selected participants do not have an email address and cannot be invited.`;
    ...
    'meetings.scheduleModal.participantsPlaceholder': `Enter a name`;
    'meetings.scheduleModal.participantsSelectedSummaryOverflow': `{name1}, {name2}, {initial}... +{count} more`;
    'meetings.scheduleModal.participantsSelectedSummaryTwo': `{name1}, {name2}`;
    'meetings.scheduleModal.previousMonthAriaLabel': `Previous month`;
    'meetings.scheduleModal.recurrence.daily': `Daily`;
    'meetings.scheduleModal.recurrence.doesNotRepeat': `Does not repeat`;
    'meetings.scheduleModal.recurrence.everyTwoWeeks': `Every two weeks`;
    'meetings.scheduleModal.recurrence.monthly': `Monthly`;
    'meetings.scheduleModal.recurrence.weekly': `Weekly`;
    'meetings.scheduleModal.repeatsLabel': `Repeats`;
    'meetings.scheduleModal.scheduleTitle': `Schedule a meeting`;
    'meetings.scheduleModal.startsLabel': `Starts`;
    'meetings.scheduleModal.timeSelectAriaLabel': `Select time`;
    'meetings.scheduleModal.titleLabel': `Title`;
    'meetings.scheduleModal.titlePlaceholder': `Enter a title`;
