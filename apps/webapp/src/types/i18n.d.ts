...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'leaveGroupAdminModalMessageNoEligible': `You\'re currently the only admin in this group with no other participant eligible to be promoted as admin. <br/>Add at least one additional admin, after that you can leave this group. If you no longer need the group or its content, consider deleting it instead.`;
    'leaveGroupAdminModalMessageWithEligible': `You\'re currently the only admin in this group. To prevent the group from being left without management after you leave, promote another participant to admin. <br/>If you no longer need the group or its content, consider deleting it instead.`;
