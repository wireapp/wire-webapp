...
export function generateConfig(params: ConfigGeneratorParams, env: Env) {
  ...
  return {
    ...
    MAX_API_VERSION: Number(env.MAX_API_VERSION) || 16,
    ENVIRONMENT: nodeEnv,
    FEATURE: {
      ...
      MULTICLASS_MODEL_PATH: env.FEATURE_MULTICLASS_MODEL_PATH,
    ...
    URL: {
      ...
      SUPPORT: {
        ...
        BACKGROUND_EFFECTS: env.URL_SUPPORT_BACKGROUND_EFFECTS,
      },
