...
export const handleMLSMessageAdd = async ({
  ...
  if (encodedSenderClientId !== null && encodedSenderClientId !== undefined) {
  ...
  return message !== null && message !== undefined ? {event, decryptedData: GenericMessage.decode(message)} : null;
};
