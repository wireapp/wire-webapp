...
export const onBackFromSleep = ({
  ...
  const tid = setInterval(() => {
    ...
    if (isDisconnectedCallback !== null && isDisconnectedCallback !== undefined && isDisconnectedCallback()) {
      wasDisconnected = true;
    }

    if (wasAsleep) {
      if (isDisconnectedCallback === null || isDisconnectedCallback === undefined || wasDisconnected) {
