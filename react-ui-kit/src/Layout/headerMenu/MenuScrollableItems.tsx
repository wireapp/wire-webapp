...
const menuScrollableItemsStyle: <T>(props: MenuScrollableItemsProps<T>) => ObjectInterpolation<undefined> = props => ({
...
export {MenuScrollableItems, menuScrollableItemsStyle};
