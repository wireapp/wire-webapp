...
- **Coding Standards:** https://github.com/wireapp/wire-webapp/docs/coding-standards.md
- **Tech Radar:** https://github.com/wireapp/wire-webapp/docs/tech-radar.md
...
- For imports/TS/React/testing/naming/readability: **refer to** the [Coding Standards](https://github.com/wireapp/wire-webapp/docs/coding-standards.md).
  - If a standard is violated, link the relevant section and suggest a minimal change.

### Technology choices

- Compare any new dependencies in `package.json`/lockfiles to the [Tech Radar](https://github.com/wireapp/wire-webapp/docs/tech-radar.md).
