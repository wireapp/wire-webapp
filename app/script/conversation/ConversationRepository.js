...
z.conversation.ConversationRepository = class ConversationRepository {
  ...
  constructor(
    ...
    this.conversations_archived = ko.pureComputed(() =>
      this.active_team().conversations_archived(),
    );
    this.conversations_calls = ko.pureComputed(() =>
      this.active_team().conversations_calls(),
    );
    this.conversations_cleared = ko.pureComputed(() =>
      this.active_team().conversations_cleared(),
    );
    this.conversations_unarchived = ko.pureComputed(() =>
      this.active_team().conversations_unarchived(),
    );
  ...
  */
  ...
  update_conversations_offline() {
    this.sorted_conversations().map(conversation_et =>
  ...
  map_guest_status() {
    this.filtered_conversations().forEach(conversation_et =>
      this._map_guest_status(conversation_et),
    );
  }
  ...
  send_gif(conversation_et, url, tag) {
    ...
    return z.util.load_url_blob(url).then(blob => {
      this.send_text(
        z.l10n.text(z.string.extensions_giphy_message, tag),
        conversation_et,
      );
