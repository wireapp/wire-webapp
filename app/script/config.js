...
window.z.config = {
  ...
  URL: {
    ACCOUNT: {
      PRODUCTION: window.EXTERNAL.ACCOUNT_BASE || 'https://account.wire.com',
      STAGING: 'https://wire-account-staging.zinfra.io',
    },
    SUPPORT: 'https://support.wire.com',
    TEAM_SETTINGS: {
      PRODUCTION: window.EXTERNAL.TEAMS_BASE || 'https://teams.wire.com',
    ...
    WEBSITE: {
      PRODUCTION: window.EXTERNAL.WEBSITE_BASE || 'https://wire.com',
