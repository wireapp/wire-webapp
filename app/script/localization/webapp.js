...
z.string.auth_blocked_database =
...
z.string.modal_block_conversation_message =
  '{{user}} won’t be able to contact you or add you to group conversations.';
...
z.string.modal_too_many_members_message =
  'Up to {{number1}} people can join a conversation. There is room for {{number2}} more people in here.';
// Parallel uploads
z.string.modal_uploads_parallel =
  'You can send up to {{number}} files at once.';
...
z.string.conversation_unable_to_decrypt_1 =
  'a message from {{user}}was not received.';
z.string.conversation_unable_to_decrypt_2 =
  '{{user}}´s device identity changed. Undelivered message.';
...
z.string.conversation_asset_upload_too_large =
  'You can send files up to {{number}}';
...
z.string.conversation_delete_timestamp = 'Deleted on {{date}}';
...
z.string.people_tabs_devices_headline =
  'Wire gives every device a unique fingerprint. Compare them with {{user}} and verify your conversation.';
z.string.people_tabs_devices_why_verify = 'Why verify conversation?';
z.string.people_tabs_no_devices_headline =
  '{{user}} is using an old version of Wire. No devices are shown here.';
...
z.string.people_tabs_device_detail_headline =
  'Verify that this matches the fingerprint shown on {{html1}}{{user}}’s device{{html2}}.';
...
z.string.people_remove_message =
  '{{user}} won’t be able to send or receive messages in this conversation.';

// Unblock user
z.string.people_unblock_headline = 'Unblock?';
z.string.people_unblock_message =
  '{{user}} will be able to contact you and add you to group conversations again.';
...
z.string.preferences_options_emoji_replace_checkbox =
  'Replace type emoticons with emojis';
z.string.preferences_options_emoji_replace_detail = ':-) → {{icon}}';
z.string.preferences_options_previews_send_checkbox = 'Send link previews';
z.string.preferences_options_previews_send_detail =
  'Generate preview of link content.';
...
z.string.warning_call_unsupported_incoming =
  '{{user}} is calling. Your browser doesn’t support calls.';
...
z.string.warning_permission_request_notification =
  '{{icon}} Allow notifications';
...
z.string.system_notification_conversation_rename =
  '{{user}} renamed the conversation to {{name}}';
z.string.system_notification_member_join_many =
  '{{user}} added {{number}} people to the conversation';
z.string.system_notification_member_join_one =
  '{{user1}} added {{user2}} to the conversation';
z.string.system_notification_member_leave_removed_you =
  '{{user}} removed you from the conversation';
...
z.string.tooltip_conversations_tooltip_start =
  'Start conversation ({{shortcut}})';
