...
z.string.preferencesAccountDataDetail = 'Help make Wire better by sending usage and crash reports.';
z.string.preferencesAccountDelete = 'Delete account';
z.string.preferencesAccountExportPersonalInfoHeadline = 'Export personal information';
z.string.preferencesAccountExportPersonalInfoSecondary = 'This includes all the data related to your account';
...
z.string.preferencesAccountReceiveNewsCheckbox = 'Receive news and offers';
z.string.preferencesAccountReceiveNewsDetail = 'We may use external services like Salesforce and Marketo to process your data. You may still recieve other messages from us.';
