...
z.string.conversationCreateWith = 'with [bold]{{users}}[/bold]';
...
z.string.conversationCreated = '[bold]{{name}}}[/bold] started a conversation with [bold]{{users}}[/bold] and [showmore]{{count}} more[/showmore]';
z.string.conversationCreatedMore = '[bold]{{name}}}[/bold] started a conversation with [bold]{{users}}[/bold] and [showmore]{{count}} more[/showmore]';
...
z.string.conversationCreatedYou = 'You started a conversation with [bold]{{users}}[/bold]';
z.string.conversationCreatedYouMore = 'You started a conversation with [bold]{{users}}[/bold] and [showmore]{{count}} more[/showmore]';
z.string.conversationCreateWithMore = 'with [bold]{{users}}[/bold] and [showmore]{{count}} more[/showmore]';
...
z.string.conversationMemberJoined = '[bold]{{name}}[/bold] added [bold]{{users}}[/bold] to the conversation';
z.string.conversationMemberJoinedYou = '[bold]You[/bold] added [bold]{{users}}[/bold] to the conversation';
z.string.conversationMemberJoinedMore = '[bold]{{name}}[/bold] added [bold]{{users}}[/bold] and [showmore]{{count}} more[/showmore] to the conversation';
z.string.conversationMemberJoinedYouMore = '[bold]You[/bold] added [bold]{{users}}[/bold] and [showmore]{{count}} more[/showmore] to the conversation';
