...
z.string.preferences_options_inline_emoji_checkbox = 'Inline replacement';
z.string.preferences_options_inline_emoji_detail = 'Replace ASCII emoticons with emojis while typing, e.g. :-) → 🙂';
