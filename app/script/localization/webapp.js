...
z.string.conversationCreated = '[bold]{{name}}}[/bold] started a conversation with {{users}} and [showmore]{{count}} more[/showmore]';
...
z.string.conversationCreatedYouMore = 'You started a conversation with {{users}}';
