...
z.string.conversationsSecondaryLineEphemeralReplyGroup = 'Someone replied to your message';
...
z.string.notificationMention = 'New mention: {{text}}';
...
z.string.notificationReply = 'Reply from {{user}}: {{text}}';
