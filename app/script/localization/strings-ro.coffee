...
z.string.ro.auth_account_remember_me = 'Ține minte'
...
z.string.ro.invite_detail = 'Linkul poate fi folosit timp de 2 săptămâni.'
...
z.string.ro.preferences_devices_remove_detail = 'Elimină acest dispozitiv dacă nu-l mai folosești. Istoricul mesajelor va fi șters și tu vei fi deconectat.'
...
z.string.ro.preferences_options_sound = 'Alerte sonore'
z.string.ro.preferences_options_sound_all = 'Toate'
z.string.ro.preferences_options_sound_all_detail = 'Toate sunetele'
z.string.ro.preferences_options_sound_none = 'Niciunul'
z.string.ro.preferences_options_sound_none_detail = 'Psst!'
z.string.ro.preferences_options_sound_some = 'Unele'
z.string.ro.preferences_options_sound_some_detail = 'Pinguri și apeluri'
