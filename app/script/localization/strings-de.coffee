...
# About screen
z.string.de.about_copyright = '© Wire Swiss GmbH • Version'
z.string.de.about_legal = 'Datenschutz u. AGB'
z.string.de.about_privacy = 'Privatsphäre'
z.string.de.about_wire = 'wire.com'
...
z.string.de.auth_account_expiration = 'Du wurdest abgemeldet, da deine Session abgelaufen ist. Bitte logge dich erneut ein.'
z.string.de.auth_account_get_wire = 'Ein moderner und sicherer Messenger für Unterhaltungen, Anrufe, Bilder, Musik, Videos, GIFs und mehr.'
z.string.de.auth_account_password_forgot = 'Passwort vergessen'
z.string.de.auth_account_remember_me = 'Angemeldet bleiben'
...
z.string.de.auth_verify_email_button = 'Hinzufügen'
z.string.de.auth_verify_email_detail = 'Um Wire auf mehreren Geräten benutzen zu können, werden eine E-Mail-Adresse und Passwort benötigt.'
z.string.de.auth_verify_email_headline = 'Hallo, %name.'
...
z.string.de.auth_posted_pending_detail = 'Schaue in deinen Posteingang oder sende die E-Mail zur Aktivierung erneut.'
...
#Authentication: Misc
z.string.de.auth_placeholder_email = 'E-Mail-Adresse'
...
z.string.de.auth_error_terms_of_use = 'Bitte akzeptiere die Nutzungsbedingungen.'
...
z.string.de.modal_call_conversation_full_message = 'Anrufe sind nur in Unterhaltungen mit bis zu %no Teilnehmern möglich.'
...
z.string.de.connection_request_message = 'Hallo %@.first_name,\nbitte füge mich als Kontakt hinzu.\n%s.first_name'
...
z.string.de.conversation_verified = 'Überprüft'
...
z.string.de.conversation_unable_to_decrypt_2 = '%@names Geräte-Identität hat sich geändert. Nachricht kann nicht entschlüsselt werden.'
...
z.string.de.conversation_list_popover_clear = 'Löschen'
z.string.de.conversation_list_popover_leave = 'Verlassen'
z.string.de.conversation_list_popover_notify = 'Benachrichtigen'
z.string.de.conversation_list_popover_silence = 'Stummschalten'
z.string.de.conversation_list_popover_unarchive = 'Dearchivieren'
...
z.string.de.people_common_contacts = 'Ihr beide kennt'
...
z.string.de.people_invite_detail = 'Wir verwenden deine Kontaktdaten, um Kontakte für dich zu erstellen. Wir anonymisieren alle Informationen und geben sie nicht weiter.'
...
z.string.de.people_tabs_devices_headline = 'Wire gibt jedem Gerät einen einzigartigen Fingerabdruck. Vergleiche diese mit %@.name und überprüfe deine Unterhaltung.'
z.string.de.people_tabs_devices_why_verify = 'Warum sollte ich meine Unterhaltungen verifizieren?'
z.string.de.people_tabs_no_devices_headline = '%@.name benutzt eine ältere Version von Wire. Es werden keine Geräte angezeigt.'
...
z.string.de.people_tabs_device_detail_headline = 'Überprüfe, ob dieser Fingerabdruck mit dem auf %bold%@.names Gerät%end übereinstimmt.'
...
z.string.de.people_connect_message = '%@.first_name wird zu deinen Kontakten hinzugefügt und die Unterhaltung mit ihm geöffnet.'
...
z.string.de.people_remove_message = '%@.first_name wird in dieser Unterhaltung keine Nachrichten schicken oder empfangen können.'
...
z.string.de.preferences_password = 'Passwort'
...
z.string.de.preferences_share_osx_contacts = 'Aus Kontakte importieren'
z.string.de.preferences_contacts_detail = 'Wir verwenden deine Daten, um Kontakte für dich zu erstellen. Wir anonymisieren alle Informationen und teilen sie mit niemand anderem.'
z.string.de.preferences_data = 'Daten senden'
z.string.de.preferences_data_checkbox = 'Senden von anonymen Nutzungsdaten'
z.string.de.preferences_data_detail = 'Sende uns Fehler- und Nutzungsberichte. Hilf uns Wire durch das Senden anonymisierter Informationen zu verbessern.'
z.string.de.preferences_sound = 'Benachrichtigungen'
z.string.de.preferences_sound_all = 'Alle'
z.string.de.preferences_sound_all_hint = 'Alle Sounds'
z.string.de.preferences_sound_none = 'Keine'
z.string.de.preferences_sound_none_hint = 'Pssst!'
z.string.de.preferences_sound_some = 'Einige'
z.string.de.preferences_sound_some_hint = 'Pings und Anrufe'
z.string.de.preferences_devices = 'Geräte'
z.string.de.preferences_device_remove = 'Gerät entfernen'
z.string.de.preferences_device_remove_detail = 'Entferne dieses Gerät, wenn du es nicht mehr benutzt.'
z.string.de.preferences_device_button_remove = 'Entfernen'
z.string.de.preferences_device_button_cancel = 'Abbrechen'
z.string.de.preferences_device_activated = 'Aktiviert in '
z.string.de.preferences_device_id = 'ID: '
z.string.de.preferences_device_reset_session_description = 'Falls die Fingerabdrücke nicht übereinstimmen, setze die Session zurück um sicherzustellen, dass die richtigen Fingerabdrücke auf allen Geräten angezeigt werden.'
z.string.de.preferences_device_reset_session_button = 'Session zurücksetzen'
z.string.de.preferences_device_fingerprint_label = 'Schlüssel-Fingerabdruck'
z.string.de.preferences_device_fingerprint_message = 'Wire gibt jedem Gerät einen einzigartigen Fingerabdruck. Vergleiche die Fingerabdrücke zur Verifizierung deiner Geräte und Unterhaltungen.'

# Profile
z.string.de.profile_about = 'Über'
z.string.de.profile_preferences = 'Einstellungen'
z.string.de.profile_sign_out = 'Abmelden'
z.string.de.profile_support = 'Hilfe'
z.string.de.profile_username_placeholder = 'Dein vollständiger Name'
...
z.string.de.search_suggestion_one = 'Kennt %@.first_name'
z.string.de.search_suggestion_two = 'Kennt %@.first_name und %@.other_name'
z.string.de.search_suggestion_many = 'Kennt %@.first_name und %no weitere'
...
z.string.de.tooltip_conversation_list_archive = 'Archivieren (%shortcut)'
z.string.de.tooltip_conversation_list_archived = 'Archiv anzeigen (%no)'
z.string.de.tooltip_conversation_list_more = 'Mehr'
z.string.de.tooltip_conversation_list_notify = 'Benachrichtigen (%shortcut)'
z.string.de.tooltip_conversation_list_silence = 'Stummschalten (%shortcut)'
z.string.de.tooltip_conversation_list_tooltip_start = 'Unterhaltung beginnen (%shortcut)'
...
z.string.de.tooltip_preferences_sound = 'Wähle, ob du über neue Nachrichten per Sound informiert wirst'

z.string.de.tooltip_profile_picture = 'Ändere dein Bild…'
z.string.de.tooltip_profile_preferences = 'Einstellungen…'
z.string.de.tooltip_profile_rename = 'Ändere deinen Namen'
