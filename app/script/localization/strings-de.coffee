...
z.string.de.preferences_devices_remove_detail = 'Entferne das Gerät, wenn du es nicht mehr nutzt. Der Nachrichtenverlauf wird auf diesem Gerät gelöscht werden und du wirst abgemeldet.'
