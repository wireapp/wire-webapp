...
z.string.hr.invite_detail = 'Link može se koristiti 2 tjedna.'
...
z.string.hr.preferences_devices_remove_detail = 'Uklanjanje ovog uređaja u slučaju nekorištenja. Sve poruka bit će izbrisane i uređaj odjavljen.'
...
z.string.hr.preferences_options_sound = 'Zvuk notifikacije'
z.string.hr.preferences_options_sound_all = 'Sve'
z.string.hr.preferences_options_sound_all_detail = 'Svi zvukovi'
z.string.hr.preferences_options_sound_none = 'Bez zvukova'
z.string.hr.preferences_options_sound_none_detail = 'Sshhh!'
z.string.hr.preferences_options_sound_some = 'Neke'
z.string.hr.preferences_options_sound_some_detail = 'Pingovi i pozivi'
