...
z.string.hr.preferences_options_audio = 'Zvuk notifikacije'
z.string.hr.preferences_options_audio_all = 'Sve'
z.string.hr.preferences_options_audio_all_detail = 'Svi zvukovi'
z.string.hr.preferences_options_audio_none = 'Bez zvukova'
z.string.hr.preferences_options_audio_none_detail = 'Sshhh!'
z.string.hr.preferences_options_audio_some = 'Neke'
