...
z.string.hu.people_tabs_device_detail_headline = 'Ellenőrizze, hogy egyezik-e az ujjlenyomata a megjelenített %bold%@.name’s eszköz%end.'
...
z.string.hu.preferences_options_audio_all = 'Mind'
