...
z.string.fr.modal_block_conversation_message = '%@.name ne pourra plus vous contacter ou vous inviter dans une conversation de groupe.'
...
z.string.fr.connection_request_message = 'Bonjour %@.first_name,\nConnectez vous sur Wire.\n%s.first_name'
...
z.string.fr.conversation_device_started_using = ' a commencé à utiliser'
z.string.fr.conversation_device_started_using_you = ' a commencé à utiliser'
...
z.string.fr.conversation_device_a_new_device = ' un nouvel appareil'
...
z.string.fr.invite_message = 'Je suis sur Wire. Cherchez %mail\nou visitez https://get.wire.com afin de vous connecter avec moi.'
...
z.string.fr.people_block_message = '%@.first_name ne pourra pas vous trouver ou vous contacter sur Wire.'
...
z.string.fr.people_unblock_message = '%@.first_name pourra de nouveau vous trouver et vous contacter sur Wire. Vous recevrez aussi les messages qu’il vous a envoyé quand il est bloqué.'
...
z.string.fr.preferences_av_camera = 'Appareil photo'
z.string.fr.preferences_av_microphone = 'Micro'
...
z.string.fr.preferences_devices_remove_detail = 'Supprimez cet appareil si vous avez arrêté de l’utiliser. L’historique de vos messages sera effacé de l’appareil et vous serez déconnecté.'
...
z.string.fr.search_suggestion_one = 'Connaît %@.first_name'
z.string.fr.search_suggestion_two = 'Connaît %@.first_name et %@.other_name'
z.string.fr.search_suggestion_many = 'Connaît %@.first_name et %no autres personnes'
...
z.string.fr.warning_permission_denied_screen = 'Vous ne pouvez pas partager votre écran car votre navigateur n’y a pas accès.'
...
z.string.fr.tooltip_conversations_notify = 'Non-silencieux (%shortcut)'
z.string.fr.tooltip_conversations_silence = 'Silencieux (%shortcut)'
