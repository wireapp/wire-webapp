...
z.string.fr.preferences_options_camera = 'Appareil photo'
...
z.string.fr.preferences_options_microphone = 'Micro'
...
z.string.fr.preferences_options_speakers = 'Haut-parleurs'
