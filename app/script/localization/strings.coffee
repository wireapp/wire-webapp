...
z.string.preferences_about_website = 'wire.com'
...
z.string.preferences_devices_remove_detail = 'Remove this device if you have stopped using it.'
...
z.string.preferences_options_data = 'Usage reports'
z.string.preferences_options_data_checkbox = 'Send anonymous usage data'
z.string.preferences_options_data_detail = 'Send usage data and crash reports. Make Wire better by sending anonymous information.'
