...
z.string.preferences_devices_remove_detail = 'Remove this device if you have stopped using it. Your message history will be erased on this device and you will be logged out.'
...
z.string.preferences_options_notifications_checkbox = 'Show message preview'
z.string.preferences_options_notifications_detail = 'Sender name and message on the notification banner'
...
z.string.preferences_options_sound_none = 'None'
...
z.string.system_notification_ephemeral = 'Sent you a message'
z.string.system_notification_ephemeral_title = 'Someone'
