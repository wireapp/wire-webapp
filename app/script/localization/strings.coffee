...
z.string.preferences_devices_remove_detail = 'Remove this device if you have stopped using it. Your message history will be erased and you will be logged out.'
