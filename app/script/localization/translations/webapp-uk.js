...
z.string.uk.modalSessionResetMessage_1 = 'Якщо проблема не вирішена,';
z.string.uk.modalSessionResetMessageLink = 'зв’яжіться';
z.string.uk.modalSessionResetMessage_2 = 'з нами.';
...
z.string.uk.conversationUnableToDecrypt_1 = 'повідомлення від {{user}} не отримане.';
z.string.uk.conversationUnableToDecrypt_2 = 'Ідентифікатор пристрою {{user}} змінився. Повідомлення не доставлено.';
...
z.string.uk.tooltipPeopleAddPeople = 'Додати учасників до розмови ({{shortcut}})';
