...
z.string.uk.people_tabs_devices_headline = 'Wire присвоює кожному пристроєві унікальний ідентифікатор. Порівняйте його з ідентифікатором на пристрої контакту %@.name та верифікуйте вашу розмову.';
z.string.uk.people_tabs_devices_why_verify = 'Навіщо верифікувати розмови?';
z.string.uk.people_tabs_no_devices_headline = '%@.name використовує стару версію Wire, тому не показується жоден пристрій.';
...
z.string.uk.people_tabs_device_detail_headline = 'Переконайтеся, що цей ідентифікатор такий самий, як і ідентифікатор на пристрої, що належить %bold%@.name%end.';
...
z.string.uk.people_remove_message = '%@.first_name більше не зможе надсилати або отримувати повідомлення в цій розмові.';
