...
z.string.uk.modal_call_conversation_full_headline = 'Забагато учасників для здійснення дзвінка';
z.string.uk.modal_call_conversation_full_message = 'Дзвінки можливі в розмовах до %no учасників.';
...
z.string.uk.modal_call_voice_channel_full_headline = 'Голосовий канал переповнений';
z.string.uk.modal_call_voice_channel_full_message = 'Тут залишилось місце тільки для %no учасників.';
z.string.uk.modal_clear_conversation_headline = 'Видалити історію розмов з "%@.name"?';
...
z.string.uk.modal_too_long_message = 'Можна надсилати повідомлення довжиною до %no символів.';
...
z.string.uk.conversation_unable_to_decrypt_1 = 'Повідомлення від %@name не було отримане.';
z.string.uk.conversation_unable_to_decrypt_2 = 'Ідентифікатор пристрою %@name змінився. Повідомлення не доставлено.';
...
z.string.uk.conversation_asset_upload_too_large = 'Ви можете надсилати файли до %no';
...
z.string.uk.people_connect_message = 'Це додасть %@.first_name до ваших контактів та відкриє розмову.';

z.string.uk.people_cancel_request_headline = 'Скасувати запит?';
z.string.uk.people_cancel_request_message = 'Видалити запит на додавання %@.first_name до контактів.';
...
z.string.uk.warning_call_unsupported_incoming = '%s.first_name дзвонить. Ваш браузер не підтримує дзвінки.';
...
z.string.uk.system_notification_member_join_many = '%s.first_name додав(-ла) %no учасників до розмови';
z.string.uk.system_notification_member_join_one = '%s.first_name додав(-ла) %@.first_name до розмови';
z.string.uk.system_notification_member_leave_left = '%s.first_name вийшов(-ла) з розмови';
z.string.uk.system_notification_member_leave_removed_many = '%s.first_name видалив(-ла) %no учасників з розмови';
z.string.uk.system_notification_member_leave_removed_one = '%s.first_name видалив(-ла) %@.first_name з розмови';
