...
z.string.ro.modal_block_conversation_message =
  '%@.name nu te va putea contacta sau adăuga la conversații de grup.';
...
z.string.ro.modal_call_conversation_full_headline =
  'Nu poți apela pe toți acești oameni';
z.string.ro.modal_call_conversation_full_message =
  'Apelurile funcționează pentru conversații de maxim %no persoane.';
...
z.string.ro.modal_call_voice_channel_full_message =
  'Mai este loc pentru %no persoane aici.';
...
z.string.ro.modal_too_long_message =
  'Nu poți trimite mesaje mai lungi de %no caractere.';
z.string.ro.modal_leave_conversation_headline =
  'Părăsește conversația cu „%@.name”?';
...
z.string.ro.modal_new_device_headline =
  '%@.name a început să folosească un nou dispozitiv';
z.string.ro.modal_new_device_headline_many =
  '%@.names au început să folosească dispozitive noi';
...
z.string.ro.modal_too_many_members_message =
  'Maxim %max persoane se pot alătura conversației. Mai este loc pentru %no persoane aici.';
...
z.string.ro.conversation_unable_to_decrypt_1 =
  'ai primit un mesaj de la %@name.';
z.string.ro.conversation_unable_to_decrypt_2 =
  'identitatea dispozitivului lui %@name s-a schimbat. Mesajul nu a fost livrat.';
...
z.string.ro.conversation_asset_upload_too_large =
  'Poți trimite fișiere până la %no';
...
z.string.ro.conversations_no_conversations =
  'Începe o conversație sau invită persoane să se alăture.';
...
z.string.ro.people_tabs_devices_headline =
  'Wire oferă fiecărui dispozitiv o amprentă unică. Compară amprentele cu %@.name și verifică conversația.';
...
z.string.ro.people_tabs_no_devices_headline =
  '%@.name folosește o versiune veche de Wire. Nu sunt afișate dispozitive.';
...
z.string.ro.people_tabs_device_detail_headline =
  'Verifică dacă aceasta se potrivește cu amprenta arătată în dispozitivul %end al lui %bold%@.name.';
...
z.string.ro.people_remove_message =
  '%@.first_name nu va mai putea trimite sau primi mesaje în această conversație.';

z.string.ro.people_unblock_headline = 'Deblochează?';
z.string.ro.people_unblock_message =
  '%@.first_name te va putea contacta și adăuga din nou la conversații de grup.';
...
z.string.ro.warning_call_unsupported_incoming =
  '%s.first_name te sună. Browserul tău nu suportă apelurile.';
...
z.string.ro.system_notification_conversation_create =
  '%s.first_name a început o conversație';
z.string.ro.system_notification_conversation_rename =
  '%s.first_name a redenumit conversația în %name';
z.string.ro.system_notification_member_join_many =
  '%s.first_name a adăugat %no persoane la conversație';
z.string.ro.system_notification_member_join_one =
  '%s.first_name a adăugat pe %@.first_name la conversație';
z.string.ro.system_notification_member_leave_left =
  '%s.first_name a părăsit conversația';
z.string.ro.system_notification_member_leave_removed_many =
  '%s.first_name a scos %no persoane din conversație';
z.string.ro.system_notification_member_leave_removed_one =
  '%s.first_name a scos pe %@.first_name din conversație';
...
z.string.ro.init_events_progress =
  'Se încacrcă mesajele - %progress din %total';
