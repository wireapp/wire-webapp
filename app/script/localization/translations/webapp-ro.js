...
z.string.ro.modalSessionResetMessage_1 = 'Dacă problema nu este rezolvată,';
z.string.ro.modalSessionResetMessageLink = 'contactează-';
z.string.ro.modalSessionResetMessage_2 = 'ne.';
...
z.string.ro.conversationUnableToDecrypt_1 = 'ai primit un mesaj de la {{user}}.';
z.string.ro.conversationUnableToDecrypt_2 = 'identitatea dispozitivului lui {{user}} s-a schimbat. Mesajul nu a fost livrat.';
...
z.string.ro.inviteHintSelected = 'Apasă {{metaKey}} + C pentru a copia';
z.string.ro.inviteHintUnselected = 'Selectează și apasă {{metaKey}} + C';
