...
z.string.ro.alert_upload_file_format =
  'Nu se poate folosi această imagine.\nTe rugăm să alegi un fișier PNG sau JPEG.';
...
z.string.ro.alert_upload_too_large =
  'Această imagine este prea mare.\nPoți încărca fișiere până la {{number}} MB.';
z.string.ro.alert_gif_too_large =
  'Animația este prea mare.\nMărimea maximă este {{number}} MB.';
...
z.string.ro.auth_verify_account_detail =
  'Aceasta îți permite să folosești Wire pe mai multe dispozitive.';
z.string.ro.auth_verify_account_headline =
  'Adaugă o adresă de e-mail și o parolă.';
z.string.ro.auth_verify_account_logout = 'Deconectare';
z.string.ro.auth_verify_code_description =
...
z.string.ro.auth_verify_code_resend_timer =
  'Poți cere un nou cod de {{expiration}}.';
...
z.string.ro.auth_limit_description =
  'Șterge unul din celelalte dispozitive pentru a folosi Wire pe acesta.';
...
z.string.ro.auth_history_headline =
  'Folosești Wire pentru prima dată pe acest dispozitiv.';
z.string.ro.auth_history_description =
  'Din motive de confidențialitate, istoricul conversației nu va apărea aici.';
z.string.ro.auth_history_reuse_headline =
  'Ai mai folosit Wire pe acest dispozitiv.';
z.string.ro.auth_history_reuse_description =
  'Mesajele trimise între timp nu vor apărea aici.';
z.string.ro.auth_history_button = 'OK';

z.string.ro.auth_posted_change_email = 'Schimbă e-mailul';
z.string.ro.auth_posted_offline_detail =
  'Verifică conexiunea la internet și reîncearcă.';
z.string.ro.auth_posted_offline_headline = 'Wire arată mai bine online.';
z.string.ro.auth_posted_pending_detail =
  'Verifică e-mailul sau retrimite mesajul de activare.';
z.string.ro.auth_posted_pending_headline =
  'Contul este deja în curs de activare';
z.string.ro.auth_posted_resend = 'Retrimite la {{email}}';
z.string.ro.auth_posted_resend_action = 'Nu a apărut nici un e-mail?';
z.string.ro.auth_posted_resend_detail =
  'Verifică e-mailul și urmează instrucțiunile.';
...
z.string.ro.auth_error_email_forbidden =
  'Ne pare rău. Această adresa de e-mail este interzisă.';
z.string.ro.auth_error_email_malformed =
...
z.string.ro.auth_error_password_short =
  'Alege o parolă de cel puțin 8 caractere.';
z.string.ro.auth_error_password_wrong = 'Parolă greșită. Reîncearcă.';
z.string.ro.auth_error_phone_number_forbidden =
  'Ne pare rău. Acest număr de telefon este interzis.';
...
z.string.ro.auth_error_sign_in =
  'Te rugăm să verifici detaliile și să reîncerci.';
...
z.string.ro.modal_block_conversation_message =
  '{{user}} nu te va putea contacta sau adăuga la conversații de grup.';
...
z.string.ro.modal_call_conversation_empty_message =
  'Nu a mai rămas nimeni aici.';
z.string.ro.modal_call_no_video_in_group_headline =
  'Nu poți face apeluri video în grupuri';
z.string.ro.modal_call_no_video_in_group_message =
  'Apelurile video nu sunt disponibile în conversațiile de grup.';
...
z.string.ro.modal_call_second_ongoing_headline =
  'Închide apelul pe un alt dispozitiv?';
z.string.ro.modal_call_second_ongoing_message =
  'Nu poți fi decât într-un singur apel la un moment dat.';
...
z.string.ro.modal_call_second_outgoing_message =
  'Nu poți fi decât într-un singur apel la un moment dat.';
z.string.ro.modal_call_second_outgoing_action = 'Închide';
z.string.ro.modal_clear_conversation_headline =
  'Șterge conversația „{{user}}”?';
...
z.string.ro.modal_connected_device_headline =
  'Contul tău a fost folosit în data de:';
z.string.ro.modal_connected_device_from = 'De la:';
z.string.ro.modal_connected_device_message =
  'Dacă nu ai făcut asta, elimină dispozitivul și resetează parola.';
...
z.string.ro.modal_too_long_message =
  'Nu poți trimite mesaje mai lungi de {{number}} caractere.';
z.string.ro.modal_leave_conversation_headline =
  'Părăsește conversația cu „{{user}}”?';
...
z.string.ro.modal_logout_message =
  'Șterge toate informațiile personale și conversațiile de pe acest dispozitiv.';
z.string.ro.modal_logout_button = 'Deconectare';
z.string.ro.modal_new_device_headline =
  '{{user}} a început să folosească un nou dispozitiv';
z.string.ro.modal_new_device_headline_many =
  '{{user}}s au început să folosească dispozitive noi';
z.string.ro.modal_new_device_headline_you =
  '{{user}} a început să folosească un nou dispozitiv';
...
z.string.ro.modal_remove_device_message =
  'Este necesară parola pentru a elimina acest dispozitiv.';
...
z.string.ro.modal_uploads_parallel =
  'Poți trimite maxim {{number}} fișiere simultan.';
...
z.string.ro.conversation_connection_cancel_request =
  'Anulează cererea de conectare';
z.string.ro.conversation_create = 'a început o conversație cu {{users}}';
z.string.ro.conversation_create_you = 'a început o conversație cu {{users}}';
...
z.string.ro.conversation_device_user_devices = ' dispozitivele lui {{user}}';
...
z.string.ro.conversation_device_new_people_joined =
  's-au mai alăturat persoane.';
z.string.ro.conversation_device_new_people_joined_verify =
  ' verifică dispozitivele';
z.string.ro.conversation_just_now = 'Chiar acum';
z.string.ro.conversation_location_link = 'Deschide harta';
z.string.ro.conversation_member_join = ' ai adăuga pe {{users}}';
z.string.ro.conversation_member_join_you = ' ai adăuga pe {{users}}';
z.string.ro.conversation_member_leave_left = ' stânga';
z.string.ro.conversation_member_leave_left_you = ' stânga';
z.string.ro.conversation_member_leave_removed = ' ai șters pe {{users}}';
z.string.ro.conversation_member_leave_removed_you = ' ai șters pe {{users}}';
...
z.string.ro.conversation_resume = 'Începe o conversație cu {{users}}';
z.string.ro.conversation_team_leave = ' a fost scos din echipă';
...
z.string.ro.conversation_unable_to_decrypt_1 =
  'ai primit un mesaj de la {{user}}.';
...
z.string.ro.conversation_asset_upload_too_large =
  'Poți trimite fișiere până la {{number}}';
...
z.string.ro.conversation_context_menu_delete_everyone =
...
z.string.ro.conversation_delete_timestamp = 'A fost șters la {{date}}';
...
z.string.ro.conversations_connection_request_many =
  '{{number}} persoane așteaptă';
z.string.ro.conversations_connection_request_one = '1 persoană așteaptă';
z.string.ro.conversations_empty_conversation_description =
...
z.string.ro.conversations_secondary_line_missed_call =
  '{{number}} apel pierdut';
z.string.ro.conversations_secondary_line_missed_calls =
  '{{number}} apeluri pierdute';
z.string.ro.conversations_secondary_line_new_message = '{{number}} mesaj nou';
z.string.ro.conversations_secondary_line_new_messages = '{{number}} mesaje noi';
z.string.ro.conversations_secondary_line_ping = '{{number}} ping';
z.string.ro.conversations_secondary_line_pings = '{{number}} pinguri';
z.string.ro.conversations_secondary_line_people_left =
  '{{number}} persoane au plecat';
...
z.string.ro.invite_message =
  'Bună, sunt pe Wire. Caută-mă cu numele {{username}} sau vizitează get.wire.com.';
z.string.ro.invite_message_no_email =
  'Sunt pe Wire. Vizitează get.wire.com pentru a te conecta cu mine.';
...
z.string.ro.people_everyone_participates =
  'Toată lumea cu care\nești conectat este deja\nîn această conversație.';
z.string.ro.people_no_matches =
...
z.string.ro.people_tabs_devices_why_verify =
  'De ce să verific această conversație?';
z.string.ro.people_tabs_no_devices_headline =
  '{{user}} folosește o versiune veche de Wire. Nu sunt afișate dispozitive.';
z.string.ro.people_tabs_device_detail_all_my_devices =
  'Arată toate dispozitivele mele';
z.string.ro.people_tabs_device_detail_device_fingerprint =
  'Amprentă dispozitiv';
...
z.string.ro.people_tabs_device_detail_show_my_device =
  'Arată amprenta dispozitivului';
...
z.string.ro.people_block_message =
  '{{user}} nu te va putea contacta sau adăuga la conversații de grup.';

z.string.ro.people_connect_headline = 'Acceptă?';
z.string.ro.people_connect_message =
  'Aceasta te va conecta și va deschide o conversație cu {{user}}.';

z.string.ro.people_cancel_request_headline = 'Anulează solicitarea?';
z.string.ro.people_cancel_request_message =
  'Șterge solicitarea de conectare cu {{user}}.';

z.string.ro.people_leave_headline = 'Părăsește conversația?';
z.string.ro.people_leave_message =
  'Nu vei mai putea trimite sau primi mesaje în această conversație.';

z.string.ro.people_remove_headline = 'Șterge?';
z.string.ro.people_remove_message =
  '{{user}} nu va mai putea trimite sau primi mesaje în această conversație.';

z.string.ro.people_unblock_headline = 'Deblochează?';
z.string.ro.people_unblock_message =
  '{{user}} te va putea contacta și adăuga din nou la conversații de grup.';
...
z.string.ro.preferences_about_support_contact =
...
z.string.ro.preferences_account_username_hint =
  'Cel puțin două caractere. Doar a—z, 0—9 și _ sunt permise.';
...
z.string.ro.preferences_av_permission_detail =
  'Activează din preferințele browserului';
...
z.string.ro.preferences_devices_session_confirmation =
...
z.string.ro.preferences_options_data_checkbox =
  'Rapoarte de folosire și de avarie';
z.string.ro.preferences_options_data_detail =
  'Ajută la îmbunătățirea Wire prin trimiterea de informații anonime.';
...
z.string.ro.preferences_options_notifications_obfuscate_message =
  'Arată expeditorul';
z.string.ro.preferences_options_notifications_on =
  'Arată expeditorul și mesajul';

z.string.ro.search_group_hint =
  'Mai încearcă sau alege persoanele cu care să creezi un grup';
...
z.string.ro.search_team_groups = 'Conversații de echipă';
...
z.string.ro.upload_google_message_error =
  'Nu am primit nicio informație. Încearcă importarea contactelor din nou.';
...
z.string.ro.warning_call_detail =
  'Browserul tău are nevoie de acces la microfon pentru a face apeluri.';
z.string.ro.warning_call_headline = 'Nu se poate apela fără microfon';
z.string.ro.warning_call_unsupported_incoming =
  '{{user}} te sună. Browserul tău nu suportă apelurile.';
z.string.ro.warning_call_unsupported_outgoing =
  'Nu poți suna pentru că browserul tău nu suportă apelurile.';
z.string.ro.warning_call_issues =
  'Această versiune de Wire nu poate participa într-un apel. Te rugăm să folosești';
z.string.ro.warning_call_upgrade_browser =
  'Pentru a suna, te rugăm să actualizezi Google Chrome.';
z.string.ro.warning_learn_more = 'Află mai multe';
z.string.ro.warning_not_found_camera =
  'Nu poți suna pentru că acest dispozitiv nu are o cameră.';
z.string.ro.warning_not_found_microphone =
  'Nu poți suna pentru că acest dispozitiv nu are un microfon.';
z.string.ro.warning_permission_denied_camera =
  'Nu poți suna pentru că browserul tău nu are acces la cameră.';
z.string.ro.warning_permission_denied_microphone =
  'Nu poți suna pentru că browserul tău nu are acces la microfon.';
z.string.ro.warning_permission_denied_screen =
  'Browserul tău are nevoie de permisiuni pentru a partaja ecranul.';
z.string.ro.warning_permission_request_camera =
  '{{icon}} permite accesul la cameră';
z.string.ro.warning_permission_request_microphone =
  '{{icon}} permit accesul la microfon';
z.string.ro.warning_permission_request_notification =
  '{{icon}} permite notificările';
z.string.ro.warning_permission_request_screen =
  '{{icon}} permite accesul la ecran';
...
z.string.ro.warning_connectivity_no_internet =
  'Nu este conexiune la internet. Nu vei putea trimite sau primi mesaje.';

z.string.ro.warning_lifecycle_update =
  'Este disponibilă o nouă versiune de Wire.';
...
z.string.ro.system_notification_connection_accepted =
  'A acceptat cererea de conectare a ta';
...
z.string.ro.system_notification_conversation_create =
  '{{user}} a început o conversație';
z.string.ro.system_notification_conversation_rename =
  '{{user}} a redenumit conversația în {{name}}';
z.string.ro.system_notification_member_join_many =
  '{{user}} a adăugat {{number}} persoane la conversație';
z.string.ro.system_notification_member_join_one =
  '{{user1}} a adăugat pe {{user2}} la conversație';
...
z.string.ro.tooltip_conversation_all_verified =
  'Toate amprentele sunt verificate';
...
z.string.ro.tooltip_conversations_tooltip_start =
  'Începe conversația ({{shortcut}})';

z.string.ro.tooltip_people_add =
  'Adaugă persoane la conversație ({{shortcut}})';
...
z.string.ro.tooltip_preferences_contacts_gmail =
  'Autentifică-te în conturile Gmail pentru a partaja contacte';
z.string.ro.tooltip_preferences_contacts_macos =
  'Partajează toate contactele de pe aplicația Contacts din macOS';
z.string.ro.tooltip_preferences_password =
  'Deschide un alt site web pentru a reseta parola';
...
z.string.ro.init_validated_client =
  'Se încarcă conexiunile și conversațiile tale';
z.string.ro.init_received_user_data = 'Verifică dacă sunt mesaje noi';
z.string.ro.init_events_progress =
  'Se încacrcă mesajele - {{number1}} din {{number2}}';
