...
z.string.sl.alert_upload_file_format =
  'Ne morete uporabiti te slike.\nProsimo izberite zbirko PNG ali JPEG.';
z.string.sl.alert_upload_too_small =
  'Ne morete uporabiti te slike.\nProsimo izberite sliko, ki je vsaj 320 x 320 px.';
z.string.sl.alert_upload_too_large =
  'Ta slika je prevelika. \nNaložite lahko zbirke do {{number}} MB.';
z.string.sl.alert_gif_too_large =
  'Animacija je prevelika. \nNajvečja velikost je {{number}} MB.';
...
z.string.sl.auth_account_expiration =
  'Ker je vaša seja potekla, ste bili odjavljeni. Prosimo prijavite se ponovno.';
...
z.string.sl.auth_limit_description =
  'Odstranite eno izmed vaših naprav za začetek uporabe Wire na tej.';
...
z.string.sl.auth_history_description =
  'Zaradi zasebnosti se vaša zgodovina pogovorov ne bo pojavila tukaj.';
z.string.sl.auth_history_reuse_headline =
  'Na tej napravi si že uporabljal(-a) Wire.';
z.string.sl.auth_history_reuse_description =
  'Sporočila poslana medtem tukaj ne bodo prikazana.';
z.string.sl.auth_history_button = 'V redu';

z.string.sl.auth_posted_change_email = 'Ponastavitev elektronskega naslova';
z.string.sl.auth_posted_offline_detail =
  'Preverite vašo spletno povezavo in poizkusite ponovno.';
z.string.sl.auth_posted_offline_headline = 'Wire je prijetnejši na spletu.';
z.string.sl.auth_posted_pending_detail =
  'Preverite vašo e-pošto ali ponovno pošljite aktivacijo.';
...
z.string.sl.auth_posted_resend_detail =
  'Preverite vašo e-pošto in sledite navodilom.';
z.string.sl.auth_posted_resend_headline = 'Imate pošto.';
z.string.sl.auth_posted_retry =
  'Poizkusi ponovno in pošlji e-pošto na {{email}}';
...
z.string.sl.auth_error_email_forbidden =
  'Se opravičujemo. Ta e-poštni naslov je prepovedan.';
z.string.sl.auth_error_email_malformed =
...
z.string.sl.auth_error_phone_number_forbidden =
  'Se opravičujemo. Ta telefonska številka je prepovedana.';
...
z.string.sl.auth_error_sign_in =
  'Prosimo preverite vaše podatke in poizkusite ponovno.';
...
z.string.sl.modal_block_conversation_headline = 'Blokiraj {{user}}?';
z.string.sl.modal_block_conversation_message =
  '{{user}} vas ne bo mogel kontaktirati ali dodati v skupinske pogovore.';
...
z.string.sl.modal_call_no_video_in_group_message =
  'Videoklici niso na voljo v skupinskih pogovorih.';
z.string.sl.modal_call_second_incoming_headline = 'Sprejmi klic?';
z.string.sl.modal_call_second_incoming_message =
  'Vaš trenuten klic se bo končal.';
z.string.sl.modal_call_second_incoming_action = 'Sprejmi';
z.string.sl.modal_call_second_ongoing_headline =
  'Odloži klic na drugi napravi?';
z.string.sl.modal_call_second_ongoing_message =
...
z.string.sl.modal_clear_conversation_headline = 'Izbris vsebine "{{user}}"?';
...
z.string.sl.modal_connected_device_message =
  'Če tega niste storili, odstranite napravo in ponastavite vaše geslo.';
...
z.string.sl.modal_delete_everyone_message =
  'To dejanje ne more biti razveljavljeno.';
z.string.sl.modal_too_long_headline = 'Sporočilo je predolgo';
z.string.sl.modal_too_long_message =
  'Lahko pošljete sporočila do {{number}} znakov.';
z.string.sl.modal_leave_conversation_headline = 'Zapusti pogovor "{{user}}"?';
z.string.sl.modal_leave_conversation_message =
  'Udeleženci bodo obveščeni in pogovor bo odstranjen iz seznama.';
z.string.sl.modal_leave_conversation_button = 'Zapusti';
z.string.sl.modal_logout_headline = 'Počisti podatke?';
z.string.sl.modal_logout_message =
  'Izbriši vse vaše osebne podatke in pogovore na tej napravi.';
z.string.sl.modal_logout_button = 'Odjava';
z.string.sl.modal_new_device_headline =
  '{{user}} je začel(-a) z uporabo nove naprave';
z.string.sl.modal_new_device_headline_many =
  '{{user}}s so začeli z uporabo novih naprav';
z.string.sl.modal_new_device_headline_you =
  '{{user}} je začel(-a) z uporabo nove naprave';
z.string.sl.modal_new_device_message =
  'Ali še vedno želite poslati vaša sporočila?';
z.string.sl.modal_new_device_call_accept = 'Sprejmi klic';
z.string.sl.modal_new_device_call_anyway = 'Vseeno pokliči';
z.string.sl.modal_new_device_call_incoming =
  'Ali še vedno želite sprejeti klic?';
...
z.string.sl.modal_remove_device_headline = 'Odstrani "{{device}}"';
z.string.sl.modal_remove_device_message =
  'Za odstranitev naprave je potrebno vaše geslo.';
...
z.string.sl.modal_uploads_parallel =
  'Lahko pošljete do {{number}} zbirk naenkrat.';
...
z.string.sl.conversation_connection_cancel_request =
  'Prekliči zahtevo za povezavo';
z.string.sl.conversation_create = ' začel pogovor s/z {{users}}';
z.string.sl.conversation_create_you = ' začel pogovor s/z {{users}}';
...
z.string.sl.conversation_device_unverified =
  ' odstranil(-a) preveritev ene izmed';
z.string.sl.conversation_device_your_devices = ' vaših naprav';
z.string.sl.conversation_device_user_devices = ' Naprave od {{user}}';
z.string.sl.conversation_device_new_device_one = ' nova naprava';
z.string.sl.conversation_device_new_device_many = ' nove naprave';
z.string.sl.conversation_device_new_people_joined =
  'nove osebe so se pridružile.';
...
z.string.sl.conversation_member_join = ' dodal(-a) {{users}}';
z.string.sl.conversation_member_join_you = ' dodal(-a) {{users}}';
...
z.string.sl.conversation_member_leave_removed = ' odstranil(-a) {{users}}';
z.string.sl.conversation_member_leave_removed_you = ' odstranil(-a) {{users}}';
...
z.string.sl.conversation_resume = 'Začni pogovor s/z {{users}}';
...
z.string.sl.conversation_unable_to_decrypt_1 =
  'sporočilo od {{user}} ni bilo prejeto.';
...
z.string.sl.conversation_asset_upload_too_large =
  'Lahko pošljete zbirke do {{number}}';
...
z.string.sl.conversation_delete_timestamp = 'Izbrisan ob {{date}}';
z.string.sl.conversation_edit_timestamp = 'Urejen ob {{date}}';
...
z.string.sl.conversations_secondary_line_missed_call =
  '{{number}} zgrešeni klic';
z.string.sl.conversations_secondary_line_missed_calls =
  '{{number}} zgrešenih klicev';
z.string.sl.conversations_secondary_line_new_message =
  '{{number}} novo sporočilo';
z.string.sl.conversations_secondary_line_new_messages =
...
z.string.sl.conversations_secondary_line_person_left =
  '{{user}} je zapustil(-a)';
z.string.sl.conversations_secondary_line_person_removed =
  '{{user}} je bil(-a) odstranjen(-a)';
...
z.string.sl.conversations_secondary_line_person_added =
  '{{user}} je bil(-a) dodan(-a)';
z.string.sl.conversations_secondary_line_person_added_you =
  '{{user}} te je dodal(-a)';
z.string.sl.conversations_secondary_line_renamed =
  '{{user}} preimenoval(-a) pogovor';
...
z.string.sl.conversations_secondary_line_you_were_removed =
  'Bil(-a) si odstranjen(-a)';
...
z.string.sl.invite_message =
  'Sem na Wire, poišči {{username}} ali obišči get.wire.com.';
z.string.sl.invite_message_no_email =
  'Sem na Wire. Obišči get.wire.com za povezavo z mano.';
...
z.string.sl.people_everyone_participates =
  'Vsi \ns katerimi ste povezani,\nso že v tem pogovoru.';
z.string.sl.people_no_matches =
  'Brez ujemanja rezultatov. \nPoizkusite vnesti drugo ime.';
...
z.string.sl.people_tabs_device_detail_all_my_devices =
  'Prikaži vse moje naprave';
z.string.sl.people_tabs_device_detail_device_fingerprint =
  'Prstni odtis naprave';
...
z.string.sl.people_tabs_device_detail_show_my_device =
  'Prikaži prstni odtis moje naprave';
...
z.string.sl.people_block_message =
  '{{user}} vas ne bo mogel kontaktirati ali dodati v skupinske pogovore.';

z.string.sl.people_connect_headline = 'Sprejmi?';
z.string.sl.people_connect_message =
  'To vas bo povezalo in odprlo pogovor s/z {{user}}.';

z.string.sl.people_cancel_request_headline = 'Prekliči zahtevo?';
z.string.sl.people_cancel_request_message =
  'Odstrani zahtevo za povezavo do {{user}}.';

z.string.sl.people_leave_headline = 'Zapusti pogovor?';
z.string.sl.people_leave_message =
  'Ne boste mogli pošiljati ali prejeti sporočila v tem pogovoru.';

z.string.sl.people_remove_headline = 'Odstrani?';
z.string.sl.people_remove_message =
  '{{user}} ne bo mogel pošiljati ali prejeti sporočila v tem pogovoru.';

z.string.sl.people_unblock_headline = 'Odblokiraj?';
z.string.sl.people_unblock_message =
  '{{user}} vas ne bo mogel kontaktirati ali ponovno dodati v skupinske pogovore.';
...
z.string.sl.preferences_account_username_hint =
  'Vsaj 2 znaka. Le a—z, 0—9 in _.';
...
z.string.sl.preferences_av_permission_detail =
  'Omogoči iz nastavitev vašega brskalnika';
...
z.string.sl.preferences_devices_session_confirmation =
  'Seja je bila ponastavljena.';
...
z.string.sl.preferences_options_data =
  'Podatki o uporabi in poročila o prisilnih ustavitvah';
z.string.sl.preferences_options_data_checkbox =
  'Podatki o uporabi in poročila o prisilnih ustavitvah';
z.string.sl.preferences_options_data_detail =
  'Izboljšajte Wire s pošiljanjem anonimnih informacij.';
...
z.string.sl.preferences_options_notifications_obfuscate_message =
  'Pokaži pošiljatelja';
z.string.sl.preferences_options_notifications_on =
  'Pokaži pošiljatelja in sporočilo';

z.string.sl.search_group_hint =
  'Nadaljujte s tipkanjem ali izberite več oseb za ustvaritev skupine';
...
z.string.sl.search_team_groups = 'Ekipni pogovori';
...
z.string.sl.upload_google_message_error =
  'Nismo prejeli vaših podatkov. Prosimo poizkusite ponovno uvoziti stike.';
...
z.string.sl.warning_call_detail =
  'Vaš brskalnik potrebuje dostop do mikrofona za klicanje.';
z.string.sl.warning_call_headline = 'Klic ni mogoč brez mikrofona';
z.string.sl.warning_call_unsupported_incoming =
  '{{user}} kliče. Vaš brskalnik ne podpira klicev.';
z.string.sl.warning_call_unsupported_outgoing =
  'Ne morete klicati, ker vaš brskalnik ne podpira klicev.';
z.string.sl.warning_call_issues =
  'Ta različica Wire ne more sodelovati v klicu. Prosimo uporabite';
z.string.sl.warning_call_upgrade_browser =
  'Če želite klicati, posodobite Google Chrome.';
z.string.sl.warning_learn_more = 'Nauči se več';
z.string.sl.warning_not_found_camera =
  'Ne morete klicati, ker vaš računalnik nima kamere.';
z.string.sl.warning_not_found_microphone =
  'Ne morete klicati, ker vaš računalnik nima mikrofona.';
z.string.sl.warning_permission_denied_camera =
  'Ne morete klicati, ker vaš brskalnik nima dostopa do kamere.';
z.string.sl.warning_permission_denied_microphone =
  'Klicati ni mogoče, ker vaš brskalnik nima dostopa do mikrofona.';
z.string.sl.warning_permission_denied_screen =
  'Vaš brskalnik potrebuje dovoljenje za deljenje vašega zaslona.';
z.string.sl.warning_permission_request_camera =
  '{{icon}} Dovoli dostop do kamere';
z.string.sl.warning_permission_request_microphone =
  '{{icon}} Dovoli dostop do mikrofona';
z.string.sl.warning_permission_request_notification =
  '{{icon}} Dovoli obvestila';
z.string.sl.warning_permission_request_screen =
  '{{icon}} Dovoli dostop do zaslona';
z.string.sl.warning_tell_me_how = 'Povej mi kako';

z.string.sl.warning_connectivity_connection_lost =
  'Poizkus povezave. Wire morda ne bo mogel dostaviti sporočila.';
z.string.sl.warning_connectivity_no_internet =
  'Ni spletne povezave. Ne boste mogli pošiljati ali prejemati sporočil.';
...
z.string.sl.system_notification_connection_accepted =
  'Je sprejel(-a) vašo zahtevo po povezavi';
...
z.string.sl.system_notification_conversation_create =
  '{{user}} je začel(-a) pogovor';
z.string.sl.system_notification_conversation_rename =
  '{{user}} je preimenoval(-a) pogovor v {{name}}';
z.string.sl.system_notification_member_join_many =
  '{{user}} je dodal(-a) {{number}} oseb v pogovor';
z.string.sl.system_notification_member_join_one =
  '{{user1}} je dodal(-a) {{user2}} v pogovor';
z.string.sl.system_notification_member_leave_removed_you =
  '{{user}} te je odstranil(-a) iz pogovora';
...
z.string.sl.tooltip_conversation_all_verified =
  'Vsi prstni odtisi naprav so preverjeni';
...
z.string.sl.tooltip_conversations_tooltip_start =
  'Začni pogovor ({{shortcut}})';
...
z.string.sl.tooltip_preferences_contacts_gmail =
  'Prijavite se v vaš Gmail račun za deljenje stikov';
z.string.sl.tooltip_preferences_contacts_macos =
  'Deli vse vaše stike iz macOS aplikacije Contacts';
z.string.sl.tooltip_preferences_password =
  'Odpri drugo spletno stran za ponastavitev gesla';
...
z.string.sl.init_events_progress =
  'Nalaganje sporočil - {{number1}} od {{number2}}';
