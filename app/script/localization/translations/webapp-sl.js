...
z.string.sl.modal_block_conversation_message =
  '%@.name vas ne bo mogel kontaktirati ali dodati v skupinske pogovore.';
...
z.string.sl.modal_new_device_headline =
  '%@.name je začel(-a) z uporabo nove naprave';
z.string.sl.modal_new_device_headline_many =
  '%@.names so začeli z uporabo novih naprav';
...
z.string.sl.modal_too_many_members_message =
  'Do %max oseb se lahko pridruži pogovoru. Tukaj je prostora še za %no oseb.';
...
z.string.sl.conversation_unable_to_decrypt_1 =
  'sporočilo od %@name ni bilo prejeto.';
z.string.sl.conversation_unable_to_decrypt_2 =
  'Identita naprave od %@name je bila spremenjena. Sporočilo ni dostavljeno.';
...
z.string.sl.people_tabs_devices_headline =
  'Wire dodeli vsaki napravi edinstven prstni odtis. Primerjajte jih z %@.name in preverite vaš pogovor.';
z.string.sl.people_tabs_devices_why_verify = 'Zakaj preveriti pogovor?';
z.string.sl.people_tabs_no_devices_headline =
  '%@.name uporablja starejšo različico Wire. Nobenih naprav tukaj ni prikazano.';
...
z.string.sl.people_tabs_device_detail_headline =
  'Preveri, da se to ujema s prstnim odtisom na napravi%end od %bold%@.name.';
...
z.string.sl.people_remove_message =
  '%@.first_name ne bo mogel pošiljati ali prejeti sporočila v tem pogovoru.';

z.string.sl.people_unblock_headline = 'Odblokiraj?';
z.string.sl.people_unblock_message =
  '%@.first_name vas ne bo mogel kontaktirati ali ponovno dodati v skupinske pogovore.';
...
z.string.sl.warning_call_unsupported_incoming =
  '%s.first_name kliče. Vaš brskalnik ne podpira klicev.';
...
z.string.sl.system_notification_conversation_create =
  '%s.first_name je začel(-a) pogovor';
z.string.sl.system_notification_conversation_rename =
  '%s.first_name je preimenoval(-a) pogovor v %name';
