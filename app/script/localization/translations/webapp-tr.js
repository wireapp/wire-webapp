...
z.string.tr.alert_upload_too_small =
  'Bu resmi kullanamazsınız.\nLütfen en az 320x320 piksellik bir resim seçin.';
z.string.tr.alert_upload_too_large =
  'Bu resim çok büyük.\nEn fazla %n MB’lık dosyalar yükleyebilirsiniz.';
z.string.tr.alert_gif_too_large =
...
z.string.tr.auth_account_expiration =
  'Oturumunuzun süresi dolduğu için çıkış yapıldı. Lütfen tekrar giriş yapın.';
...
z.string.tr.auth_verify_account_detail =
  'Bu sizin Wire’ı birden fazla cihazda kullanmanıza olanak sağlar.';
z.string.tr.auth_verify_account_headline =
  'Bir e-posta adresi ve şifre ekleyin.';
z.string.tr.auth_verify_account_logout = 'Çıkış yap';
z.string.tr.auth_verify_code_description =
  '%@ numarasına gönderdiğimiz doğrulama kodunu girin.';
z.string.tr.auth_verify_code_resend = 'Kod gelmedi mi?';
z.string.tr.auth_verify_code_resend_detail = 'Tekrar gönder';
z.string.tr.auth_verify_code_resend_timer =
  '%e içerisinde yeni bir kod isteyebilirsiniz.';
...
z.string.tr.auth_limit_description =
  'Bu cihazda Wire’ı kullanabilmek için diğer cihazlarınızdan birini kaldırınız.';
...
z.string.tr.auth_history_headline =
  'Wire’ı bu cihazda ilk kez kullanıyorsunuz.';
z.string.tr.auth_history_description =
  'Gizlilik sebeplerinden ötürü, mesaj geçmişiniz burada gösterilmemektedir.';
z.string.tr.auth_history_reuse_headline =
  'Bu cihazdan daha önce Wire kullanmışsınız.';
z.string.tr.auth_history_reuse_description =
  'Bu sırada gönderilen mesajlar burada görünmeyecektir.';
z.string.tr.auth_history_button = 'TAMAM';

z.string.tr.auth_posted_change_email = 'E-posta değiştir';
z.string.tr.auth_posted_offline_detail =
  'İnternet bağlantınızı kontrol edin ve tekrar deneyin.';
z.string.tr.auth_posted_offline_headline = 'Wire çevrimiçi olunca daha güzel.';
z.string.tr.auth_posted_pending_detail =
  'Gelen kutunuzu kontrol edin veya aktivasyonu tekrar gönderin.';
...
z.string.tr.auth_posted_resend_detail =
  'E-posta gelen kutunuzu kontrol edin ve talimatları izleyin.';
z.string.tr.auth_posted_resend_headline = 'E-posta geldi.';
z.string.tr.auth_posted_retry =
  'Yeniden deneyin ve %e adresine tekrar e-posta gönderin';
...
z.string.tr.auth_error_email_malformed =
  'Lütfen geçerli bir e-posta adresi girin.';
z.string.tr.auth_error_email_missing = 'Lütfen bir e-posta adresi girin.';
z.string.tr.auth_error_misc =
  'Bağlantı sorunları mevcut. Lütfen tekrar deneyin.';
...
z.string.tr.auth_error_phone_number_forbidden =
  'Üzgünüz. Bu telefon numarası yasaklı.';
...
z.string.tr.auth_error_sign_in =
  'Lütfen bilgilerinizi doğrulayıp öyle tekrar deneyiniz.';
...
z.string.tr.modal_block_conversation_message =
  '%@.name sizinle iletişim kuramayacak ve sizi grup konuşmalarına ekleyemeyecek.';
...
z.string.tr.modal_call_conversation_full_headline =
  'Arayacak çok fazla kişi var';
z.string.tr.modal_call_conversation_full_message =
  'Arama işlemi, kullanıcı sayısı en fazla %n olan konuşmalarda çalışır.';
z.string.tr.modal_call_no_video_in_group_headline =
  'Gruplarda görüntülü konuşma yok';
z.string.tr.modal_call_no_video_in_group_message =
  'Görüntülü konuşma, grup konuşmalarında yapılamıyor.';
...
z.string.tr.modal_call_second_ongoing_headline =
  'Aramayı başka bir cihazda kapa?';
z.string.tr.modal_call_second_ongoing_message =
  'Aynı anda tek bir aramada bulunabilirsiniz.';
...
z.string.tr.modal_call_second_outgoing_message =
  'Aynı anda tek bir aramada bulunabilirsiniz.';
z.string.tr.modal_call_second_outgoing_action = 'Kapat';
z.string.tr.modal_call_voice_channel_full_headline = 'Dolup taşmış';
z.string.tr.modal_call_voice_channel_full_message =
  'Burada sadece %n kişi için yer var.';
z.string.tr.modal_clear_conversation_headline =
  '%@.name’e ait içerikler silinsin mi?';
...
z.string.tr.modal_too_long_message =
  'En fazla %no karakterlik mesajlar gönderebilirsiniz.';
z.string.tr.modal_leave_conversation_headline =
  '"%@.name" görüşmesinden ayrılınsın mı?';
z.string.tr.modal_leave_conversation_message =
  'Katılımcılar bilgilendirilecek ve görüşme listenizden silinecek.';
z.string.tr.modal_leave_conversation_button = 'Ayrıl';
z.string.tr.modal_logout_headline = 'Veriyi Temizle?';
z.string.tr.modal_logout_message =
  'Bu cihazdaki tüm kişisel bilgileriniz ve görüşme kayıtlarınızı silin.';
z.string.tr.modal_logout_button = 'Çıkış yap';
z.string.tr.modal_new_device_headline =
  '%@.name yeni bir cihaz kullanmaya başladı';
z.string.tr.modal_new_device_headline_many =
  '%@.names yeni cihazlar kullanmaya başladılar';
z.string.tr.modal_new_device_headline_you =
  '%@.name yeni bir cihaz kullanmaya başladı';
z.string.tr.modal_new_device_message =
  'Hâlâ mesajlarınızı göndermek istiyor musunuz?';
z.string.tr.modal_new_device_call_accept = 'Aramayı kabul et';
z.string.tr.modal_new_device_call_anyway = 'Yine de ara';
z.string.tr.modal_new_device_call_incoming =
  'Hala aramayı kabul etmek istiyor musunuz?';
...
z.string.tr.modal_remove_device_message =
  'Cihazı kaldırmak için şifreniz gereklidir.';
...
z.string.tr.modal_too_many_members_message =
  'Görüşmeye en fazla %max kişi katılabilir. Burada %no kişi için daha boş yer var.';
z.string.tr.modal_uploads_parallel =
  'Tek seferde en fazla %no boyutunda dosya gönderebilirsiniz.';
...
z.string.tr.conversation_connection_cancel_request =
  'Bağlantı isteğini iptal et';
...
z.string.tr.conversation_unable_to_decrypt_1 =
  '%@names’den gelen bir mesaj alınamadı.';
z.string.tr.conversation_unable_to_decrypt_2 =
  '%@names’nin cihaz kimliği değişti. Teslim edilmemiş mesaj.';
...
z.string.tr.conversation_missed_messages =
  'Bir süredir bu cihazı kullanmıyorsun. Bazı mesajlar gösterilmeyebilir.';
...
z.string.tr.conversation_asset_upload_too_large =
  'En fazla %no büyüklüğünde dosyalar gönderebilirsiniz';
...
z.string.tr.conversations_no_conversations =
  'Bir konuşma başlatın veya insanları katılmaları için davet edin.';
...
z.string.tr.conversations_secondary_line_missed_call =
  '{{number}} cevapsız çağrı';
z.string.tr.conversations_secondary_line_missed_calls =
  '{{number}} cevapsız çağrı';
...
z.string.tr.conversations_secondary_line_person_left =
  '{{number}} kişi ayrıldı';
z.string.tr.conversations_secondary_line_people_left =
  '{{number}} kişi ayrıldı';
z.string.tr.conversations_secondary_line_person_added =
  '{{user2}}, {{user1}} tarafından eklendi';
...
z.string.tr.conversations_secondary_line_renamed =
  '{{user}} yeniden adlandırdı';
...
z.string.tr.invite_message =
  'Wire’dayım, %username olarak arat ya da get.wire.com adresini ziyaret et.';
z.string.tr.invite_message_no_email =
  'Wire’dayım. get.wire.com ’u ziyaret ederek bana bağlanabilirsin.';
...
z.string.tr.people_everyone_participates =
  'Bağlantıda olduğun herkes zaten bu görüşme içerisinde.';
z.string.tr.people_no_matches =
...
z.string.tr.people_tabs_devices_headline =
  'Wire her cihaza eşsiz bir parmak izi verir. %@.name ile karşılaştırın ve konuşmayı doğrulayın.';
z.string.tr.people_tabs_devices_why_verify = 'Neden konuşmayı doğrulamalıyız?';
z.string.tr.people_tabs_no_devices_headline =
  '%@.name, Wire’ın eski bir versiyonunu kullanıyor. Hiçbir cihaz burada gösterilmiyor.';
...
z.string.tr.people_tabs_device_detail_headline =
  'Bunun %bold%%@.names’in aygıtında gösterilen%end parmak iziyle eşleştiğini doğrulayın.';
...
z.string.tr.people_tabs_device_detail_show_my_device =
  'Cihaz parmak izimi göster';
...
z.string.tr.people_block_message =
  '%@.first_name sizinle iletişim kuramayacak ve sizi grup konuşmalarına ekleyemeyecek.';

z.string.tr.people_connect_headline = 'Kabul et?';
z.string.tr.people_connect_message =
  'Bu sizi %@.first_name ile bağlayacak ve bir konuşma başlatacak.';

z.string.tr.people_cancel_request_headline = 'İsteği İptal et?';
z.string.tr.people_cancel_request_message =
  '%@.first_name’e olan bağlantı isteğini iptal et.';

z.string.tr.people_leave_headline = 'Konuşmadan ayrıl?';
z.string.tr.people_leave_message =
  'Bu konuşmada, artık mesaj gönderemeyecek ve mesaj alamayacaksınız.';

z.string.tr.people_remove_headline = 'Çıkar?';
z.string.tr.people_remove_message =
  '%@.first_name bu konuşmaya mesaj gönderemeyecek ve bu konuşmadan mesaj alamayacak.';

z.string.tr.people_unblock_headline = 'Engeli kaldır?';
z.string.tr.people_unblock_message =
  '%@.first_name sizinle tekrardan iletişim kurabilecek ve sizi grup konuşmalarına ekleyebilecek.';
...
z.string.tr.preferences_account_username_hint =
  'En az 2 karakter. a—z, 0—9, ve yalnızca _.';
...
z.string.tr.preferences_av_permission_detail =
  'Tarayıcı Seçeneklerinizden aktifleştirin';
...
z.string.tr.preferences_options_data_checkbox =
  'Kullanım ve kilitlenme raporları';
z.string.tr.preferences_options_data_detail =
  'Anonim bilgiler göndererek Wire’ın daha iyi olmasını sağlayabilirsiniz.';
...
z.string.tr.preferences_options_notifications_obfuscate_message =
  'Göndereni göster';
z.string.tr.preferences_options_notifications_on = 'Göndereni ve mesajı göster';

z.string.tr.search_group_hint =
  'Yazmaya devam edin ya da bir grup oluşturmak için daha fazla kişi seçin';
...
z.string.tr.search_team_groups = 'Takım Konuşmaları';
z.string.tr.search_team_members = 'Takım Üyeleri';
z.string.tr.search_top_people = 'Enler';
z.string.tr.search_try_search =
  'İnsanları isimlerine veya kullanıcı adlarına göre bul';
...
z.string.tr.upload_google_message_error =
  'Bilgilerinzi alamadık. Lütfen kişileriniz yeniden içe aktarmayı deneyin.';
...
z.string.tr.warning_call_detail =
  'Sesli aramalar yapmak için tarayıcınızın mikrofona erişim izni alması gerekir.';
z.string.tr.warning_call_headline = 'Mikrofon olmadan arama yapılamaz';
z.string.tr.warning_call_unsupported_incoming =
  '%s.first_name arıyor. Ancak tarayıcınız sesli aramaları desteklemiyor.';
z.string.tr.warning_call_unsupported_outgoing =
  'Arama yapamazsınız çünkü tarayıcınız sesli aramaları desteklemiyor.';
z.string.tr.warning_call_issues =
  'Wire’ın bu versiyonu aramalara katılamaz. Lütfen kullanın';
z.string.tr.warning_call_upgrade_browser =
  'Arama yapmak için, Google Chrome’u güncelleyin.';
z.string.tr.warning_learn_more = 'Daha fazla bilgi';
z.string.tr.warning_not_found_camera =
  'Arama yapamıyorsunuz çünkü bilgisayarınızda bir kamera bulunmamaktadır.';
z.string.tr.warning_not_found_microphone =
  'Arama yapamıyorsunuz çünkü bilgisayarınızda bir mikrofon bulunmamaktadır.';
...
z.string.tr.warning_permission_denied_screen =
  'Tarayıcınız ekranınızı paylaşmak için gerekli izinleri sağlamalıdır.';
z.string.tr.warning_permission_request_camera =
  '%icon Kameraya erişime izin ver';
z.string.tr.warning_permission_request_microphone =
  '%icon Mikrofona erişime izin ver';
z.string.tr.warning_permission_request_notification =
  '%icon Bildirimlere izin ver';
...
z.string.tr.warning_connectivity_no_internet =
  'İnternet bağlantısı yok. Mesaj gönderemez veya mesaj alamazsınız.';
...
z.string.tr.system_notification_connection_accepted =
  'Bağlantı isteğinizi kabul etti';
...
z.string.tr.system_notification_conversation_create =
  '%s.first_name bir konuşma başlattı';
z.string.tr.system_notification_conversation_rename =
  '%s.first_name, konuşma ismini %name olarak değiştirdi';
z.string.tr.system_notification_member_join_many =
  '%s.first_name, konuşmaya %no kişi ekledi';
z.string.tr.system_notification_member_join_one =
  '%s.first_name, %@.first_name’i konuşmaya ekledi';
z.string.tr.system_notification_member_leave_left =
  '%s.first_name konuşmadan ayrıldı';
z.string.tr.system_notification_member_leave_removed_many =
  '%s.first_name, konuşmadan %no kişi çıkardı';
z.string.tr.system_notification_member_leave_removed_one =
  '%s.first_name, %@.first_name’i konuşmadan çıkardı';
...
z.string.tr.tooltip_preferences_contacts_gmail =
  'Kişilerinizi paylaşmak için Gmail hesabınıza giriş yapınız';
z.string.tr.tooltip_preferences_contacts_macos =
  'MacOS Kişiler uygulaması aracılığıyla tüm kişilerinizi paylaşın';
z.string.tr.tooltip_preferences_password =
  'Şifreyi sıfırlamak için yeni bir pencere aç';
...
z.string.tr.init_validated_client =
  'Bağlantılarınız ve konuşmalarınız alınıyor';
