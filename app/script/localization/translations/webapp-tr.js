...
z.string.tr.modalSessionResetMessage_1 = 'Eğer sorun çözülmemişse,';
z.string.tr.modalSessionResetMessageLink = 'iletişime geç';
z.string.tr.modalSessionResetMessage_2 = 'biz.';
...
z.string.tr.conversationUnableToDecrypt_1 = '{{user}}’den gelen bir mesaj alınamadı.';
z.string.tr.conversationUnableToDecrypt_2 = '{{user}}’nin cihaz kimliği değişti. Teslim edilmemiş mesaj.';
...
z.string.tr.inviteHintSelected = 'Kopyalamak için {{metaKey}} + C';
z.string.tr.inviteHintUnselected = 'Seç ve {{metaKey}} + C tuşlarına bas';
...
z.string.tr.peopleButtonAddPeople = 'Kişileri Ekle';
...
z.string.tr.preferencesAccountCreateTeam = 'Takım oluştur';
