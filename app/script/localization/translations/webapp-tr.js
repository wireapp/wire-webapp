...
z.string.tr.auth_verify_code_description =
  '{{number}} gönderdiğimiz doğrulama kodunu girin.';
...
z.string.tr.auth_verify_code_resend_timer =
  '{{expiration}} içerisinde yeni bir kod isteyebilirsiniz.';
...
z.string.tr.auth_posted_retry =
  'Yeniden deneyin ve {{email}} adresine tekrar e-posta gönderin';
...
z.string.tr.modal_clear_conversation_headline =
  '{{user}}’e ait içerikler silinsin mi?';
...
z.string.tr.modal_too_long_message =
  'En fazla {{number}} karakterlik mesajlar gönderebilirsiniz.';
z.string.tr.modal_leave_conversation_headline =
  '"{{user}}" görüşmesinden ayrılınsın mı?';
...
z.string.tr.modal_new_device_headline =
  '{{user}} yeni bir cihaz kullanmaya başladı';
z.string.tr.modal_new_device_headline_many =
  '{{user}}s yeni cihazlar kullanmaya başladılar';
...
z.string.tr.modal_uploads_parallel =
  'Tek seferde en fazla {{number}} boyutunda dosya gönderebilirsiniz.';
...
z.string.tr.conversation_create = ' {{users}} ile bir konuşma başlattı';
z.string.tr.conversation_create_you = ' {{users}} ile bir konuşma başlattı';
...
z.string.tr.conversation_device_user_devices = ' {{user}} ’in cihazları';
...
z.string.tr.conversation_member_join = ' {{users}} eklendi';
z.string.tr.conversation_member_join_you = ' {{users}} eklendi';
z.string.tr.conversation_member_leave_left = ' ayrıldı';
z.string.tr.conversation_member_leave_left_you = ' ayrıldı';
z.string.tr.conversation_member_leave_removed = ' {{users}}, attı';
z.string.tr.conversation_member_leave_removed_you = ' {{users}}, attı';
...
z.string.tr.conversation_resume = '{{users}} ile bir görüşme başlat';
z.string.tr.conversation_team_leave = ' takımdan çıkartıldı';
...
z.string.tr.conversation_unable_to_decrypt_1 =
  '{{users}}’den gelen bir mesaj alınamadı.';
z.string.tr.conversation_unable_to_decrypt_2 =
  '{{users}}’nin cihaz kimliği değişti. Teslim edilmemiş mesaj.';
...
z.string.tr.conversation_asset_upload_too_large =
  'En fazla {{number}} büyüklüğünde dosyalar gönderebilirsiniz';
...
z.string.tr.conversation_delete_timestamp = '{{date}} ’da silinmiş';
...
z.string.tr.conversations_secondary_line_people_left =
  '{{number}} kişi ayrıldı';
z.string.tr.conversations_secondary_line_person_left = '{{user}} ayrıldı';
z.string.tr.conversations_secondary_line_person_removed = '{{user}} çıkartıldı';
z.string.tr.conversations_secondary_line_people_added = '{{user}} kişi eklendi';
z.string.tr.conversations_secondary_line_person_added = '{{user}} eklendi';
z.string.tr.conversations_secondary_line_person_added_you =
  '{{user}} seni ekledi';
z.string.tr.conversations_secondary_line_renamed =
  '{{user}} konuşmayı yeniden adlandırdı';
...
z.string.tr.people_remove_message =
  '{{user}} bu konuşmaya mesaj gönderemeyecek ve bu konuşmadan mesaj alamayacak.';
...
z.string.tr.warning_call_unsupported_incoming =
  '{{user}} arıyor. Ancak tarayıcınız sesli aramaları desteklemiyor.';
...
z.string.tr.warning_permission_request_screen =
  '{{icon}} Ekrana erişime izin ver';
...
z.string.tr.system_notification_conversation_create =
  '{{user}} bir konuşma başlattı';
z.string.tr.system_notification_conversation_rename =
  '{{user}}, konuşma ismini {{name}} olarak değiştirdi';
z.string.tr.system_notification_member_join_many =
  '{{user}}, konuşmaya {{number}} kişi ekledi';
z.string.tr.system_notification_member_join_one =
  '{{user1}}, {{user2}}’i konuşmaya ekledi';
z.string.tr.system_notification_member_leave_removed_you =
  '{{user}} sizi konuşmadan çıkardı';
...
z.string.tr.tooltip_conversations_tooltip_start =
  'Konuşma başlat ({{shortcut}})';
...
z.string.tr.init_events_progress =
  'Mesajlar yükleniyor - {{number2}}’de {{number1}}';
