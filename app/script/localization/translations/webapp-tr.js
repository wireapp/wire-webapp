...
z.string.tr.auth_error_pending = 'Hesap doğrulanamadı';
z.string.tr.auth_error_phone_number_budget = 'Çok sık giriş yaptınız. Tekrardan deneyin.';
...
z.string.tr.modal_bots_confirm_button = 'Onay';
z.string.tr.modal_bots_unavailable_headline = 'Botlar şuanda kullanılabilir değil';
z.string.tr.modal_bots_unavailable_message = 'Botlara ilginiz için teşekkür ederiz. Bir bir sonraki sürüm üzerinde çalışırken hizmet askıya alınmış. Beklemede kalın.';
...
z.string.tr.modal_clear_conversation_headline = 'İçerik silinsin?';
...
z.string.tr.modal_too_long_message = 'En fazla {{number}} karakterlik mesajlar gönderebilirsiniz.';
z.string.tr.modal_leave_conversation_headline = '"{{user}}" görüşmesinden ayrılınsın mı?';
...
z.string.tr.modal_new_device_headline = '{{user}} yeni bir cihaz kullanmaya başladı';
z.string.tr.modal_new_device_headline_many = '{{user}}s yeni cihazlar kullanmaya başladılar';
z.string.tr.modal_new_device_headline_you = '{{user}} yeni bir cihaz kullanmaya başladı';
...
z.string.tr.modal_not_connected_message_one = '{{name}} sohbetlere eklenmek istemiyor.';
z.string.tr.modal_not_connected_message_many = 'Seçtiğin kişilerden biri sohbetlere eklenmek istemiyor.';
...
z.string.tr.conversation_unable_to_decrypt_1 = '{{user}}’den gelen bir mesaj alınamadı.';
z.string.tr.conversation_unable_to_decrypt_2 = '{{user}}’nin cihaz kimliği değişti. Teslim edilmemiş mesaj.';
...
z.string.tr.conversation_asset_upload_too_large = 'En fazla {{number}} büyüklüğünde dosyalar gönderebilirsiniz';
...
z.string.tr.conversations_secondary_line_person_added_you = '{{user}} seni ekledi';
z.string.tr.conversations_secondary_line_renamed = '{{user}} konuşmayı yeniden adlandırdı';
...
z.string.tr.people_invite = 'İnsanları Wire’a katılmaya davet edin';
...
z.string.tr.people_services = 'Servisler';
...
z.string.tr.people_tabs_people = 'İnsanlar';
z.string.tr.people_tabs_services = 'Servisler';
z.string.tr.people_verified = 'Doğrulanmış';

z.string.tr.people_block_headline = 'Engelle?';
z.string.tr.people_block_message = '{{user}} sizinle iletişim kuramayacak ve sizi grup konuşmalarına ekleyemeyecek.';

z.string.tr.people_connect_headline = 'Kabul et?';
z.string.tr.people_connect_message = 'Bu sizi {{user}} ile bağlayacak ve bir konuşma başlatacak.';

z.string.tr.people_cancel_request_headline = 'İsteği İptal et?';
z.string.tr.people_cancel_request_message = '{{user}}’e olan bağlantı isteğini iptal et.';
...
z.string.tr.preferences_account_manage_team = 'Takım yönet';
...
z.string.tr.search_people = 'İnsanlar';
z.string.tr.search_placeholder = 'İsim veya kullanıcı adına göre ara';
z.string.tr.search_services = 'Servisler';
...
z.string.tr.tooltip_conversation_input_placeholder_available = '{{user}} müsait';
z.string.tr.tooltip_conversation_input_placeholder_away = '{{user}} uzakta';
z.string.tr.tooltip_conversation_input_placeholder_busy = '{{user}} meşgul';
