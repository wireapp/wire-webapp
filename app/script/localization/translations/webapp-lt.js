...
z.string.lt.modal_clear_conversation_headline =
  'Ištrinti pokalbio su "{{user}}" turinį?';
...
z.string.lt.modal_too_long_message =
  'Jūs galite siųsti žinutes iki {{number}} simbolių ilgio.';
z.string.lt.modal_leave_conversation_headline =
  'Išeiti iš "{{user}}" pokalbio?';
...
z.string.lt.modal_new_device_headline =
  '{{user}} pradėjo naudoti naują įrenginį';
z.string.lt.modal_new_device_headline_many =
  '{{user}}s pradėjo naudoti naujus įrenginius';
z.string.lt.modal_new_device_headline_you =
  '{{user}} pradėjote naudoti naują įrenginį';
...
z.string.lt.modal_uploads_parallel =
  'Jūs vienu metu galite siųsti iki {{number}} failų.';
...
z.string.lt.conversation_create = ' pradėjo pokalbį su {{users}}';
z.string.lt.conversation_create_you = ' pradėjote pokalbį su {{users}}';
...
z.string.lt.conversation_device_user_devices = ' {{user}} įrenginių';
...
z.string.lt.conversation_member_join = ' pridėjo {{users}}';
z.string.lt.conversation_member_join_you = ' pridėjote {{users}}';
z.string.lt.conversation_member_leave_left = ' išėjo';
z.string.lt.conversation_member_leave_left_you = ' išėjote';
z.string.lt.conversation_member_leave_removed = ' pašalino {{users}}';
z.string.lt.conversation_member_leave_removed_you = ' pašalinote {{users}}';
...
z.string.lt.conversation_resume = 'Pradėti pokalbį su {{users}}';
...
z.string.lt.conversation_asset_upload_too_large =
  'Jūs galite siųsti failus iki {{number}}';
...
z.string.lt.conversation_delete_timestamp = 'Ištrinta {{date}}';
z.string.lt.conversation_edit_timestamp = 'Taisyta {{date}}';
...
z.string.lt.invite_hint_unselected =
  'Pažymėkite ir paspauskite {{meta_key}} + C';
...
z.string.lt.people_tabs_no_devices_headline =
  '{{user}} naudoja seną Wire versiją. Čia nerodomi jokie įrenginiai.';
...
z.string.lt.people_remove_message =
  '{{user}} negalės siųsti ir gauti žinutes šiame pokalbyje.';

z.string.lt.people_unblock_headline = 'Atblokuoti?';
z.string.lt.people_unblock_message =
  '{{user}} galės ir vėl su jumis susisiekti ar pridėti jus į grupės pokalbius.';
...
z.string.lt.warning_call_unsupported_incoming =
  'Skambina {{user}}. Jūsų naršyklė nepalaiko skambučių.';
...
z.string.lt.warning_permission_request_notification =
  '{{icon}} Leisti pranešimus';
...
z.string.lt.tooltip_conversations_silence =
  'Išjungti pranešimus ({{shortcut}})';
z.string.lt.tooltip_conversations_tooltip_start =
  'Pradėti pokalbį ({{shortcut}})';
...
z.string.lt.init_events_progress =
  'Įkeliamos žinutės - {{number1}} iš {{number2}}';
