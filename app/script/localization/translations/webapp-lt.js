...
z.string.lt.auth_history_headline = 'Tai yra pirmas kartas, kai naudojate Wire šiame įrenginyje.';
z.string.lt.auth_history_description = 'Privatumo sumetimais, jūsų pokalbio istorija čia nebus rodoma.';
z.string.lt.auth_history_reuse_headline = 'Jūs jau esate naudoję Wire šiame įrenginyje.';
...
z.string.lt.auth_posted_offline_detail = 'Patikrinkite savo interneto ryšį ir bandykite dar kartą.';
z.string.lt.auth_posted_offline_headline = 'Wire yra geresnė, prisijungus prie interneto.';
z.string.lt.auth_posted_pending_detail = 'Patikrinkite savo el. paštą arba iš naujo siųskite aktyvaciją.';
...
z.string.lt.auth_posted_retry = 'Bandyti iš naujo ir siųsti el. laišką į %email';
...
z.string.lt.auth_error_email_malformed = 'Prašome įvesti taisyklingą el. pašto adresą.';
...
z.string.lt.auth_error_password_wrong = 'Neteisingas slaptažodis. Prašome bandyti dar kartą.';
...
z.string.lt.modal_block_conversation_message = '%@.name negalės su jumis susisiekti ar pridėti jus į grupės pokalbius.';
...
z.string.lt.modal_call_conversation_full_headline = 'Per daug žmonių, norint skambinti';
z.string.lt.modal_call_conversation_full_message = 'Skambučiai veikia pokalbiuose, kuriuose yra ne daugiau %no žmonių.';
z.string.lt.modal_call_no_video_in_group_headline = 'Vaizdo skambučiai grupėse nepalaikomi';
z.string.lt.modal_call_no_video_in_group_message = 'Vaizdo skambučiai grupės pokalbiuose yra neprieinami.';
z.string.lt.modal_call_second_incoming_headline = 'Atsiliepti į skambutį?';
z.string.lt.modal_call_second_incoming_message = 'Jūsų dabartinis skambutis bus užbaigtas.';
z.string.lt.modal_call_second_incoming_action = 'Atsiliepti';
z.string.lt.modal_call_second_ongoing_headline = 'Užbaigti skambutį kitame įrenginyje?';
z.string.lt.modal_call_second_ongoing_message = 'Jūs vienu metu galite dalyvauti tik viename skambutyje.';
...
z.string.lt.modal_call_second_outgoing_message = 'Jūs vienu metu galite dalyvauti tik viename skambutyje.';
z.string.lt.modal_call_second_outgoing_action = 'Užbaigti';
z.string.lt.modal_call_voice_channel_full_headline = 'Balso kanalas perpildytas';
z.string.lt.modal_call_voice_channel_full_message = 'Čia liko vietos tik %no žmonėms.';
z.string.lt.modal_clear_conversation_headline = 'Ištrinti pokalbio su "%@.name" turinį?';
z.string.lt.modal_clear_conversation_message = 'Tai ištrins pokalbio istoriją ir pašalins jį iš jūsų sąrašo.';
...
z.string.lt.modal_too_long_message = 'Jūs galite siųsti žinutes iki %no simbolių ilgio.';
z.string.lt.modal_leave_conversation_headline = 'Išeiti iš "%@.name" pokalbio?';
z.string.lt.modal_leave_conversation_message = 'Dalyviams bus pranešta ir pokalbis bus pašalintas iš jūsų sąrašo.';
z.string.lt.modal_leave_conversation_button = 'Išeiti';
z.string.lt.modal_logout_headline = 'Išvalyti duomenis?';
z.string.lt.modal_logout_message = 'Ištrinti visą jūsų asmeninę informaciją ir pokalbius šiame įrenginyje.';
z.string.lt.modal_logout_button = 'Atsijungti';
z.string.lt.modal_new_device_headline = '%@.name pradėjo naudoti naują įrenginį';
z.string.lt.modal_new_device_headline_many = '%@.names pradėjo naudoti naujus įrenginius';
z.string.lt.modal_new_device_headline_you = '%@.name pradėjote naudoti naują įrenginį';
z.string.lt.modal_new_device_message = 'Ar vis dar norite išsiųsti savo žinutes?';
z.string.lt.modal_new_device_call_accept = 'Priimti skambutį';
z.string.lt.modal_new_device_call_anyway = 'Vis tiek skambinti';
z.string.lt.modal_new_device_call_incoming = 'Ar vis dar norite priimti skambutį?';
z.string.lt.modal_new_device_call_outgoing = 'Ar vis dar norite atlikti skambutį?';
...
z.string.lt.modal_too_many_members_message = 'Prie pokalbio gali prisijungti iki %max žmonių. Čia yra vietos tik dar %no žmonėms.';
z.string.lt.modal_uploads_parallel = 'Jūs vienu metu galite siųsti iki %no failų.';
...
z.string.lt.conversation_device_unverified = ' panaikinote patvirtinimą vieno iš';
...
z.string.lt.conversation_device_new_people_joined_verify = ' patvirtinkite įrenginius';
...
z.string.lt.conversation_unable_to_decrypt_1 = 'žinutė nuo %@name nebuvo gauta.';
z.string.lt.conversation_unable_to_decrypt_2 = 'Pasikeitė %@name įrenginio tapatybė. Žinutė nepristatyta.';
...
z.string.lt.conversation_asset_upload_too_large = 'Jūs galite siųsti failus iki %no';
...
z.string.lt.conversations_no_conversations = 'Pradėkite pokalbį arba pakvieskite žmones prisijungti.';
...
z.string.lt.conversations_secondary_line_missed_call = '{{number}} praleistas skambutis';
z.string.lt.conversations_secondary_line_missed_calls = '{{number}} praleistų skambučių';
z.string.lt.conversations_secondary_line_new_message = '{{number}} nauja žinutė';
z.string.lt.conversations_secondary_line_new_messages = '{{number}} naujų žinučių';
...
z.string.lt.people_no_matches = 'Nėra atitinkančių rezultatų.\nPabandykite įvesti kitą vardą.';
...
z.string.lt.people_tabs_devices_headline = 'Wire kiekvienam įrenginiui suteikia unikalų kontrolinį kodą. Palyginkite juos su %@.name ir patvirtinkite savo pokalbį.';
z.string.lt.people_tabs_devices_why_verify = 'Kam patvirtinti pokalbį?';
z.string.lt.people_tabs_no_devices_headline = '%@.name naudoja seną Wire versiją. Čia nerodomi jokie įrenginiai.';
...
z.string.lt.people_tabs_device_detail_headline = 'Įsitikinkite, kad šis kontrolinis kodas yra toks pats, kaip ir įrenginyje, kurį naudoja %bold%@.name%end.';
...
z.string.lt.people_block_message = '%@.first_name negalės su jumis susisiekti ar pridėti jus į grupės pokalbius.';

z.string.lt.people_connect_headline = 'Priimti?';
z.string.lt.people_connect_message = 'Tai užmegs kontaktą ir atvers pokalbį su %@.first_name.';

z.string.lt.people_cancel_request_headline = 'Atsisakyti užklausos?';
z.string.lt.people_cancel_request_message = 'Šalinti kontakto užmezgimo su %@.first_name užklausą.';

z.string.lt.people_leave_headline = 'Išeiti iš pokalbio?';
z.string.lt.people_leave_message = 'Jūs daugiau nebegalėsite gauti ar siųsti žinutes šiame pokalbyje.';

z.string.lt.people_remove_headline = 'Šalinti?';
z.string.lt.people_remove_message = '%@.first_name negalės siųsti ir gauti žinutes šiame pokalbyje.';

z.string.lt.people_unblock_headline = 'Atblokuoti?';
z.string.lt.people_unblock_message = '%@.first_name galės ir vėl su jumis susisiekti ar pridėti jus į grupės pokalbius.';
...
z.string.lt.preferences_av_permission_detail = 'Įjunkite savo naršyklės nuostatose';
...
z.string.lt.preferences_options_audio_some_detail = 'Ryšio tikrinimai ir skambučiai';
...
z.string.lt.preferences_options_notifications_obfuscate = 'Slėpti išsamesnę informaciją';
...
z.string.lt.url_support_calling = 'https://support.wire.com/hc/en-us/articles/202969412';
z.string.lt.url_support_camera_access_denied = 'https://support.wire.com/hc/en-us/articles/202935412';
z.string.lt.url_support_device_access_denied = 'https://support.wire.com/hc/en-us/articles/213512545';
z.string.lt.url_support_contact = 'https://support.wire.com/hc/en-us/requests/new';
z.string.lt.url_support_contact_bug = 'https://support.wire.com/hc/en-us/requests/new?ticket_form_id=101615';
z.string.lt.url_support_history = 'https://support.wire.com/hc/en-us/articles/207834645';
z.string.lt.url_support_mic_access_denied = 'https://support.wire.com/hc/en-us/articles/202590081';
z.string.lt.url_support_mic_not_found = 'https://support.wire.com/hc/en-us/articles/202970662';
z.string.lt.url_support_screen_access_denied = 'https://support.wire.com/hc/en-us/articles/202935412';
z.string.lt.url_support_screen_whitelist = 'https://support.wire.com/hc/en-us/articles/209423889';
...
z.string.lt.warning_call_unsupported_incoming = 'Skambina %s.first_name. Jūsų naršyklė nepalaiko skambučių.';
z.string.lt.warning_call_unsupported_outgoing = 'Jūs negalite skambinti, nes jūsų naršyklė nepalaiko skambučių.';
z.string.lt.warning_call_issues = 'Ši Wire versija negali dalyvauti skambutyje. Prašome naudoti';
z.string.lt.warning_call_upgrade_browser = 'Norėdami skambinti, atnaujinkite Google Chrome.';
...
z.string.lt.system_notification_conversation_create = '%s.first_name pradėjo pokalbį';
z.string.lt.system_notification_conversation_rename = '%s.first_name pervadino pokalbį į %name';
z.string.lt.system_notification_member_join_many = '%s.first_name pridėjo %no žmones(-ių) į pokalbį';
z.string.lt.system_notification_member_join_one = '%s.first_name pridėjo %@.first_name į pokalbį';
z.string.lt.system_notification_member_leave_left = '%s.first_name išėjo iš pokalbio';
z.string.lt.system_notification_member_leave_removed_many = '%s.first_name pašalino %no žmones iš pokalbio';
z.string.lt.system_notification_member_leave_removed_one = '%s.first_name pašalino %@.first_name iš pokalbio';
...
z.string.lt.tooltip_preferences_contacts_gmail = 'Prisijunkite prie savo Gmail paskyros, norėdami bendrinti kontaktus';
z.string.lt.tooltip_preferences_contacts_macos = 'Bendrinti visus savo kontaktus iš macOS Kontaktų programos';
z.string.lt.tooltip_preferences_password = 'Atverti kitą svetainę, skirtą slaptažodžio atstatymui';
