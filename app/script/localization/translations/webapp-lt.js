...
z.string.lt.alert_upload_file_format =
...
z.string.lt.alert_upload_too_large =
  'Šis paveikslas yra per didelis.\nJūs galite įkelti failus iki %no MB.';
z.string.lt.alert_gif_too_large =
  'Animacija yra per didelė.\nDidžiausias dydis yra %no MB.';
...
z.string.lt.auth_verify_account_detail =
  'Tai leidžia jums naudoti Wire keliuose įrenginiuose.';
z.string.lt.auth_verify_account_headline =
  'Pridėkite el. pašto adresą ir slaptažodį.';
z.string.lt.auth_verify_account_logout = 'Atsijungti';
z.string.lt.auth_verify_code_description =
...
z.string.lt.auth_verify_code_resend_timer =
  'Jūs galite užklausti naują kodą %expiration.';
...
z.string.lt.auth_history_headline =
  'Tai yra pirmas kartas, kai naudojate Wire šiame įrenginyje.';
z.string.lt.auth_history_description =
  'Privatumo sumetimais, jūsų pokalbio istorija čia nebus rodoma.';
z.string.lt.auth_history_reuse_headline =
  'Jūs jau esate naudoję Wire šiame įrenginyje.';
z.string.lt.auth_history_reuse_description =
  'Per tą laikotarpį išsiųstos žinutės, čia nebus rodomos.';
z.string.lt.auth_history_button = 'GERAI';

z.string.lt.auth_posted_change_email = 'Pakeisti el. paštą';
z.string.lt.auth_posted_offline_detail =
  'Patikrinkite savo interneto ryšį ir bandykite dar kartą.';
z.string.lt.auth_posted_offline_headline =
  'Wire yra geresnė, prisijungus prie interneto.';
z.string.lt.auth_posted_pending_detail =
  'Patikrinkite savo el. paštą arba iš naujo siųskite aktyvaciją.';
z.string.lt.auth_posted_pending_headline = 'Paskyra jau laukia patvirtinimo';
z.string.lt.auth_posted_resend = 'Siųsti iš naujo į %email';
z.string.lt.auth_posted_resend_action = 'Negaunate el. laiško?';
z.string.lt.auth_posted_resend_detail =
  'Patikrinkite savo el. paštą ir sekite nurodymus.';
z.string.lt.auth_posted_resend_headline = 'Jūs gavote laišką.';
z.string.lt.auth_posted_retry =
  'Bandyti iš naujo ir siųsti el. laišką į %email';
z.string.lt.auth_posted_retry_action = 'Bandyti dar kartą?';
z.string.lt.auth_posted_retry_detail = 'Prašome bandyti dar kartą.';
z.string.lt.auth_posted_retry_headline = 'Kažkas nutiko';
z.string.lt.auth_posted_verify_later = 'Patvirtinti vėliau';

z.string.lt.auth_placeholder_email = 'El. paštas';
z.string.lt.auth_placeholder_name = 'Vardas';
...
z.string.lt.auth_error_email_forbidden =
  'Atleiskite. Šis el. pašto adresas yra uždraustas.';
z.string.lt.auth_error_email_malformed =
  'Prašome įvesti taisyklingą el. pašto adresą.';
z.string.lt.auth_error_email_missing = 'Prašome įvesti el. pašto adresą.';
z.string.lt.auth_error_misc = 'Problemos su ryšiu. Prašome bandyti dar kartą.';
z.string.lt.auth_error_name_short = 'Įveskite bent 2 simbolių vardą';
z.string.lt.auth_error_offline = 'Nėra interneto ryšio';
z.string.lt.auth_error_password_short =
  'Pasirinkite bent 8 simbolių slaptažodį.';
z.string.lt.auth_error_password_wrong =
  'Neteisingas slaptažodis. Prašome bandyti dar kartą.';
z.string.lt.auth_error_phone_number_forbidden =
  'Atleiskite. Šis telefono numeris yra uždraustas.';
...
z.string.lt.auth_error_sign_in =
  'Patvirtinkite savo duomenis ir bandykite dar kartą.';
...
z.string.lt.call_decline = 'Atmesti';
...
z.string.lt.modal_block_conversation_headline = 'Užblokuoti %@.name?';
z.string.lt.modal_block_conversation_message =
  '%@.name negalės su jumis susisiekti ar pridėti jus į grupės pokalbius.';
...
z.string.lt.modal_call_no_video_in_group_message =
  'Vaizdo skambučiai grupės pokalbiuose yra neprieinami.';
z.string.lt.modal_call_second_incoming_headline = 'Atsiliepti į skambutį?';
z.string.lt.modal_call_second_incoming_message =
  'Jūsų dabartinis skambutis bus užbaigtas.';
z.string.lt.modal_call_second_incoming_action = 'Atsiliepti';
z.string.lt.modal_call_second_ongoing_headline =
  'Užbaigti skambutį kitame įrenginyje?';
z.string.lt.modal_call_second_ongoing_message =
  'Jūs vienu metu galite dalyvauti tik viename skambutyje.';
z.string.lt.modal_call_second_ongoing_action = 'Užbaigti';
z.string.lt.modal_call_second_outgoing_headline = 'Užbaigti esamą skambutį?';
...
z.string.lt.modal_clear_conversation_message =
  'Tai ištrins pokalbio istoriją ir pašalins jį iš jūsų sąrašo.';
z.string.lt.modal_clear_conversation_option = 'Taip pat išeiti iš pokalbio';
...
z.string.lt.modal_delete_everyone_button = 'Ištrinti';
z.string.lt.modal_delete_everyone_headline = 'Ištrinti visiems?';
z.string.lt.modal_delete_everyone_message = 'To negalima bus atšaukti.';
z.string.lt.modal_too_long_headline = 'Žinutė pernelyg ilga';
z.string.lt.modal_too_long_message =
  'Jūs galite siųsti žinutes iki %no simbolių ilgio.';
z.string.lt.modal_leave_conversation_headline = 'Išeiti iš "%@.name" pokalbio?';
z.string.lt.modal_leave_conversation_message =
  'Dalyviams bus pranešta ir pokalbis bus pašalintas iš jūsų sąrašo.';
z.string.lt.modal_leave_conversation_button = 'Išeiti';
z.string.lt.modal_logout_headline = 'Išvalyti duomenis?';
z.string.lt.modal_logout_message =
  'Ištrinti visą jūsų asmeninę informaciją ir pokalbius šiame įrenginyje.';
z.string.lt.modal_logout_button = 'Atsijungti';
z.string.lt.modal_new_device_headline =
  '%@.name pradėjo naudoti naują įrenginį';
z.string.lt.modal_new_device_headline_many =
  '%@.names pradėjo naudoti naujus įrenginius';
z.string.lt.modal_new_device_headline_you =
  '%@.name pradėjote naudoti naują įrenginį';
z.string.lt.modal_new_device_message =
  'Ar vis dar norite išsiųsti savo žinutes?';
z.string.lt.modal_new_device_call_accept = 'Priimti skambutį';
z.string.lt.modal_new_device_call_anyway = 'Vis tiek skambinti';
z.string.lt.modal_new_device_call_incoming =
  'Ar vis dar norite priimti skambutį?';
z.string.lt.modal_new_device_call_outgoing =
  'Ar vis dar norite atlikti skambutį?';
z.string.lt.modal_new_device_show_device = 'rodyti įrenginį';
z.string.lt.modal_new_device_send_anyway = 'vis tiek išsiųsti';
z.string.lt.modal_remove_device_button = 'Šalinti įrenginį';
z.string.lt.modal_remove_device_headline = 'Šalinti "%device_name"';
z.string.lt.modal_remove_device_message =
  'Norint pašalinti įrenginį, reikalingas jūsų slaptažodis.';
...
z.string.lt.modal_too_many_members_message =
  'Prie pokalbio gali prisijungti iki %max žmonių. Čia yra vietos tik dar %no žmonėms.';
z.string.lt.modal_uploads_parallel =
  'Jūs vienu metu galite siųsti iki %no failų.';
...
z.string.lt.conversation_connection_cancel_request =
  'Atsisakyti kontakto užmezgimo užklausos';
z.string.lt.conversation_create = ' pradėjo pokalbį su %@names';
z.string.lt.conversation_create_you = ' pradėjote pokalbį su %@names';
z.string.lt.conversation_device_started_using_one = ' pradėjo naudoti';
z.string.lt.conversation_device_started_using_many = ' pradėjo naudoti';
z.string.lt.conversation_device_unverified =
  ' panaikinote patvirtinimą vieno iš';
z.string.lt.conversation_device_your_devices = ' savo įrenginių';
z.string.lt.conversation_device_user_devices = ' %@name įrenginių';
z.string.lt.conversation_device_new_device_one = ' naują įrenginį';
z.string.lt.conversation_device_new_device_many = ' naujus įrenginius';
z.string.lt.conversation_device_new_people_joined = 'prisijungė nauji žmonės.';
z.string.lt.conversation_device_new_people_joined_verify =
  ' patvirtinkite įrenginius';
z.string.lt.conversation_just_now = 'Ką tik';
z.string.lt.conversation_location_link = 'Atverti žemėlapį';
z.string.lt.conversation_member_join = ' pridėjo %@names';
z.string.lt.conversation_member_join_you = ' pridėjote %@names';
z.string.lt.conversation_member_leave_left = ' išėjo';
z.string.lt.conversation_member_leave_left_you = ' išėjote';
z.string.lt.conversation_member_leave_removed = ' pašalino %@names';
z.string.lt.conversation_member_leave_removed_you = ' pašalinote %@names';
z.string.lt.conversation_message_delivered = 'Pristatyta';
z.string.lt.conversation_rename = ' pervadino pokalbį';
z.string.lt.conversation_rename_you = ' pervadinote pokalbį';
z.string.lt.conversation_resume = 'Pradėti pokalbį su %@names';
z.string.lt.conversation_ping = ' patikrino ryšį';
z.string.lt.conversation_ping_you = ' patikrinote ryšį';
z.string.lt.conversation_today = 'šiandien';
z.string.lt.conversation_verified = 'Patvirtintas';
z.string.lt.conversation_voice_channel_deactivate = ' skambino';
z.string.lt.conversation_voice_channel_deactivate_you = ' skambinote';
z.string.lt.conversation_yesterday = 'Vakar';
z.string.lt.conversation_unable_to_decrypt_1 =
  'žinutė nuo %@name nebuvo gauta.';
z.string.lt.conversation_unable_to_decrypt_2 =
  'Pasikeitė %@name įrenginio tapatybė. Žinutė nepristatyta.';
...
z.string.lt.conversation_asset_upload_too_large =
  'Jūs galite siųsti failus iki %no';
z.string.lt.conversation_playback_error = 'Nepavyko atkurti';
z.string.lt.conversation_context_menu_edit = 'Taisyti';
z.string.lt.conversation_context_menu_delete = 'Ištrinti man';
z.string.lt.conversation_context_menu_delete_everyone = 'Ištrinti visiems';
z.string.lt.conversation_context_menu_download = 'Atsisiųsti';
z.string.lt.conversation_context_menu_like = 'Patinka';
z.string.lt.conversation_context_menu_unlike = 'Nebepatinka';
z.string.lt.conversation_delete_timestamp = 'Ištrinta %@timestamp';
...
z.string.lt.conversations_connection_request_many = 'Laukia %no žmonės';
...
z.string.lt.conversations_popover_clear = 'Ištrinti';
z.string.lt.conversations_popover_leave = 'Išeiti';
z.string.lt.conversations_popover_notify = 'Įjungti garsą';
z.string.lt.conversations_popover_silence = 'Nutildyti';
z.string.lt.conversations_popover_unarchive = 'Išarchyvuoti';

z.string.lt.conversations_secondary_line_missed_call =
  '{{number}} praleistas skambutis';
z.string.lt.conversations_secondary_line_missed_calls =
  '{{number}} praleistų skambučių';
z.string.lt.conversations_secondary_line_new_message =
  '{{number}} nauja žinutė';
z.string.lt.conversations_secondary_line_new_messages =
...
z.string.lt.invite_meta_key_pc = 'Ctrl (Vald)';
z.string.lt.invite_hint_selected =
  'Norėdami nukopijuoti, paspauskite %meta_key + C';
...
z.string.lt.invite_message =
  'Aš naudoju Wire. Ieškokite manęs kaip %username arba apsilankykite get.wire.com.';
z.string.lt.invite_message_no_email =
  'Aš naudoju Wire. Apsilankyk get.wire.com , kad su manimi susisiektum.';
...
z.string.lt.people_everyone_participates =
  'Visi, su kuo esate\nužmezgę kontaktą, jau yra\nšiame pokalbyje.';
z.string.lt.people_no_matches =
...
z.string.lt.people_tabs_devices_headline =
  'Wire kiekvienam įrenginiui suteikia unikalų kontrolinį kodą. Palyginkite juos su %@.name ir patvirtinkite savo pokalbį.';
z.string.lt.people_tabs_devices_why_verify = 'Kam patvirtinti pokalbį?';
z.string.lt.people_tabs_no_devices_headline =
  '%@.name naudoja seną Wire versiją. Čia nerodomi jokie įrenginiai.';
z.string.lt.people_tabs_device_detail_all_my_devices =
  'Rodyti visus mano įrenginius';
z.string.lt.people_tabs_device_detail_device_fingerprint =
  'Įrenginio kontrolinis kodas';
z.string.lt.people_tabs_device_detail_headline =
  'Įsitikinkite, kad šis kontrolinis kodas yra toks pats, kaip ir įrenginyje, kurį naudoja %bold%@.name%end.';
...
z.string.lt.people_tabs_device_detail_show_my_device =
  'Rodyti mano įrenginio kontrolinį kodą';
z.string.lt.people_tabs_device_detail_verify = 'Patvirtintas';
z.string.lt.people_verified = 'Patvirtintas';

z.string.lt.people_block_headline = 'Užblokuoti?';
z.string.lt.people_block_message =
  '%@.first_name negalės su jumis susisiekti ar pridėti jus į grupės pokalbius.';

z.string.lt.people_connect_headline = 'Priimti?';
z.string.lt.people_connect_message =
  'Tai užmegs kontaktą ir atvers pokalbį su %@.first_name.';

z.string.lt.people_cancel_request_headline = 'Atsisakyti užklausos?';
z.string.lt.people_cancel_request_message =
  'Šalinti kontakto užmezgimo su %@.first_name užklausą.';

z.string.lt.people_leave_headline = 'Išeiti iš pokalbio?';
z.string.lt.people_leave_message =
  'Jūs daugiau nebegalėsite gauti ar siųsti žinutes šiame pokalbyje.';

z.string.lt.people_remove_headline = 'Šalinti?';
z.string.lt.people_remove_message =
  '%@.first_name negalės siųsti ir gauti žinutes šiame pokalbyje.';

z.string.lt.people_unblock_headline = 'Atblokuoti?';
z.string.lt.people_unblock_message =
  '%@.first_name galės ir vėl su jumis susisiekti ar pridėti jus į grupės pokalbius.';
...
z.string.lt.people_button_create = 'Sukurti grupę';
z.string.lt.people_button_ignore = 'Nepaisyti';
z.string.lt.people_button_leave = 'Išeiti';
z.string.lt.people_button_open = 'Atverti pokalbį';
z.string.lt.people_button_pending = 'Laukia';
z.string.lt.people_button_profile = 'Profilis';
z.string.lt.people_button_remove = 'Šalinti';
z.string.lt.people_button_unblock = 'Atblokuoti';
z.string.lt.people_button_no = 'Ne';
z.string.lt.people_button_yes = 'Taip';

z.string.lt.preferences_about = 'Apie';
z.string.lt.preferences_account = 'Paskyra';
z.string.lt.preferences_av = 'Garsas / Vaizdas';
z.string.lt.preferences_device_details = 'Išsamesnė įrenginio informacija';
z.string.lt.preferences_devices = 'Įrenginiai';
...
z.string.lt.preferences_account_username_hint =
  'Bent 2 simboliai. Tik a—z, 0—9 ir _.';
z.string.lt.preferences_account_username_available = 'Prieinamas';
z.string.lt.preferences_account_username_error_taken = 'Jau užimtas';

z.string.lt.preferences_av_camera = 'Kamera';
z.string.lt.preferences_av_microphone = 'Mikrofonas';
z.string.lt.preferences_av_permission_detail =
  'Įjunkite savo naršyklės nuostatose';
z.string.lt.preferences_av_speakers = 'Garsiakalbiai';

z.string.lt.preferences_devices_activated_in = 'šalia %location';
z.string.lt.preferences_devices_activated_on = 'Aktyvuotas %time';
...
z.string.lt.preferences_devices_session_confirmation =
  'Seansas buvo atstatytas.';
...
z.string.lt.preferences_options_audio = 'Garso signalai';
z.string.lt.preferences_options_audio_all = 'Visi';
z.string.lt.preferences_options_audio_all_detail = 'Visi garsai';
z.string.lt.preferences_options_audio_none = 'Jokių';
z.string.lt.preferences_options_audio_none_detail = 'Ša!';
z.string.lt.preferences_options_audio_some = 'Kai kurie';
z.string.lt.preferences_options_audio_some_detail =
  'Ryšio tikrinimai ir skambučiai';
...
z.string.lt.preferences_options_data_checkbox =
  'Naudojimosi ir strigčių ataskaitos';
z.string.lt.preferences_options_data_detail =
  'Padarykite Wire geresnę, siųsdami anoniminę informaciją.';
z.string.lt.preferences_options_notifications = 'Pranešimai';
z.string.lt.preferences_options_notifications_none = 'Išjungta';
z.string.lt.preferences_options_notifications_obfuscate =
  'Slėpti išsamesnę informaciją';
z.string.lt.preferences_options_notifications_obfuscate_message =
  'Rodyti siuntėją';
z.string.lt.preferences_options_notifications_on = 'Rodyti siuntėją ir žinutę';

z.string.lt.search_group_hint =
  'Tęskite rašymą arba, norėdami sukurti grupę, pasirinkite daugiau žmonių';
z.string.lt.search_connect = 'Užmegzti kontaktą';
z.string.lt.search_connections = 'Kontaktai';
z.string.lt.search_groups = 'Grupės';
z.string.lt.search_placeholder = 'Ieškokite pagal vardą ar naudotojo vardą';
z.string.lt.search_team_groups = 'Komandos pokalbiai';
z.string.lt.search_team_members = 'Komandos dalyviai';
z.string.lt.search_top_people = 'Mėgstami žmonės';
z.string.lt.search_try_search =
  'Raskite žmones pagal vardą arba naudotojo vardą';
...
z.string.lt.url_legal = 'https://wire.com/legal/';
z.string.lt.url_privacy = 'https://wire.com/privacy/';
z.string.lt.url_privacy_how = 'https://wire.com/privacy/how/';
z.string.lt.url_privacy_why = 'https://wire.com/privacy/why/';
z.string.lt.url_support = 'https://support.wire.com';
z.string.lt.url_terms_of_use = 'https://wire.com/legal/terms/';
z.string.lt.url_wire = 'https://wire.com';
z.string.lt.url_wire_for_web = 'https://app.wire.com';
z.string.lt.url_support_calling =
  'https://support.wire.com/hc/en-us/articles/202969412';
z.string.lt.url_support_camera_access_denied =
  'https://support.wire.com/hc/en-us/articles/202935412';
z.string.lt.url_support_device_access_denied =
  'https://support.wire.com/hc/en-us/articles/213512545';
z.string.lt.url_support_contact =
  'https://support.wire.com/hc/en-us/requests/new';
z.string.lt.url_support_contact_bug =
  'https://support.wire.com/hc/en-us/requests/new?ticket_form_id=101615';
z.string.lt.url_support_history =
  'https://support.wire.com/hc/en-us/articles/207834645';
z.string.lt.url_support_mic_access_denied =
  'https://support.wire.com/hc/en-us/articles/202590081';
z.string.lt.url_support_mic_not_found =
  'https://support.wire.com/hc/en-us/articles/202970662';
z.string.lt.url_support_screen_access_denied =
  'https://support.wire.com/hc/en-us/articles/202935412';
z.string.lt.url_support_screen_whitelist =
  'https://support.wire.com/hc/en-us/articles/209423889';
z.string.lt.url_support_usernames = 'https://wire.com/support/username';
z.string.lt.url_decrypt_error_1 = 'https://wire.com/privacy/error-1';
z.string.lt.url_decrypt_error_2 = 'https://wire.com/privacy/error-2';

z.string.lt.warning_call_detail =
  'Norint skambinti, jūsų naršyklei reikia prieigos prie jūsų mikrofono.';
z.string.lt.warning_call_headline = 'Nepavyksta skambinti be mikrofono';
z.string.lt.warning_call_unsupported_incoming =
  'Skambina %s.first_name. Jūsų naršyklė nepalaiko skambučių.';
z.string.lt.warning_call_unsupported_outgoing =
  'Jūs negalite skambinti, nes jūsų naršyklė nepalaiko skambučių.';
z.string.lt.warning_call_issues =
  'Ši Wire versija negali dalyvauti skambutyje. Prašome naudoti';
z.string.lt.warning_call_upgrade_browser =
  'Norėdami skambinti, atnaujinkite Google Chrome.';
z.string.lt.warning_learn_more = 'Sužinoti daugiau';
z.string.lt.warning_not_found_camera =
  'Jūs negalite skambinti, nes jūsų kompiuteryje nėra kameros.';
z.string.lt.warning_not_found_microphone =
  'Jūs negalite skambinti, nes jūsų kompiuteryje nėra mikrofono.';
...
z.string.lt.warning_permission_denied_screen =
  'Norint bendrinti ekraną, jūsų naršyklei reikia leidimų.';
z.string.lt.warning_permission_request_camera =
  '%icon Leisti prieigą prie kameros';
z.string.lt.warning_permission_request_microphone =
  '%icon Leisti prieigą prie mikrofono';
z.string.lt.warning_permission_request_notification = '%icon Leisti pranešimus';
z.string.lt.warning_permission_request_screen =
  '%icon Leisti prieigą prie ekrano';
...
z.string.lt.warning_connectivity_no_internet =
  'Nėra interneto. Jūs negalėsite siųsti ir gauti žinutes.';
...
z.string.lt.system_notification_connection_accepted =
  'Priėmė jūsų kontakto užmezgimo užklausą';
z.string.lt.system_notification_connection_connected =
  'Dabar esate užmezgę kontaktą';
z.string.lt.system_notification_connection_request = 'Nori užmegzti kontaktą';
z.string.lt.system_notification_conversation_create =
  '%s.first_name pradėjo pokalbį';
z.string.lt.system_notification_conversation_rename =
  '%s.first_name pervadino pokalbį į %name';
z.string.lt.system_notification_member_join_many =
...
z.string.lt.tooltip_conversation_all_verified =
  'Visi kontroliniai kodai patvirtinti';
...
z.string.lt.tooltip_conversations_archived = 'Rodyti archyvą (%no)';
...
z.string.lt.tooltip_people_leave = 'Išeiti iš pokalbio';
z.string.lt.tooltip_people_open = 'Atverti pokalbį';
z.string.lt.tooltip_people_profile = 'Atverti jūsų profilį';
z.string.lt.tooltip_people_rename = 'Pakeisti pokalbio pavadinimą';
z.string.lt.tooltip_people_remove = 'Šalinti iš pokalbio';
z.string.lt.tooltip_people_unblock = 'Atblokuoti';

z.string.lt.tooltip_preferences_contacts_gmail =
  'Prisijunkite prie savo Gmail paskyros, norėdami bendrinti kontaktus';
z.string.lt.tooltip_preferences_contacts_macos =
  'Bendrinti visus savo kontaktus iš macOS Kontaktų programos';
z.string.lt.tooltip_preferences_password =
  'Atverti kitą svetainę, skirtą slaptažodžio atstatymui';
z.string.lt.tooltip_preferences_picture = 'Pakeisti savo paveikslą…';
z.string.lt.tooltip_preferences_rename = 'Pakeisti savo vardą';
