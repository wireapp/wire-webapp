...
z.string.it.conversations_secondary_line_person_left = '{{number}} utente ha abbandonato';
z.string.it.conversations_secondary_line_people_left = '{{number}} utenti hanno abbandonato';
z.string.it.conversations_secondary_line_person_added = '{{user1}} ha aggiunto {{user2}}';
