...
z.string.hr.alert_upload_too_large =
  'Ova slika je prevelika. Možete učitati datoteke do %no MB.';
z.string.hr.alert_gif_too_large =
  'Animacija je prevelika. Maksimalne veličine je %no MB.';
...
z.string.hr.modal_too_many_members_message =
  'Do %max ljudi može pristupiti razgovoru. Ima mjesta za još %no ljudi ovdje.';
...
z.string.hr.conversation_unable_to_decrypt_1 =
  'poruka od %@name nije primljena.';
z.string.hr.conversation_unable_to_decrypt_2 =
  '%@name identitet uređaja promijenjen. Neisporučena poruka.';
...
z.string.hr.people_tabs_devices_headline =
  'Wire daje svakom uređaju jedinstveni otisak. Usporedite otiske s %@name da bi verificirali razgovor.';
z.string.hr.people_tabs_devices_why_verify = 'Zašto verifikacija razgovora?';
z.string.hr.people_tabs_no_devices_headline =
  '%@.name koristi staru verziju Wire. Nema novih uređaja.';
...
z.string.hr.people_tabs_device_detail_headline =
  'Provjerite da je otisak prikazan na %bold%@.name’s device%end.';
...
z.string.hr.people_remove_message =
  '%@.First_NAME neće moći slati ili primati poruke u ovom razgovoru.';
...
z.string.hr.warning_call_unsupported_incoming =
  '%s.First_NAME zove. Vaš preglednik ne podržava pozive.';
...
z.string.hr.system_notification_conversation_create =
  '%s.First_NAME je započela/o razgovor';
z.string.hr.system_notification_conversation_rename =
  '%s.First_NAME je preimenovala/o razgovor u %name';
