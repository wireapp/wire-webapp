...
z.string.el.modalSessionResetMessage_1 = 'Εάν το πρόβλημα δεν επιλυθεί,';
z.string.el.modalSessionResetMessageLink = 'επαφή';
z.string.el.modalSessionResetMessage_2 = 'Εμάς.';
...
z.string.el.conversationYouDative = 'εσυ';
z.string.el.conversationYouAccusative = 'εσυ';
...
z.string.el.conversationCreate = ' ξεκίνησε μία συνομιλία με {{users}}';
z.string.el.conversationCreateYou = ' ξεκίνησε μία συνομιλία με {{users}}';
...
z.string.el.conversationMemberJoin = ' προστέθηκαν {{users}}';
z.string.el.conversationMemberJoinYou = ' προστέθηκαν {{users}}';
z.string.el.conversationMemberLeaveLeft = ' αποχώρηση';
z.string.el.conversationMemberLeaveLeftYou = ' αποχώρηση';
z.string.el.conversationMemberLeaveRemoved = ' αφαιρέθηκαν {{users}}';
z.string.el.conversationMemberLeaveRemovedYou = ' αφαιρέθηκαν {{users}}';
...
z.string.el.conversationTeamLeave = ' αφαιρέθηκε από την ομάδα';
z.string.el.conversationPing = ' σκουντημα';
z.string.el.conversationPingYou = ' σκουντηξες';
...
z.string.el.conversationVoiceChannelDeactivateYou = ' καλεσες';
z.string.el.conversationYesterday = 'Χθές';
z.string.el.conversationUnableToDecrypt_1 = 'ένα μήνυμα από τον {{user}} δεν παρελήφθη.';
z.string.el.conversationUnableToDecrypt_2 = '{{user}}´ς η ταυτότητα συσκευής άλλαξε. Ανεπίδοτο μήνυμα.';
...
z.string.el.inviteHintSelected = 'Πατήστε {{metaKey}} + C για αντιγραφή';
z.string.el.inviteHintUnselected = 'Επιλέξτε και Πατήστε {{metaKey}} + C';
...
z.string.el.peopleButtonAddPeople = 'Προσθήκη ατόμων';
...
z.string.el.preferencesAccountCreateTeam = 'Δημιουργία ομάδος';
