...
z.string.fr.modal_clear_conversation_headline = 'Supprimer le contenu "{{user}}" ?';
...
z.string.fr.modal_leave_conversation_headline = 'Quitter la conversation "{{user}}" ?';
...
z.string.fr.modal_new_device_headline_many = '{{user}}s utilisent de nouveaux appareils';
z.string.fr.modal_new_device_headline_you = '{{user}} utilise un nouvel appareil';
...
z.string.fr.conversation_create_you = ' a commencé une conversation avec {{users}}';
...
z.string.fr.warning_call_unsupported_incoming = '{{user}} vous appelle. Votre navigateur ne supporte pas les appels.';
...
z.string.fr.system_notification_conversation_create = '{{user}} a démarré une conversation';
