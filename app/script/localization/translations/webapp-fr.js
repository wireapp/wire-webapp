...
z.string.fr.modalNewDeviceHeadlineYou = '{{user}} utilisez un nouvel appareil';
...
z.string.fr.modalSessionResetMessage_1 = 'Si le problème n’est pas résolu,';
z.string.fr.modalSessionResetMessageLink = 'contactez';
z.string.fr.modalSessionResetMessage_2 = '-nous.';
...
z.string.fr.conversationCreate = ' a commencé une conversation avec {{users}}';
z.string.fr.conversationCreateYou = ' avez commencé une conversation avec {{users}}';
z.string.fr.conversationDeviceStartedUsingOne = ' utilise';
z.string.fr.conversationDeviceStartedUsingMany = ' utilisent';
...
z.string.fr.conversationMemberJoin = ' a ajouté {{users}}';
z.string.fr.conversationMemberJoinYou = ' avez ajouté {{users}}';
z.string.fr.conversationMemberLeaveLeft = ' est parti';
z.string.fr.conversationMemberLeaveLeftYou = ' êtes parti';
z.string.fr.conversationMemberLeaveRemoved = ' a exclu {{users}}';
z.string.fr.conversationMemberLeaveRemovedYou = ' avez exclu {{users}}';
z.string.fr.conversationMessageDelivered = 'Distribué';
z.string.fr.conversationRename = ' a renommé la conversation';
z.string.fr.conversationRenameYou = ' avez renommé la conversation';
z.string.fr.conversationResume = 'Commencez une conversation avec {{users}}';
z.string.fr.conversationTeamLeave = ' a été exclu de l’équipe';
z.string.fr.conversationPing = ' a fait un signe';
z.string.fr.conversationPingYou = ' avez fait un signe';
...
z.string.fr.conversationVoiceChannelDeactivateYou = ' avez essayé d’appeler';
z.string.fr.conversationYesterday = 'Hier';
z.string.fr.conversationUnableToDecrypt_1 = 'un message de {{user}} n’a pas été reçu.';
z.string.fr.conversationUnableToDecrypt_2 = 'L’identité de l’appareil de {{user}} a changé. Message non distribué.';
...
z.string.fr.conversationsPopoverClear = 'Supprimer';
z.string.fr.conversationsPopoverLeave = 'Quitter';
...
z.string.fr.peopleButtonAdd = 'Ajouter des personnes';
z.string.fr.peopleButtonAddPeople = 'Ajouter';
...
z.string.fr.preferencesDevicesActivatedIn = 'à {{location}}';
...
z.string.fr.preferencesDevicesRemove = 'Exclure';
