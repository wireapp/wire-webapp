...
z.string.es.modal_too_long_message =
  'Puede enviar mensajes de hasta {{number}} caracteres.';
z.string.es.modal_leave_conversation_headline =
  '¿Abandonar la conversación "{{user}}"?';
...
z.string.es.modal_new_device_headline =
  '{{user}} comenzó a utilizar un dispositivo nuevo';
z.string.es.modal_new_device_headline_many =
  '{{user}}s comenzaron a utilizar dispositivos nuevos';
...
z.string.es.modal_uploads_parallel =
  'Puede enviar hasta {{number}} archivos a la vez.';
...
z.string.es.conversation_unable_to_decrypt_1 =
  'un mensaje de {{user}} no se recibió';
z.string.es.conversation_unable_to_decrypt_2 =
  '{{user}}´s identidad de dispositivo cambiada. Mensaje no entregado.';
...
z.string.es.conversation_asset_upload_too_large =
  'Puedes enviar archivos de hasta {{number}}';
...
z.string.es.conversations_connection_request_many =
  '{{number}} personas en espera';
...
z.string.es.people_remove_message =
  '{{user}} no podrá enviar o recibir mensajes en esta conversación.';

z.string.es.people_unblock_headline = '¿Desbloquear?';
z.string.es.people_unblock_message =
  '{{user}} ahora podrá ponerse en contacto contigo o añadirte a chats de grupo.';
...
z.string.es.system_notification_conversation_create =
  '{{user}} inició una conversación';
z.string.es.system_notification_conversation_rename =
  '{{user}} renombró la conversación a {{name}}';
z.string.es.system_notification_member_join_many =
  '{{user}} agregó a {{number}} personas a la conversación';
z.string.es.system_notification_member_join_one =
  '{{user1}} agregó a {{user2}} a la conversación';
...
z.string.es.init_events_progress =
  'Cargando mensajes - {{number1}} {{number2}}';
