...
z.string.es.modal_block_conversation_headline = '¿Bloquear a %@.name?';
z.string.es.modal_block_conversation_message = '%@.name no podrá ponerse en contacto contigo o añadirte a chats de grupo.';
...
z.string.es.conversation_member_join_you = ' %@nombres añadidos';
z.string.es.conversation_member_leave_left = ' abandonó';
z.string.es.conversation_member_leave_left_you = ' abandonó';
z.string.es.conversation_member_leave_removed = ' %@nombres eliminados';
z.string.es.conversation_member_leave_removed_you = ' %@nombres eliminados';
...
z.string.es.conversation_resume = 'Iniciar una conversación con %@nombres';
...
z.string.es.people_tabs_devices_headline = 'Wire proporciona a cada dispositivo una huella digital única. Comparala con %@.name y verifica tu conversación.';
z.string.es.people_tabs_devices_why_verify = '¿Por qué verificar la conversación?';
z.string.es.people_tabs_no_devices_headline = '%@.name está utilizando una versión antigua de Wire. No se muestran dispositivos aquí.';
...
z.string.es.people_tabs_device_detail_headline = 'Verifica que esta coincida con la huella digital que se muestra en el dispositivo de %bold%@.name’s%end.';
...
z.string.es.people_unblock_message = '%@.first_name ahora podrá ponerse en contacto contigo o añadirte a chats de grupo.';
...
z.string.es.preferences_devices_activated_on = 'Activado %time';
...
z.string.es.warning_call_unsupported_incoming = '%s.first_name está llamando. Tu navegador no está configurada para llamadas.';
...
z.string.es.tooltip_conversations_archived = 'Mostrar archivo (%no)';
