...
z.string.fi.alert_upload_file_format =
  'Kuvaa ei voi käyttää. Valitse PNG- tai JPEG-tiedosto.';
z.string.fi.alert_upload_too_small =
  'Kuvaa ei voi käyttää. Valitse kuva, jonka koko on vähintään 320 X 320 pikseliä.';
z.string.fi.alert_upload_too_large =
  'Kuva on liian suuri. Voit ladata maksimissaan %no MB kokoisia kuvia.';
z.string.fi.alert_gif_too_large =
  'Animaatio on liian suuri. Maksimi koko on %no MB.';
...
z.string.fi.auth_account_expiration =
  'Sinut kirjattiin ulos, koska istuntosi päättyi. Kirjaudu sisään uudelleen.';
...
z.string.fi.auth_verify_account_detail =
  'Tämä mahdollistaa Wiren käytön useilla laitteilla.';
z.string.fi.auth_verify_account_headline =
  'Lisää sähköpostiosoitteesi ja salasanasi.';
z.string.fi.auth_verify_account_logout = 'Kirjaudu ulos';
z.string.fi.auth_verify_code_description =
  'Syötä vahvistuskoodi jonka lähetimme numeroon %@.';
...
z.string.fi.auth_verify_code_resend_timer =
  'Voit pyytää uuden koodin %expiration kuluttua.';
...
z.string.fi.auth_limit_description =
  'Poista yksi laitteistasi aloittaaksesi Wiren käytön tässä laiteessa.';
...
z.string.fi.auth_history_headline =
  'Käytät Wireä ensimmäistä kertaa tällä laitteella.';
z.string.fi.auth_history_description =
  'Tietosuojasyistä keskusteluhistoriasi ei näy täällä.';
z.string.fi.auth_history_button = 'OK';

z.string.fi.auth_posted_change_email = 'Vaihda sähköpostiosoite';
z.string.fi.auth_posted_offline_detail =
  'Tarkista internet-yhteytesi ja yritä uudelleen.';
z.string.fi.auth_posted_offline_headline =
  'Wire on mukavampi internettiin kytkettynä.';
...
z.string.fi.auth_posted_resend =
  'Lähetä uudelleen sähköpostiosoitteeseen: %email';
z.string.fi.auth_posted_resend_action = 'Eikö sähköposti saavu perille?';
z.string.fi.auth_posted_resend_detail =
  'Tarkista sähköpostisi saapuneet-kansio ja seuraa ohjeita.';
z.string.fi.auth_posted_resend_headline = 'Sinulle on sähköpostia.';
z.string.fi.auth_posted_retry =
  'Yritä uudelleen ja lähetä sähköpostia osoitteeseen %email';
...
z.string.fi.auth_placeholder_password_set =
  'Salasana (vähintään 8 merkkiä pitkä)';
...
z.string.fi.auth_error_email_forbidden =
  'Valitettavasti tämä sähköpostiosoite on kielletty.';
z.string.fi.auth_error_email_malformed =
...
z.string.fi.auth_error_name_short =
  'Kirjoita nimi, jossa on vähintään 2 merkkiä';
z.string.fi.auth_error_offline = 'Ei internet-yhteyttä';
z.string.fi.auth_error_password_short =
  'Valitse salasana, jossa on vähintään 8 merkkiä.';
z.string.fi.auth_error_password_wrong = 'Väärä salasana. Yritä uudelleen.';
z.string.fi.auth_error_phone_number_forbidden =
  'Valitettavasti tämä puhelinnumero on kielletty.';
...
z.string.fi.modal_call_conversation_empty_message =
  'Täällä ei ole ketään jäljellä.';
z.string.fi.modal_call_conversation_full_headline =
  'Liian monta ihmistä puheluun';
z.string.fi.modal_call_conversation_full_message =
  'Puhelut toimivat maksimissaan %no keskustelussa.';
z.string.fi.modal_call_no_video_in_group_headline = 'Ei videopuheluja ryhmissä';
z.string.fi.modal_call_no_video_in_group_message =
  'Videopuhelut eivät ole saatavilla ryhmäkeskusteluissa.';
z.string.fi.modal_call_second_incoming_headline = 'Vastaatko puheluun?';
z.string.fi.modal_call_second_incoming_message =
  'Sinun tämänhetkinen puhelu päättyy.';
z.string.fi.modal_call_second_incoming_action = 'Vastaa';
z.string.fi.modal_call_second_ongoing_headline =
  'Katkaise puhelu toisessa laitteessa?';
z.string.fi.modal_call_second_ongoing_message =
  'Voit olla vain yhdessä puhelussa kerrallaan.';
...
z.string.fi.modal_call_second_outgoing_message =
  'Voit olla vain yhdessä puhelussa kerrallaan.';
z.string.fi.modal_call_second_outgoing_action = 'Katkaise puhelu';
z.string.fi.modal_call_voice_channel_full_headline =
  'Kaikki puhelukanavat varattuja';
z.string.fi.modal_call_voice_channel_full_message =
  'Täällä on tilaa vain %no ihmiselle.';
z.string.fi.modal_clear_conversation_headline = 'Poista "%@.name":n sisältö?';
z.string.fi.modal_clear_conversation_message =
  'Tämä tyhjentää keskusteluhistorian ja poistaa sen luettelostasi.';
...
z.string.fi.modal_connected_device_message =
  'Jos et tehnyt tätä, poista laite ja vaihda salasanasi.';
...
z.string.fi.modal_too_long_message =
  'Voit lähettää viestejä joissa on maksimissaan %no merkkiä.';
z.string.fi.modal_leave_conversation_headline =
  'Poistu "%@.name" -keskustelusta?';
z.string.fi.modal_leave_conversation_message =
  'Osallistujille ilmoitetaan ja keskustelu poistetaan listastasi.';
z.string.fi.modal_leave_conversation_button = 'Poistu';
z.string.fi.modal_logout_headline = 'Tyhjennä tiedot?';
z.string.fi.modal_logout_message =
  'Poista kaikki henkilökohtaiset tiedot ja keskustelut tästä laitteesta.';
z.string.fi.modal_logout_button = 'Kirjaudu ulos';
z.string.fi.modal_new_device_headline =
  '%@.name aloitti käyttämään uutta laitetta';
z.string.fi.modal_new_device_headline_you =
  '%@.name aloitti käyttämään uutta laitetta';
z.string.fi.modal_new_device_message =
  'Haluatko vielä silti lähettää viestisi?';
...
z.string.fi.modal_remove_device_message =
  'Sinun täytyy kirjoittaa salasanasi poistaaksesi laitteen.';
...
z.string.fi.modal_too_many_members_message =
  'Maksimissaan %max henkilöä voi liittyä keskusteluun. Tässä keskustelussa on tilaa %no hengelle.';
z.string.fi.modal_uploads_parallel =
...
z.string.fi.conversation_member_join_you = ' lisättiin %@names';
...
z.string.fi.conversation_member_leave_removed_you = ' poistettu %@names';
...
z.string.fi.conversation_ping_you = ' pinggasi';
...
z.string.fi.conversation_unable_to_decrypt_1 =
  '%@name n viesti ei tullut perille.';
z.string.fi.conversation_unable_to_decrypt_2 =
  '%@name n laitteen identiteetti muuttui. Perilletoimittamaton viesti.';
...
z.string.fi.conversation_asset_upload_too_large =
  'Voit lähettää maksimissaan %no kokoisia tiedostoja';
...
z.string.fi.conversations_no_conversations =
  'Aloita keskustelu tai kutsu ihmisiä liittymään keskusteluun.';
...
z.string.fi.invite_message =
  'Olen Wiressä, etsi %username tai mene osoitteeseen get.wire.com.';
z.string.fi.invite_message_no_email =
  'Olen Wiressä. Mene osoitteeseen get.wire.com ottaaksesi minuun yhteyttä.';
...
z.string.fi.people_everyone_participates =
  'Jokainen jonka kanssa olet yhdistetty on jo tässä keskustelussa.';
z.string.fi.people_no_matches =
  'Ei vastaavia tuloksia. Yritä toisella nimellä.';
...
z.string.fi.people_tabs_devices_headline =
  'Wire antaa jokaiselle laitteelle yksilöllisen sormenjäljen. Vertaa niitä %@.name kanssa ja vahvista keskustelusi.';
z.string.fi.people_tabs_devices_why_verify = 'Miksi vahvistaa keskustelu?';
z.string.fi.people_tabs_no_devices_headline =
  '%@.name käyttää vanhaa Wire-versiota. Laitteita ei näytetä täällä.';
z.string.fi.people_tabs_device_detail_all_my_devices = 'Näytä kaikki laitteeni';
z.string.fi.people_tabs_device_detail_device_fingerprint =
  'Laitteen sormenjälki';
z.string.fi.people_tabs_device_detail_headline =
  'Vahvista että tämä vastaa sormenjälkeä joka näkyy %bold%@.name’s n laitteella%end.';
...
z.string.fi.people_tabs_device_detail_show_my_device =
  'Näytä laitteeni sormenjälki';
...
z.string.fi.people_connect_message =
  'Tämä yhdistää teidät ja avaa keskustelun %@.first_name kanssa.';

z.string.fi.people_cancel_request_headline = 'Peruuta pyyntö?';
z.string.fi.people_cancel_request_message =
  'Poista yhteyspyyntö %@.first_name:lle.';

z.string.fi.people_leave_headline = 'Poistu keskustelusta?';
z.string.fi.people_leave_message =
  'Et pysty lähettämään tai vastaanottamaan viestejä tässä keskustelussa.';

z.string.fi.people_remove_headline = 'Poista?';
z.string.fi.people_remove_message =
  '%@.first_name ei pysty lähettämään tai vastaanottamaan viestejä tässä keskustelussa.';
...
z.string.fi.preferences_account_username_hint =
  'Vähintään 2 merkkiä, vain a - z, 0 - 9 ja _.';
...
z.string.fi.preferences_devices_active_detail =
  'Jos et tunnista yllä olevaa laitetta, poista se ja vaihda salasanasi.';
...
z.string.fi.preferences_options_data_detail =
  'Tee Wirestä parempi lähetämällä anonyymiä tietoa.';
z.string.fi.preferences_options_notifications = 'Ilmoitukset';
z.string.fi.preferences_options_notifications_none = 'Pois päältä';
z.string.fi.preferences_options_notifications_obfuscate =
  'Piilota yksityiskohdat';
z.string.fi.preferences_options_notifications_obfuscate_message =
  'Näytä lähettäjä';
z.string.fi.preferences_options_notifications_on = 'Näytä lähettäjä ja viesti';

z.string.fi.search_group_hint =
  'Jatka kirjoittamista tai valitse lisää ihmisiä luodaksesi ryhmän';
...
z.string.fi.warning_call_headline =
  'Et voi käydä puhelinkeskusteluja ilman mikrofonia';
z.string.fi.warning_call_unsupported_incoming =
  '%s.first_name soittaa. Selaimesi ei tue puheluja.';
z.string.fi.warning_call_unsupported_outgoing =
  'Et voi soittaa puhelua koska selaimesi ei tue puheluja.';
z.string.fi.warning_call_issues =
  'Tämä versio Wirestä ei pysty osallistumaan puheluun. Käytä';
z.string.fi.warning_call_upgrade_browser =
  'Soittaaksesi puhelun, päivitä Google Chrome.';
z.string.fi.warning_learn_more = 'Lue lisää';
z.string.fi.warning_not_found_camera =
  'Et voi soittaa puhelua koska tietokoneessasi ei ole kameraa.';
z.string.fi.warning_not_found_microphone =
  'Et voi soittaa puhelua koska tietokoneessasi ei ole mikrofonia.';
...
z.string.fi.warning_permission_denied_screen =
  'Selaimesi tarvitsee luvan jakaa näyttösi.';
z.string.fi.warning_permission_request_camera =
  '%icon Anna käyttöoikeus kameraan';
z.string.fi.warning_permission_request_microphone =
  '%icon Anna käyttöoikeus mikrofoniin';
...
z.string.fi.warning_connectivity_no_internet =
  'Ei Internetiä. Et pysty lähettämään tai vastaanottamaan viestejä.';
...
z.string.fi.system_notification_conversation_create =
  '%s.first_name aloitti keskustelun';
z.string.fi.system_notification_conversation_rename =
  '%s.first_name nimesi keskustelun uudelleen %nameksi';
z.string.fi.system_notification_member_join_many =
  '%s.first_name lisäsi %no ihmistä keskusteluun';
z.string.fi.system_notification_member_join_one =
  '%s.first_name lisäsi %@.first_namen keskusteluun';
z.string.fi.system_notification_member_leave_left =
  '%s.first_name poistui keskustelusta';
z.string.fi.system_notification_member_leave_removed_many =
  '%s.first_name poisti %no ihmistä keskustelusta';
z.string.fi.system_notification_member_leave_removed_one =
  '%s.first_name poisti %@.first_namen keskustelusta';
...
z.string.fi.tooltip_conversation_all_verified =
  'Kaikki sormenjäljet on vahvistettu';
...
z.string.fi.tooltip_conversations_tooltip_start =
  'Aloita keskustelu (%shortcut)';
...
z.string.fi.tooltip_preferences_contacts_gmail =
  'Kirjaudu gmail-tilillesi jakaaksesi kontakteja';
z.string.fi.tooltip_preferences_contacts_macos =
  'Jaa kaikki yhteystietosi macOs Yhteystieto sovelluksesta';
z.string.fi.tooltip_preferences_password =
