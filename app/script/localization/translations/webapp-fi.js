...
z.string.fi.modalSessionResetMessage_1 = 'Jos ongelma ei ole ratkennut';
z.string.fi.modalSessionResetMessageLink = 'ota yhteys';
z.string.fi.modalSessionResetMessage_2 = 'meihin.';
...
z.string.fi.conversationDeviceStartedUsingMany = ' aloittivat käyttämään';
...
z.string.fi.conversationUnableToDecrypt_1 = '{{user}} n viesti ei tullut perille.';
z.string.fi.conversationUnableToDecrypt_2 = '{{user}} n laitteen identiteetti muuttui. Perilletoimittamaton viesti.';
...
z.string.fi.inviteHintSelected = 'Paina {{metaKey}} + C kopioidaksesi';
z.string.fi.inviteHintUnselected = 'Valitse ja paina {{metaKey}} + C';
...
z.string.fi.peopleButtonAddPeople = 'Lisää henkilöitä';
