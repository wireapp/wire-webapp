...
z.string.fi.auth_error_phone_number_budget = 'Kirjauduit sisään liian usein. Yritä myöhemmin uudelleen.';
...
z.string.fi.modal_block_conversation_message = '{{user}} ei pysty ottamaan sinuun yhteyttä tai lisäämään sinua ryhmäkeskusteluihin.';
z.string.fi.modal_block_conversation_button = 'Estä';
z.string.fi.modal_bots_confirm_button = 'Vahvista';
z.string.fi.modal_bots_unavailable_headline = 'Botit eivät käytettävissä';
z.string.fi.modal_bots_unavailable_message = 'Kiitos mielenkiinnostasi botteihin. Tämä palvelu on väliaikaisesti pois käytöstä, koska työstämme seuraavaa versiota.';
...
z.string.fi.modal_too_long_message = 'Voit lähettää viestejä joissa on maksimissaan {{number}} merkkiä.';
z.string.fi.modal_leave_conversation_headline = 'Poistu "{{user}}" -keskustelusta?';
...
z.string.fi.modal_new_device_headline = '{{user}} aloitti käyttämään uutta laitetta';
z.string.fi.modal_new_device_headline_many = '{{users}} aloittivat käyttämään uusia laitteita';
z.string.fi.modal_new_device_headline_you = '{{user}} aloitti käyttämään uutta laitetta';
z.string.fi.modal_new_device_message = 'Haluatko vielä silti lähettää viestisi?';
z.string.fi.modal_new_device_call_accept = 'Vastaa puheluun';
z.string.fi.modal_new_device_call_anyway = 'Soita kuitenkin';
z.string.fi.modal_new_device_call_incoming = 'Haluatko silti vastata puheluun?';
z.string.fi.modal_new_device_call_outgoing = 'Haluatko silti soittaa puhelun?';
z.string.fi.modal_new_device_show_device = 'näytä laite';
z.string.fi.modal_new_device_send_anyway = 'lähetä siitä huolimatta';
z.string.fi.modal_not_connected_headline = 'Ketään ei ole lisätty keskusteluun';
z.string.fi.modal_not_connected_message_one = '{{name}} ei halua tulla lisätyksi keskusteluihin.';
z.string.fi.modal_not_connected_message_many = 'Yksi valitsimistasi käyttäjistä ei halua tulla lisätyksi keskusteluihin.';
...
z.string.fi.conversation_device_started_using_one = ' aloitti käyttämään';
z.string.fi.conversation_device_started_using_many = ' aloittivat käyttämään';
...
z.string.fi.conversation_device_new_device_one = ' uutta laitetta';
z.string.fi.conversation_device_new_device_many = ' uusia laitteita';
z.string.fi.conversation_device_new_people_joined = 'uusia liittymisiä.';
z.string.fi.conversation_device_new_people_joined_verify = ' vahvista laitteet';
...
z.string.fi.conversation_team_leave = ' poistettiin tiimistä';
...
z.string.fi.conversation_missed_messages = 'Et ole käyttänyt tätä laitetta pitkään aikaan. Jotkut viestit eivät saata näkyä täällä.';
...
z.string.fi.conversation_asset_upload_too_large = 'Voit lähettää maksimissaan {{number}} kokoisia tiedostoja';
...
z.string.fi.conversation_send_pasted_file = 'Liitetty kuva, {{date}}';
...
z.string.fi.conversations_secondary_line_missed_call = '{{number}} vastaamaton puhelu';
z.string.fi.conversations_secondary_line_missed_calls = '{{number}} vastaamatonta puhelua';
z.string.fi.conversations_secondary_line_new_message = '{{number}} uusi viesti';
z.string.fi.conversations_secondary_line_new_messages = '{{number}} uutta viestiä';
z.string.fi.conversations_secondary_line_ping = '{{number}} pingi';
z.string.fi.conversations_secondary_line_pings = '{{number}} pingiä';
z.string.fi.conversations_secondary_line_people_left = '{{number}} henkilöä poistui';
z.string.fi.conversations_secondary_line_person_left = '{{user}} poistui';
z.string.fi.conversations_secondary_line_person_removed = '{{user}} poistettiin';
z.string.fi.conversations_secondary_line_people_added = '{{user}} henkilöä lisättiin';
z.string.fi.conversations_secondary_line_person_added = '{{user}} lisättiin';
z.string.fi.conversations_secondary_line_person_added_you = '{{user}} lisäsi sinut';
z.string.fi.conversations_secondary_line_renamed = '{{user}} vaihtoi keskustelun nimeä';
...
z.string.fi.people_invite = 'Kutsu henkilöitä Wireen';
...
z.string.fi.people_services = 'Palvelut';
...
z.string.fi.people_tabs_people = 'Ihmiset';
z.string.fi.people_tabs_services = 'Palvelut';
z.string.fi.people_verified = 'Vahvistettu';

z.string.fi.people_block_headline = 'Estä?';
z.string.fi.people_block_message = '{{user}} ei pysty ottamaan sinuun yhteyttä tai lisäämään sinua ryhmäkeskusteluihin.';

z.string.fi.people_connect_headline = 'Hyväksy?';
z.string.fi.people_connect_message = 'Tämä yhdistää teidät ja avaa keskustelun {{user}} kanssa.';
...
z.string.fi.people_remove_message = '{{user}} ei pysty lähettämään tai vastaanottamaan viestejä tässä keskustelussa.';
...
z.string.fi.preferences_account_manage_team = 'Hallinnoi tiimiä';
z.string.fi.preferences_account_reset_password = 'Vaihda salasana';
z.string.fi.preferences_account_team = 'tiimissä {{name}}';
...
z.string.fi.preferences_options_popular = 'Yleisön pyynnöstä';
z.string.fi.preferences_options_emoji_replace_checkbox = 'Korvaa tekstihymiöt emojeilla';
z.string.fi.preferences_options_previews_send_checkbox = 'Luo esikatselut lähettämillesi linkeille';
z.string.fi.preferences_options_previews_send_detail = 'Esikatselut saattavat silti näkyä muiden lähettämissä linkeissä.';
...
z.string.fi.search_people = 'Ihmiset';
z.string.fi.search_placeholder = 'Etsi nimellä tai käyttäjänimellä';
z.string.fi.search_services = 'Palvelut';
z.string.fi.search_team_groups = 'Tiimikeskustelut';
z.string.fi.search_team_members = 'Tiimin jäsenet';
...
z.string.fi.warning_lifecycle_update = 'Wiren uusi versio on saatavilla.';
z.string.fi.warning_lifecycle_update_notes = 'Uutuudet';
z.string.fi.warning_lifecycle_update_link = 'Päivitä nyt';
...
z.string.fi.tooltip_conversation_search = 'Etsi';
...
z.string.fi.tooltip_people_add = 'Lisää henkilöitä keskusteluun ({{shortcut}})';
