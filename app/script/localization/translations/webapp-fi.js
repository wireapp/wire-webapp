...
z.string.fi.alert_upload_too_large =
  'Kuva on liian suuri. Voit ladata maksimissaan {{number}} MB kokoisia kuvia.';
z.string.fi.alert_gif_too_large =
  'Animaatio on liian suuri. Maksimi koko on {{number}} MB.';
...
z.string.fi.auth_verify_code_description =
  'Syötä vahvistuskoodi jonka lähetimme {{number}}.';
...
z.string.fi.modal_block_conversation_headline = 'Estä {{user}}?';
...
z.string.fi.modal_clear_conversation_headline = 'Poista "{{user}}":n sisältö?';
...
z.string.fi.modal_too_long_message =
  'Voit lähettää viestejä joissa on maksimissaan {{number}} merkkiä.';
z.string.fi.modal_leave_conversation_headline =
  'Poistu "{{user}}" -keskustelusta?';
...
z.string.fi.modal_new_device_headline =
  '{{user}} aloitti käyttämään uutta laitetta';
...
z.string.fi.modal_remove_device_headline = 'Poista "{{device}}"';
...
z.string.fi.modal_uploads_parallel =
  'Voit lähettää jopa {{number}} tiedostoa samaan aikaan.';
...
z.string.fi.conversation_create = ' aloitti keskustelun {{users}} kanssa';
z.string.fi.conversation_create_you = ' aloitti keskustelun {{users}} kanssa';
...
z.string.fi.conversation_device_user_devices = ' {{user}} n laitteet';
z.string.fi.conversation_just_now = 'Juuri nyt';
z.string.fi.conversation_location_link = 'Avaa kartta';
z.string.fi.conversation_member_join = ' lisättiin {{users}}';
z.string.fi.conversation_member_join_you = ' lisättiin {{users}}';
z.string.fi.conversation_member_leave_left = ' on lähtenyt';
z.string.fi.conversation_member_leave_left_you = ' on lähtenyt';
z.string.fi.conversation_member_leave_removed = ' poistettu {{users}}';
z.string.fi.conversation_member_leave_removed_you = ' poistettu {{users}}';
...
z.string.fi.conversation_resume = 'Aloita keskustelu {{users}} n kanssa';
...
z.string.fi.conversation_unable_to_decrypt_1 =
  '{{user}} n viesti ei tullut perille.';
z.string.fi.conversation_unable_to_decrypt_2 =
  '{{user}} n laitteen identiteetti muuttui. Perilletoimittamaton viesti.';
...
z.string.fi.conversation_asset_upload_too_large =
  'Voit lähettää maksimissaan {{number}} kokoisia tiedostoja';
...
z.string.fi.conversation_delete_timestamp = 'Poistettu {{date}}';
...
z.string.fi.conversations_connection_request_many =
  '{{number}} ihmisiä odottaa';
...
z.string.fi.people_tabs_no_devices_headline =
  '{{user}} käyttää vanhaa Wire-versiota. Laitteita ei näytetä täällä.';
...
z.string.fi.people_connect_message =
  'Tämä yhdistää teidät ja avaa keskustelun {{user}} kanssa.';

z.string.fi.people_cancel_request_headline = 'Peruuta pyyntö?';
z.string.fi.people_cancel_request_message = 'Poista yhteyspyyntö {{user}}:lle.';
...
z.string.fi.people_remove_message =
  '{{user}} ei pysty lähettämään tai vastaanottamaan viestejä tässä keskustelussa.';
...
z.string.fi.preferences_devices_activated_on = 'Aktivoitu {{date}}: ssa';
...
z.string.fi.warning_call_unsupported_incoming =
  '{{user}} soittaa. Selaimesi ei tue puheluja.';
...
z.string.fi.warning_permission_request_notification =
  '{{icon}} Salli ilmoitukset';
