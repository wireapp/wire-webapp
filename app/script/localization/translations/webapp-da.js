...
z.string.da.alert_upload_too_large =
  'Dette billede er for stort. Du kan uploade filer op til %no MB.';
z.string.da.alert_gif_too_large =
  'Animationen er for stor. Den maksimale størrelse er %no MB.';
...
z.string.da.modal_block_conversation_message =
  '%@.name vil ikke kunne kontakte dig eller tilføje dig til gruppesamtaler.';
...
z.string.da.modal_too_long_message =
  'Du kan sende beskeder på op til %no tegn.';
z.string.da.modal_leave_conversation_headline = 'Forlad "%@.name" samtale?';
...
z.string.da.modal_new_device_headline =
  '%@.name er begyndt at bruge en ny enhed';
z.string.da.modal_new_device_headline_many =
  '%@.names er begyndt at bruge nye enheder';
...
z.string.da.modal_remove_device_headline = 'Fjern "%device_name"';
...
z.string.da.modal_too_many_members_message =
  'Op til %max personer kan deltage i en samtale. Der er plads til %no personer mere herinde.';
z.string.da.modal_uploads_parallel =
  'Du kan sende op til %no filer på én gang.';
...
z.string.da.conversation_member_join_you = ' tilføjede %@names';
z.string.da.conversation_member_leave_left = ' forlod';
z.string.da.conversation_member_leave_left_you = ' forlod';
z.string.da.conversation_member_leave_removed = ' fjernede %@names';
z.string.da.conversation_member_leave_removed_you = ' fjernede %@names';
...
z.string.da.conversation_resume = 'Start en samtale med %@names';
...
z.string.da.conversation_unable_to_decrypt_1 =
  'en besked fra %@name blev ikke modtaget.';
z.string.da.conversation_unable_to_decrypt_2 =
  '%@name’s enheds identitet er ændret. Uleveret besked.';
...
z.string.da.conversation_asset_upload_too_large =
  'Du kan sende filer med størrelse op til %no';
...
z.string.da.conversation_delete_timestamp = 'Slettet på %@timestamp';
...
z.string.da.people_tabs_devices_headline =
  'Wire giver hver enhed et unikt fingeraftryk. Sammenlign dem med %@.name og bekræft din samtale.';
z.string.da.people_tabs_devices_why_verify = 'Hvorfor bekræfte samtale?';
z.string.da.people_tabs_no_devices_headline =
  '%@.name bruger en gammel version af Wire. Ingen enheder er vist her.';
...
z.string.da.people_tabs_device_detail_headline =
  'Bekræft at dette passer med fingeraftrykket vist på %bold%@.name’s enhed%end.';
...
z.string.da.people_remove_message =
  '%@.first_name vil ikke være i stand til at sende eller modtage beskeder i denne samtale.';

z.string.da.people_unblock_headline = 'Fjern Blokering?';
z.string.da.people_unblock_message =
  '%@.first_name vil igen kunne kontakte dig og tilføje dig til gruppesamtaler.';
...
z.string.da.preferences_devices_activated_on = 'Aktiveret på %time';
...
z.string.da.warning_call_unsupported_incoming =
  '%s.first_name ringer. Din browser understøtter ikke opkald.';
...
z.string.da.system_notification_conversation_create =
  '%s.first_name startede en samtale';
z.string.da.system_notification_conversation_rename =
  '%s.first_name omdøbte samtalen til %name';
...
z.string.da.tooltip_conversations_archived = 'Vis arkiv (%no)';
