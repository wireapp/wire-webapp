...
z.string.da.modalSessionResetMessage_1 = 'Hvis problemet ikke er løst,';
z.string.da.modalSessionResetMessageLink = 'kontakt';
z.string.da.modalSessionResetMessage_2 = 'os.';
...
z.string.da.conversationCreate = ' startede en samtale med {{users}}';
z.string.da.conversationCreateYou = ' startede en samtale med {{users}}';
...
z.string.da.conversationMemberJoin = ' tilføjede {{users}}';
z.string.da.conversationMemberJoinYou = ' tilføjede {{users}}';
z.string.da.conversationMemberLeaveLeft = ' forlod';
z.string.da.conversationMemberLeaveLeftYou = ' forlod';
z.string.da.conversationMemberLeaveRemoved = ' fjernede {{users}}';
z.string.da.conversationMemberLeaveRemovedYou = ' fjernede {{users}}';
...
z.string.da.conversationUnableToDecrypt_1 = 'en besked fra {{user}} blev ikke modtaget.';
z.string.da.conversationUnableToDecrypt_2 = '{{user}}’s enheds identitet er ændret. Uleveret besked.';
...
z.string.da.inviteHintUnselected = 'Vælg og tryk {{metaKey}} + C';
...
z.string.da.peopleButtonAddPeople = 'Tilføj personer';
