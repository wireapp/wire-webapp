...
z.string.da.alert_upload_file_format =
  'Kan ikke anvende dette billede. Vælg venligst en PNG eller JPEG-fil.';
z.string.da.alert_upload_too_small =
  'Kan ikke anvende dette billede. Vælg venligst et billede der er mindst 320 x 320 px.';
z.string.da.alert_upload_too_large =
  'Dette billede er for stort. Du kan uploade filer op til {{number}} MB.';
z.string.da.alert_gif_too_large =
  'Animationen er for stor. Den maksimale størrelse er {{number}} MB.';
...
z.string.da.auth_account_expiration =
  'Du er blevet logget af, da din session udløb. Log venligst ind igen.';
...
z.string.da.auth_verify_account_detail =
  'Dette gør, at du kan bruge Wire på flere enheder.';
z.string.da.auth_verify_account_headline =
  'Tilføj email adresse og adgangskode.';
z.string.da.auth_verify_account_logout = 'Log ud';
z.string.da.auth_verify_code_description =
  'Indtast bekræftelseskoden vi sendte til {{number}}.';
z.string.da.auth_verify_code_resend = 'Ingen kode vist?';
z.string.da.auth_verify_code_resend_detail = 'Gensend';
z.string.da.auth_verify_code_resend_timer =
  'Du kan anmode om en ny kode {{expiration}}.';
...
z.string.da.auth_limit_description =
  'Fjern en af dine andre enheder for at begynde at bruge Wire på denne.';
...
z.string.da.auth_history_headline =
  'Det er første gang du bruger Wire på denne enhed.';
z.string.da.auth_history_description =
  'Af hensyn til fortrolighed, vil din chathistorik ikke vises her.';
z.string.da.auth_history_reuse_headline =
  'Du har brugt Wire på denne enhed før.';
z.string.da.auth_history_reuse_description =
  'Beskeder sendt i mellemtiden vises ikke.';
z.string.da.auth_history_button = 'OK';

z.string.da.auth_posted_change_email = 'Ændre email';
z.string.da.auth_posted_offline_detail =
  'Tjek din internetforbindelse og prøv igen.';
z.string.da.auth_posted_offline_headline = 'Wire er bedre online.';
z.string.da.auth_posted_pending_detail =
  'Tjek din email indbakke eller gensend aktivering.';
...
z.string.da.auth_posted_resend_detail =
  'Tjek din email indbakke og følg anvisningerne.';
...
z.string.da.auth_error_email_forbidden =
  'Beklager. Denne email adresse er forbudt.';
z.string.da.auth_error_email_malformed =
  'Indtast venligst en gyldig email adresse.';
z.string.da.auth_error_email_missing = 'Indtast venligst en e-mailadresse.';
z.string.da.auth_error_misc = 'Problemer med forbindelsen. Prøv venligst igen.';
z.string.da.auth_error_name_short = 'Indtast et navn på mindst to karakterer';
z.string.da.auth_error_offline = 'Ingen internetforbindelse';
z.string.da.auth_error_password_short =
  'Vælg en adgangskode på mindst 8 karakterer.';
z.string.da.auth_error_password_wrong = 'Forkert adgangskode. Prøv igen.';
z.string.da.auth_error_phone_number_forbidden =
  'Beklager. Dette telefonnummer er ikke tilladt.';
z.string.da.auth_error_phone_number_invalid = 'Ugyldigt telefonnummer';
...
z.string.da.call_decline = 'Afvis';
z.string.da.call_accept = 'Besvar';
z.string.da.call_join = 'Deltag';
z.string.da.call_choose_shared_screen = 'Vælg en skærm som du vil dele';

z.string.da.modal_button_cancel = 'Annuller';
z.string.da.modal_button_ok = 'Ok';
...
z.string.da.modal_call_no_video_in_group_message =
  'Video opkald er ikke tilgængelig i gruppe samtaler.';
z.string.da.modal_call_second_incoming_headline = 'Besvar opkald?';
z.string.da.modal_call_second_incoming_message =
  'Dit nuværende opkald vil afsluttes.';
z.string.da.modal_call_second_incoming_action = 'Besvar';
z.string.da.modal_call_second_ongoing_headline = 'Læg på fra en anden enhed?';
z.string.da.modal_call_second_ongoing_message =
  'Du kan kun være i et opkald af gangen.';
z.string.da.modal_call_second_ongoing_action = 'Læg På';
...
z.string.da.modal_clear_conversation_headline = 'Slet "{{user}}" indhold?';
...
z.string.da.modal_connected_device_headline = 'Din konto blev brugt på:';
z.string.da.modal_connected_device_from = 'Fra:';
z.string.da.modal_connected_device_message =
  'Hvis du ikke gjorde dette, slet enheden og nulstil din adgangskode.';
...
z.string.da.modal_delete_everyone_button = 'Slet';
z.string.da.modal_delete_everyone_headline = 'Slet for alle?';
z.string.da.modal_delete_everyone_message = 'Dette kan ikke fortrydes.';
z.string.da.modal_too_long_headline = 'Besked for lang';
z.string.da.modal_too_long_message =
  'Du kan sende beskeder på op til {{number}} tegn.';
z.string.da.modal_leave_conversation_headline = 'Forlad "{{user}}" samtale?';
z.string.da.modal_leave_conversation_message =
  'Deltagerne vil få besked og samtalen fjernet fra din liste.';
z.string.da.modal_leave_conversation_button = 'Forlad';
z.string.da.modal_logout_headline = 'Ryd Data?';
z.string.da.modal_logout_message =
  'Slet alle dine personlige informationer og samtaler på denne enhed.';
z.string.da.modal_logout_button = 'Log ud';
z.string.da.modal_new_device_headline =
  '{{user}} er begyndt at bruge en ny enhed';
z.string.da.modal_new_device_headline_many =
  '{{user}}s er begyndt at bruge nye enheder';
z.string.da.modal_new_device_headline_you =
  '{{user}} er begyndt at bruge en ny enhed';
...
z.string.da.modal_remove_device_button = 'Fjern enhed';
z.string.da.modal_remove_device_headline = 'Fjern "{{device}}"';
z.string.da.modal_remove_device_message =
  'Din adgangskode er krævet for at fjerne denne enhed.';
z.string.da.modal_session_reset_headline = 'Sessionen er blevet nulstillet';
...
z.string.da.modal_uploads_parallel =
  'Du kan sende op til {{number}} filer på én gang.';

z.string.da.connection_request_connect = 'Forbind';
z.string.da.connection_request_ignore = 'Ignorér';

z.string.da.conversation_you_nominative = 'dig';
z.string.da.conversation_you_dative = 'dig';
z.string.da.conversation_you_accusative = 'dig';

z.string.da.conversation_connection_accepted = 'Forbundet';
z.string.da.conversation_connection_blocked = 'Blokeret';
z.string.da.conversation_connection_cancel_request =
  'Annullér anmodning om forbindelse';
z.string.da.conversation_create = ' startede en samtale med {{users}}';
z.string.da.conversation_create_you = ' startede en samtale med {{users}}';
...
z.string.da.conversation_device_user_devices = ' {{user}}’s enheder';
...
z.string.da.conversation_member_join = ' tilføjede {{users}}';
z.string.da.conversation_member_join_you = ' tilføjede {{users}}';
z.string.da.conversation_member_leave_left = ' forlod';
z.string.da.conversation_member_leave_left_you = ' forlod';
z.string.da.conversation_member_leave_removed = ' fjernede {{users}}';
z.string.da.conversation_member_leave_removed_you = ' fjernede {{users}}';
z.string.da.conversation_message_delivered = 'Leveret';
z.string.da.conversation_rename = ' omdøbte samtalen';
z.string.da.conversation_rename_you = ' omdøbte samtalen';
z.string.da.conversation_resume = 'Start en samtale med {{users}}';
z.string.da.conversation_ping = ' pingede';
z.string.da.conversation_ping_you = ' pingede';
z.string.da.conversation_today = 'i dag';
z.string.da.conversation_verified = 'Bekræftet';
...
z.string.da.conversation_unable_to_decrypt_1 =
  'en besked fra {{user}} blev ikke modtaget.';
z.string.da.conversation_unable_to_decrypt_2 =
  '{{user}}’s enheds identitet er ændret. Uleveret besked.';
...
z.string.da.conversation_asset_upload_too_large =
  'Du kan sende filer med størrelse op til {{number}}';
z.string.da.conversation_playback_error = 'Ikke i stand til at afspille';
z.string.da.conversation_context_menu_edit = 'Redigér';
z.string.da.conversation_context_menu_delete = 'Slet for mig';
z.string.da.conversation_context_menu_delete_everyone = 'Slet for alle';
z.string.da.conversation_context_menu_download = 'Download';
z.string.da.conversation_context_menu_like = 'Synes Om';
z.string.da.conversation_context_menu_unlike = 'Synes Ikke Om';
z.string.da.conversation_delete_timestamp = 'Slettet på {{date}}';
...
z.string.da.conversations_connection_request_many =
  '{{number}} personer venter';
...
z.string.da.conversations_popover_clear = 'Slet';
z.string.da.conversations_popover_leave = 'Forlad';
...
z.string.da.conversations_secondary_line_missed_call =
  '{{number}} ubesvaret opkald';
z.string.da.conversations_secondary_line_missed_calls =
  '{{number}} ubesvarede opkald';
z.string.da.conversations_secondary_line_new_message = '{{number}} ny besked';
z.string.da.conversations_secondary_line_new_messages =
  '{{number}} nye beskeder';
...
z.string.da.invite_message =
  'Jeg er på Wire, søg efter {{username}} eller besøg get.wire.com.';
z.string.da.invite_message_no_email =
  'Jeg er på Wire. Besøg get.wire.com for at forbinde dig med mig.';
...
z.string.da.people_everyone_participates =
  'Alle du er \nforbundet med er allerede i \ndenne samtale.';
z.string.da.people_no_matches =
  'Ingen passende resultater.\nPrøv at indtaste et andet navn.';
...
z.string.da.people_tabs_no_devices_headline =
  '{{user}} bruger en gammel version af Wire. Ingen enheder er vist her.';
z.string.da.people_tabs_device_detail_all_my_devices = 'Vis alle mine enheder';
z.string.da.people_tabs_device_detail_device_fingerprint =
  'Enheds fingeraftryk';
...
z.string.da.people_tabs_device_detail_show_my_device =
  'Vis min enheds fingeraftryk';
z.string.da.people_tabs_device_detail_verify = 'Bekræftet';
z.string.da.people_verified = 'Bekræftet';

z.string.da.people_block_headline = 'Blokér?';
z.string.da.people_block_message =
  '{{user}} vil ikke kunne kontakte dig eller tilføje dig til gruppesamtaler.';

z.string.da.people_connect_headline = 'Acceptér?';
z.string.da.people_connect_message =
  'Dette vil forbinde jer og åbne en samtale med {{user}}.';

z.string.da.people_cancel_request_headline = 'Annuller anmodning?';
z.string.da.people_cancel_request_message =
  'Fjern anmodning om forbindelse til {{user}}.';

z.string.da.people_leave_headline = 'Forlad samtalen?';
z.string.da.people_leave_message =
  'Du vil ikke være i stand til at sende og modtage beskeder i denne samtale.';
...
z.string.da.people_unblock_message =
  '{{user}} vil igen kunne kontakte dig og tilføje dig til gruppesamtaler.';
...
z.string.da.people_button_create = 'Opret gruppe';
z.string.da.people_button_ignore = 'Ignorér';
z.string.da.people_button_leave = 'Forlad';
z.string.da.people_button_open = 'Åben Samtale';
z.string.da.people_button_pending = 'Afventer';
z.string.da.people_button_profile = 'Profil';
z.string.da.people_button_remove = 'Fjern';
z.string.da.people_button_unblock = 'Fjern Blokering';
z.string.da.people_button_no = 'Nej';
z.string.da.people_button_yes = 'Ja';

z.string.da.preferences_about = 'Om';
z.string.da.preferences_account = 'Konto';
z.string.da.preferences_av = 'Lyd / Video';
z.string.da.preferences_device_details = 'Enheds Detaljer';
z.string.da.preferences_devices = 'Enheder';
...
z.string.da.preferences_account_log_out = 'Log ud';
z.string.da.preferences_account_username_placeholder = 'Dit fulde navn';
z.string.da.preferences_account_username_hint =
  'Mindst to tegn. Kun a-z, 0-9 og _.';
z.string.da.preferences_account_username_available = 'Ledig';
z.string.da.preferences_account_username_error_taken = 'Allerede i brug';

z.string.da.preferences_av_camera = 'Kamera';
z.string.da.preferences_av_microphone = 'Mikrofon';
z.string.da.preferences_av_permission_detail =
  'Aktivér fra din browser indstillinger';
z.string.da.preferences_av_speakers = 'Højtalere';
...
z.string.da.preferences_devices_session_confirmation =
  'Sessionen er blevet nulstillet.';
...
z.string.da.preferences_options_audio = 'Lyd advarsler';
z.string.da.preferences_options_audio_all = 'Alle';
z.string.da.preferences_options_audio_all_detail = 'Alle lyde';
z.string.da.preferences_options_audio_none = 'Ingen';
z.string.da.preferences_options_audio_none_detail = 'Sshhh!';
z.string.da.preferences_options_audio_some = 'Nogle';
z.string.da.preferences_options_audio_some_detail = 'Ping og opkald';
...
z.string.da.preferences_options_data_checkbox =
  'Forbrug og rapporter om nedbrud';
z.string.da.preferences_options_data_detail =
  'Gøre Wire bedre ved at sende anonyme oplysninger.';
z.string.da.preferences_options_notifications = 'Notifikationer';
z.string.da.preferences_options_notifications_none = 'Slået Fra';
z.string.da.preferences_options_notifications_obfuscate = 'Skjul detaljer';
z.string.da.preferences_options_notifications_obfuscate_message =
  'Vis afsender';
z.string.da.preferences_options_notifications_on = 'Vis afsender og besked';

z.string.da.search_group_hint =
  'Bliv ved med at skrive eller vælg flere personer for at oprette en gruppe';
z.string.da.search_connect = 'Forbind';
z.string.da.search_connections = 'Forbindelser';
z.string.da.search_groups = 'Grupper';
...
z.string.da.url_support_calling =
  'https://support.wire.com/hc/en-us/articles/202969412';
z.string.da.url_support_device_access_denied =
...
z.string.da.warning_call_detail =
  'Din browser skal have adgang til mikrofonen for at foretage opkald.';
z.string.da.warning_call_headline = 'Kan ikke ringe uden mikrofon';
z.string.da.warning_call_unsupported_incoming =
  '{{user}} ringer. Din browser understøtter ikke opkald.';
z.string.da.warning_call_unsupported_outgoing =
  'Du kan ikke ringe, fordi din browser ikke understøtter opkald.';
z.string.da.warning_call_issues =
  'Denne version af Wire kan ikke deltage i opkaldet. Brug venligst';
z.string.da.warning_call_upgrade_browser =
  'Venligst opdater Google Chrome for at ringe.';
z.string.da.warning_learn_more = 'Lær mere';
z.string.da.warning_not_found_camera =
  'Du kan ikke ringe, fordi din computer har ikke et kamera.';
z.string.da.warning_not_found_microphone =
  'Du kan ikke ringe, fordi din computer har ikke en mikrofon.';
z.string.da.warning_permission_denied_camera =
  'Du kan ikke ringe, fordi din browser ikke har adgang til kameraet.';
z.string.da.warning_permission_denied_microphone =
  'Du kan ikke ringe, fordi din browser ikke har adgang til mikrofonen.';
z.string.da.warning_permission_denied_screen =
  'Din browser skal have tilladelse til at dele din skærm.';
z.string.da.warning_permission_request_camera =
  '{{icon}} Tillad adgang til kamera';
z.string.da.warning_permission_request_microphone =
  '{{icon}} Tillad adgang til mikrofon';
z.string.da.warning_permission_request_notification =
  '{{icon}} Tillad meddelelser';
z.string.da.warning_permission_request_screen =
  '{{icon}} Tillad adgang til skærm';
z.string.da.warning_tell_me_how = 'Fortæl mig hvordan';

z.string.da.warning_connectivity_connection_lost =
  'Forsøger at forbinde. Wire kan muligvis ikke levere beskeder.';
z.string.da.warning_connectivity_no_internet =
  'Ingen Internet. Du vil ikke kunne sende eller modtage beskeder.';
...
z.string.da.system_notification_connection_accepted =
  'Accepterede din anmodning om forbindelse';
...
z.string.da.system_notification_conversation_create =
  '{{user}} startede en samtale';
z.string.da.system_notification_conversation_rename =
  '{{user}} omdøbte samtalen til {{name}}';
z.string.da.system_notification_member_join_many =
  '{{user}} tilføjede {{number}} personer til samtalen';
z.string.da.system_notification_member_join_one =
  '{{user1}} tilføjede {{user2}} til samtalen';
...
z.string.da.tooltip_conversation_all_verified =
  'Alle fingeraftryk er bekræftede';
z.string.da.tooltip_conversation_call = 'Ring op';
z.string.da.tooltip_conversation_ephemeral = 'Tidsbestemt besked';
z.string.da.tooltip_conversation_file = 'Tilføj fil';
...
z.string.da.tooltip_conversations_tooltip_start =
  'Start samtale ({{shortcut}})';

z.string.da.tooltip_people_add = 'Tilføj personer til samtalen ({{shortcut}})';
z.string.da.tooltip_people_back = 'Tilbage';
z.string.da.tooltip_people_block = 'Blokér';
z.string.da.tooltip_people_connect = 'Forbind';
z.string.da.tooltip_people_leave = 'Forlad samtalen';
z.string.da.tooltip_people_open = 'Åbn samtale';
z.string.da.tooltip_people_profile = 'Åbn din profil';
z.string.da.tooltip_people_rename = 'Ændre samtalens navn';
z.string.da.tooltip_people_remove = 'Fjern fra samtale';
z.string.da.tooltip_people_unblock = 'Fjern Blokering';

z.string.da.tooltip_preferences_contacts_gmail =
  'Log ind på din Gmail konto for at dele kontakter';
z.string.da.tooltip_preferences_contacts_macos =
  'Del alle dine kontakter fra macOS Kontakter app';
z.string.da.tooltip_preferences_password =
  'Åbn en anden hjemmeside for at nulstille din adgangskode';
z.string.da.tooltip_preferences_picture = 'Ændre dit billede…';
z.string.da.tooltip_preferences_rename = 'Ændre dit navn';
...
z.string.da.init_events_progress =
  'Indlæser beskeder - {{number1}} af {{number2}}';
