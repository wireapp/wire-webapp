...
z.string.da.alert_upload_too_large = 'Dette billede er for stort. Du kan uploade filer op til %no MB.';
z.string.da.alert_gif_too_large = 'Animationen er for stor. Den maksimale størrelse er %no MB.';
...
z.string.da.auth_error_password_short = 'Vælg en adgangskode på mindst 8 karakterer.';
z.string.da.auth_error_password_wrong = 'Forkert adgangskode. Prøv igen.';
z.string.da.auth_error_phone_number_forbidden = 'Beklager. Dette telefonnummer er ikke tilladt.';
...
z.string.da.modal_call_conversation_full_headline = 'For mange personer at ringe til';
z.string.da.modal_call_conversation_full_message = 'Opkald virker i samtaler med op til %no personer.';
z.string.da.modal_call_no_video_in_group_headline = 'Ingen video opkald i grupper';
z.string.da.modal_call_no_video_in_group_message = 'Video opkald er ikke tilgængelig i gruppe samtaler.';
z.string.da.modal_call_second_incoming_headline = 'Besvar opkald?';
z.string.da.modal_call_second_incoming_message = 'Dit nuværende opkald vil afsluttes.';
...
z.string.da.modal_call_second_ongoing_message = 'Du kan kun være i et opkald af gangen.';
...
z.string.da.modal_call_voice_channel_full_message = 'Der er kun plads til %no personer herinde.';
...
z.string.da.modal_connected_device_message = 'Hvis du ikke gjorde dette, slet enheden og nulstil din adgangskode.';
...
z.string.da.modal_too_long_message = 'Du kan sende beskeder på op til %no tegn.';
z.string.da.modal_leave_conversation_headline = 'Forlad "%@.name" samtale?';
z.string.da.modal_leave_conversation_message = 'Deltagerne vil få besked og samtalen fjernet fra din liste.';
...
z.string.da.modal_remove_device_message = 'Din adgangskode er krævet for at fjerne denne enhed.';
...
z.string.da.conversation_unable_to_decrypt_1 = 'en besked fra %@name blev ikke modtaget.';
z.string.da.conversation_unable_to_decrypt_2 = '%@name’s enheds identitet er ændret. Uleveret besked.';
...
z.string.da.conversation_asset_upload_too_large = 'Du kan sende filer med størrelse op til %no';
...
z.string.da.people_no_matches = 'Ingen passende resultater.\nPrøv at indtaste et andet navn.';
...
z.string.da.people_tabs_no_devices_headline = '%@.name bruger en gammel version af Wire. Ingen enheder er vist her.';
...
z.string.da.people_connect_message = 'Dette vil forbinde jer og åbne en samtale med %@.first_name.';

z.string.da.people_cancel_request_headline = 'Annuller anmodning?';
z.string.da.people_cancel_request_message = 'Fjern anmodning om forbindelse til %@.first_name.';
...
z.string.da.preferences_account_username_hint = 'Mindst to tegn. Kun a-z, 0-9 og _.';
...
z.string.da.preferences_av_permission_detail = 'Aktivér fra din browser indstillinger';
...
z.string.da.warning_call_unsupported_incoming = '%s.first_name ringer. Din browser understøtter ikke opkald.';
...
z.string.da.system_notification_member_join_many = '%s.first_name tilføjede %no personer til samtalen';
z.string.da.system_notification_member_join_one = '%s.first_name tilføjede %@.first_name til samtalen';
z.string.da.system_notification_member_leave_left = '%s.first_name forlod samtalen';
z.string.da.system_notification_member_leave_removed_many = '%s.first_name fjernede %no personer fra samtalen';
z.string.da.system_notification_member_leave_removed_one = '%s.first_name fjernede %@.first_name fra samtalen';
...
z.string.da.tooltip_preferences_contacts_gmail = 'Log ind på din Gmail konto for at dele kontakter';
z.string.da.tooltip_preferences_contacts_macos = 'Del alle dine kontakter fra macOS Kontakter app';
z.string.da.tooltip_preferences_password = 'Åbn en anden hjemmeside for at nulstille din adgangskode';
