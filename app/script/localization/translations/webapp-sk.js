...
z.string.sk.modalSessionResetMessage_1 = 'Ak problém nebol vyriešený,';
z.string.sk.modalSessionResetMessageLink = 'kontakt';
z.string.sk.modalSessionResetMessage_2 = 'nás.';
...
z.string.sk.conversationUnableToDecrypt_1 = 'správa od {{user}} nebola prijatá.';
z.string.sk.conversationUnableToDecrypt_2 = '{{user}}´s zariadenie sa zmenilo. Nedoručená správa.';
...
z.string.sk.inviteHintSelected = 'Stlačte {{metaKey}} + C pre kopírovanie';
z.string.sk.inviteHintUnselected = 'Vyberte a stlačte {{metaKey}} + C';
...
z.string.sk.peopleButtonAddPeople = 'Pridať ľudí';
