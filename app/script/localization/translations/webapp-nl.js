...
z.string.nl.modalSessionResetMessage_1 = 'Als het probleem niet is opgelost, ';
z.string.nl.modalSessionResetMessageLink = 'contact';
z.string.nl.modalSessionResetMessage_2 = 'ons.';
...
z.string.nl.conversationUnableToDecrypt_1 = 'een bericht van {{user}} is niet ontvangen.';
z.string.nl.conversationUnableToDecrypt_2 = '{{user}}’s apparaatidentiteit is veranderd. Het bericht is niet afgeleverd.';
...
z.string.nl.inviteHintSelected = 'Toets {{metaKey}} + C om te kopiëren';
z.string.nl.inviteHintUnselected = 'Selecteer en toets {{metaKey}} + C';
...
z.string.nl.peopleButtonAddPeople = 'Contacten toevoegen';
