...
z.string.ru.conversationCreatedMore = '[bold]{{name}}[/bold] начал(а) разговор с {{users}} и [showmore]еще {{count}}[/showmore]';
...
z.string.ru.conversationCreatedYouMore = 'Вы начали разговор с {{users}} и [showmore]еще {{count}}[/showmore]';
z.string.ru.conversationCreateWithMore = 'с {{users}} и [showmore]еще {{count}}[/showmore]';
...
z.string.ru.conversationMemberJoinedMore = '[bold]{{name}}[/bold] добавил(а) {{users}} и [showmore]еще {{count}}[/showmore] к разговору';
z.string.ru.conversationMemberJoinedYouMore = '[bold]Вы[/bold] добавили {{users}} и [showmore]еще {{count}}[/showmore] к разговору';
...
z.string.ru.conversationUpdatedTimerYou = ' установить таймер сообщения на {{time}}';
z.string.ru.conversationResetTimer = ' отключить таймер сообщения';
z.string.ru.conversationResetTimerYou = ' отключить таймер сообщения';
...
z.string.ru.preferencesOptionsCallLogsDetail = 'Эта информация помогает службе поддержки Wire диагностировать проблемы, связанные со звонками.';
