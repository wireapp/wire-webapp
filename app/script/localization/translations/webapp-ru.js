...
z.string.ru.modalSessionResetMessage_1 = 'Если проблема не решена,';
z.string.ru.modalSessionResetMessageLink = 'cвяжитесь';
z.string.ru.modalSessionResetMessage_2 = 'с нами.';
...
z.string.ru.conversationUnableToDecrypt_1 = 'сообщение от {{user}} не было получено.';
z.string.ru.conversationUnableToDecrypt_2 = 'Идентификатор устройства {{user}} изменился. Сообщение не доставлено.';
...
z.string.ru.conversationsPopoverSilence = 'Откл. уведомления';
...
z.string.ru.preferencesOptionsData = 'Отчеты о сбоях и использовании';
z.string.ru.preferencesOptionsDataCheckbox = 'Отчеты о сбоях и использовании';
z.string.ru.preferencesOptionsDataDetail = 'Сделайте Wire лучше, отправляя анонимную информацию.';
