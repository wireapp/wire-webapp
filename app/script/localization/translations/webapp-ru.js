...
z.string.ru.auth_posted_offline_detail = 'Пожалуйста, проверьте подключение к интернету и повторите попытку.';
z.string.ru.auth_posted_offline_headline = 'Wire лучше, когда в сети.';
z.string.ru.auth_posted_pending_detail = 'Проверьте ваш почтовый ящик или повторите процедуру активации.';
z.string.ru.auth_posted_pending_headline = 'Учетная запись уже ожидает верификации';
...
z.string.ru.auth_posted_retry = 'Попробовать еще раз и отправить письмо на {{email}}';
...
z.string.ru.auth_error_email_forbidden = 'Извините, этот адрес электронной почты запрещен.';
...
z.string.ru.auth_error_misc = 'Проблемы с подключением. Пожалуйста, попробуйте еще раз.';
...
z.string.ru.modal_call_no_video_in_group_headline = 'В группах нет видеозвонков';
z.string.ru.modal_call_no_video_in_group_message = 'Видеозвонки недоступны в групповых беседах.';
z.string.ru.modal_call_second_incoming_headline = 'Ответить на звонок?';
z.string.ru.modal_call_second_incoming_message = 'Ваш текущий звонок будет завершен.';
z.string.ru.modal_call_second_incoming_action = 'Ответить';
z.string.ru.modal_call_second_ongoing_headline = 'Завершить звонок на другом устройстве?';
z.string.ru.modal_call_second_ongoing_message = 'Вы можете одновременно участвовать только в одном звонке.';
...
z.string.ru.modal_clear_conversation_headline = 'Удалить историю разговоров с "{{user}}"?';
...
z.string.ru.modal_connected_device_message = 'Если это были не Вы, удалите устройство и измените ваш пароль.';
...
z.string.ru.modal_too_long_message = 'Вы можете отправлять сообщения длиной до {{number}} символов.';
z.string.ru.modal_leave_conversation_headline = 'Покинуть разговор "{{user}}"?';
z.string.ru.modal_leave_conversation_message = 'Участники будут уведомлены и разговор будет удален из вашего списка.';
...
z.string.ru.modal_new_device_headline = '{{user}} начал(а) использовать новое устройство';
z.string.ru.modal_new_device_headline_many = '{{user}}s начали использовать новые устройства';
z.string.ru.modal_new_device_headline_you = '{{user}} начал(а) использовать новое устройство';
...
z.string.ru.conversation_device_user_devices = 'Устройства, принадлежащие {{user}}';
...
z.string.ru.conversation_unable_to_decrypt_1 = 'сообщение от {{user}} не было получено.';
z.string.ru.conversation_unable_to_decrypt_2 = 'Идентификатор устройства {{user}} изменился. Сообщение не доставлено.';
...
z.string.ru.conversation_asset_upload_too_large = 'Вы можете отправлять файлы размером до {{number}}';
...
z.string.ru.people_no_matches = 'Совпадений не найдено.\nПопробуйте ввести другое имя.';
...
z.string.ru.people_tabs_device_detail_device_fingerprint = 'Отпечаток устройства';
...
z.string.ru.people_block_message = '{{user}} больше не сможет связаться с вами или добавить вас в групповые разговоры.';

z.string.ru.people_connect_headline = 'Принять?';
z.string.ru.people_connect_message = 'Это подключит вас и откроет разговор с {{user}}.';

z.string.ru.people_cancel_request_headline = 'Отменить запрос?';
z.string.ru.people_cancel_request_message = 'Удалить запрос на добавление {{user}}.';

z.string.ru.people_leave_headline = 'Покинуть разговор?';
z.string.ru.people_leave_message = 'Вы больше не сможете отправлять и получать сообщения в этом разговоре.';

z.string.ru.people_remove_headline = 'Удалить?';
z.string.ru.people_remove_message = '{{user}} больше не сможет отправлять и получать сообщения в этом разговоре.';
...
z.string.ru.preferences_devices_active_detail = 'Если не распознаете устройство выше, удалите его и измените пароль.';
...
z.string.ru.url_support_calling = 'https://support.wire.com/hc/en-us/articles/202969412';
z.string.ru.url_support_camera_access_denied = 'https://support.wire.com/hc/en-us/articles/202935412';
z.string.ru.url_support_device_access_denied = 'https://support.wire.com/hc/en-us/articles/213512545';
z.string.ru.url_support_contact = 'https://support.wire.com/hc/en-us/requests/new';
z.string.ru.url_support_contact_bug = 'https://support.wire.com/hc/en-us/requests/new?ticket_form_id=101615';
z.string.ru.url_support_history = 'https://support.wire.com/hc/en-us/articles/207834645';
z.string.ru.url_support_mic_access_denied = 'https://support.wire.com/hc/en-us/articles/202590081';
...
z.string.ru.warning_call_unsupported_incoming = '{{user}} звонит. Ваш браузер не поддерживает звонки.';
z.string.ru.warning_call_unsupported_outgoing =
  'Не удается совершить звонок, потому что ваш браузер не поддерживает звонки.';
z.string.ru.warning_call_issues = 'Эта версия Wire не может участвовать в звонке. Пожалуйста, используйте';
z.string.ru.warning_call_upgrade_browser = 'Для совершения звонков, пожалуйста, обновите Google Chrome.';
z.string.ru.warning_learn_more = 'Подробнее';
z.string.ru.warning_not_found_camera = 'Не удается совершить звонок, потому что у вас нет видеокамеры.';
...
z.string.ru.tooltip_preferences_contacts_macos = 'Поделиться всеми контактами из приложения macOS Контакты';
