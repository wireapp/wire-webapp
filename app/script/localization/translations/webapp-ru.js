...
z.string.ru.authErrorPending = 'Аккаунт пока не подтвержден';
...
z.string.ru.authErrorSignIn = 'Проверьте свои данные и повторите попытку.';
...
z.string.ru.modalCallNoMicrophoneMessage = 'Для совершения звонков вашему браузеру необходим доступ к микрофону.';
...
z.string.ru.modalServiceUnavailableMessage = 'В данный момент эта служба недоступна.';
...
z.string.ru.conversationCreateYou = ' начали разговор с {{users}}';
...
z.string.ru.conversationMemberJoinYou = ' добавили {{users}}';
...
z.string.ru.conversationMemberLeaveLeftYou = ' покинули';
z.string.ru.conversationMemberLeaveRemoved = ' удалил(а) {{users}}';
z.string.ru.conversationMemberLeaveRemovedYou = ' удалили {{users}}';
...
z.string.ru.conversationUpdatedTimer = ' установить таймер сообщения на {{time}}';
z.string.ru.conversationResetTimer = ' отключить таймер сообщения';
...
z.string.ru.groupSizeInfo = 'К групповому разговору может присоединиться до {{count}} участников. Видеозвонки возможны между вами и еще тремя участниками.';

z.string.ru.guestRoomConversationName = 'Гостевая комната';
z.string.ru.guestRoomToggleName = 'Разрешить гостей';
...
z.string.ru.inviteMessage = 'Я в Wire, ищи меня там по нику {{username}} или зайди на сайт get.wire.com.';
...
z.string.ru.addParticipantsTabsServices = 'Службы';
...
z.string.ru.conversationDetailsParticipantsServicesOne = 'Служба';
z.string.ru.conversationDetailsParticipantsServicesMany = 'Службы';
...
z.string.ru.conversationDetailsServices = 'Службы';
...
z.string.ru.preferencesOptionsCallLogsGet = 'Сохранить технический отчет о звонке';
z.string.ru.preferencesOptionsCallLogsDetail = 'Эта информация помогает поддержке Wire диагностировать проблемы, связанные со звонками.';
...
z.string.ru.searchServices = 'Службы';
...
z.string.ru.temporaryGuestDescription = 'Защитите свой бизнес шифрованными групповыми сообщениями и звонками.';
...
z.string.ru.warningCallUpgradeBrowser = 'Для совершения звонков обновите Google Chrome.';
...
z.string.ru.warningNotFoundCamera = 'Не удается позвонить, так как компьютер не имеет камеры.';
z.string.ru.warningNotFoundMicrophone = 'Не удается позвонить, так как компьютер не имеет микрофона.';
z.string.ru.warningPermissionDeniedCamera = 'Не удается позвонить, так как ваш браузер не имеет доступа к камере.';
z.string.ru.warningPermissionDeniedMicrophone = 'Не удается позвонить, так как ваш браузер не имеет доступа к микрофону.';
...
z.string.ru.notificationMemberJoinOne = '{{user1}} добавил(а) {{user2}} в разговор';
