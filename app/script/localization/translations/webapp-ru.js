...
z.string.ru.people_tabs_devices_headline = 'Wire даёт каждому устройству уникальный отпечаток. Сравните их с %@.name, чтобы верифицировать разговор.';
...
z.string.ru.people_tabs_device_detail_headline = 'Убедитесь, что этот отпечаток соответствует отпечатку, показанному на устройстве %bold%@.name%end.';
