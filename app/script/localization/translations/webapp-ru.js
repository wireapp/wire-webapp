...
z.string.ru.modal_block_conversation_message =
  '%@.name больше не сможет связаться с вами или добавить вас в групповые разговоры.';
...
z.string.ru.modal_too_long_message =
  'Вы можете отправлять сообщения длиной до %no символов.';
z.string.ru.modal_leave_conversation_headline = 'Покинуть разговор "%@.name"?';
...
z.string.ru.modal_new_device_headline =
  '%@.name начал(а) использовать новое устройство';
z.string.ru.modal_new_device_headline_many =
  '%@.names начали использовать новые устройства';
...
z.string.ru.modal_remove_device_headline = 'Удалить "%device_name"';
...
z.string.ru.modal_too_many_members_message =
  'К разговору может присоединиться до %max человек. Здесь хватит места ещё для %no человек.';
z.string.ru.modal_uploads_parallel =
  'Вы можете отправить до %no файлов за раз.';
...
z.string.ru.conversation_member_join_you = ' добавил(а) %@names';
z.string.ru.conversation_member_leave_left = ' покинул(а)';
z.string.ru.conversation_member_leave_left_you = ' покинул(а)';
z.string.ru.conversation_member_leave_removed = ' удалил(а) %@names';
z.string.ru.conversation_member_leave_removed_you = ' удалил(а) %@names';
...
z.string.ru.conversation_unable_to_decrypt_1 =
  'сообщение от %@name не было получено.';
z.string.ru.conversation_unable_to_decrypt_2 =
  'Идентификатор устройства %@name изменился. Сообщение не доставлено.';
...
z.string.ru.conversation_asset_upload_too_large =
  'Вы можете отправлять файлы размером до %no';
...
z.string.ru.people_tabs_devices_headline =
  'Wire даёт каждому устройству уникальный отпечаток. Сравните их с %@.name, чтобы верифицировать разговор.';
z.string.ru.people_tabs_devices_why_verify = 'Зачем верифицировать разговоры?';
z.string.ru.people_tabs_no_devices_headline =
  '%@.name использует устаревшую версию Wire. Устройства не отображаются.';
...
z.string.ru.people_tabs_device_detail_headline =
  'Убедитесь, что этот отпечаток соответствует отпечатку, показанному на устройстве %bold%@.name%end.';
...
z.string.ru.people_remove_message =
  '%@.first_name больше не сможет отправлять и получать сообщения в этом разговоре.';

z.string.ru.people_unblock_headline = 'Разблокировать?';
z.string.ru.people_unblock_message =
  '%@.first_name вновь сможет связываться с вами и добавлять вас в групповые разговоры.';
...
z.string.ru.preferences_devices_activated_on = 'Активирован %time';
...
z.string.ru.warning_call_unsupported_incoming =
  '%s.first_name звонит. Ваш браузер не поддерживает звонки.';
...
z.string.ru.system_notification_conversation_create =
  '%s.first_name начал разговор';
z.string.ru.system_notification_conversation_rename =
  '%s.first_name переименовал разговор на %name';
...
z.string.ru.tooltip_conversations_archived = 'Показать архив (%no)';
