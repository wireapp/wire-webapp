...
z.string.ru.modal_call_conversation_full_headline = 'Слишком много людей для группового звонка';
z.string.ru.modal_call_conversation_full_message = 'Звонки работают в разговорах до %no участников.';
...
z.string.ru.modal_call_voice_channel_full_message = 'Здесь хватит места только для %no человек.';
z.string.ru.modal_clear_conversation_headline = 'Удалить историю разговоров с "%@.name"?';
...
z.string.ru.modal_too_long_message = 'Вы можете отправлять сообщения длиной до %no символов.';
...
z.string.ru.conversation_unable_to_decrypt_1 = 'сообщение от %@name не было получено.';
z.string.ru.conversation_unable_to_decrypt_2 = 'Идентификатор устройства %@name изменился. Сообщение не доставлено.';
...
z.string.ru.conversation_asset_upload_too_large = 'Вы можете отправлять файлы размером до %no';
...
z.string.ru.people_tabs_no_devices_headline = '%@.name использует устаревшую версию Wire. Устройства не отображаются.';
...
z.string.ru.people_connect_message = 'Это подключит вас и откроет разговор с %@.first_name.';

z.string.ru.people_cancel_request_headline = 'Отменить запрос?';
z.string.ru.people_cancel_request_message = 'Удалить запрос на добавление %@.first_name.';
...
z.string.ru.people_remove_message = '%@.first_name больше не сможет отправлять и получать сообщения в этом разговоре.';
...
z.string.ru.warning_call_unsupported_incoming = '%s.first_name звонит. Ваш браузер не поддерживает звонки.';
...
z.string.ru.system_notification_member_join_many = '%s.first_name добавил %no человек(а) в разговор';
z.string.ru.system_notification_member_join_one = '%s.first_name добавил %@.first_name в разговор';
