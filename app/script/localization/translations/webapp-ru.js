...
z.string.ru.modalAccountNewDevicesMessage = 'Если это были не вы, удалите это устройство и измените пароль.';
...
z.string.ru.modalImproveWireSecondary = 'Не сейчас';
z.string.ru.modalImproveWireHeadline = 'Помогите нам сделать Wire лучше';
z.string.ru.modalImproveWireMessage = 'Отправка анонимных отчетов об использовании и сбоях помогает нам улучшать наши продукты и сервисы. Мы не используем эту информацию ни для чего другого.';
...
z.string.ru.conversationDeviceStartedUsingMany = ' начал(а) использовать';
z.string.ru.conversationDeviceUnverified = ' деверифицировал(а) одно из';
...
z.string.ru.conversationMemberJoin = ' добавил(а) {{users}}';
z.string.ru.conversationMemberJoinYou = ' добавил(а) {{users}}';
z.string.ru.conversationMemberJoinSelf = ' присоединился';
z.string.ru.conversationMemberJoinSelfYou = ' присоединился';
z.string.ru.conversationMemberLeaveLeft = ' покинул(а)';
z.string.ru.conversationMemberLeaveLeftYou = ' покинул(а)';
z.string.ru.conversationMemberLeaveRemoved = ' удалил(а) {{users}}';
z.string.ru.conversationMemberLeaveRemovedYou = ' удалил(а) {{users}}';
z.string.ru.conversationMessageDelivered = 'Доставлено';
z.string.ru.conversationRename = ' переименовал(а) разговор';
z.string.ru.conversationRenameYou = ' переименовал(а) разговор';
z.string.ru.conversationResume = 'Начать разговор с {{users}}';
z.string.ru.conversationTeamLeave = ' был удален из команды';
...
z.string.ru.conversationUnableToDecrypt1 = 'сообщение от {{user}} не было получено.';
z.string.ru.conversationUnableToDecrypt2 = 'Идентификатор устройства {{user}} изменился. Сообщение не доставлено.';
...
z.string.ru.groupCreationPreferencesHeader = 'Новая группа';
...
z.string.ru.conversationsAllArchived = 'Все разговоры отправлены в архив';
...
z.string.ru.inviteHintUnselected = 'Выделите и нажмите {{metaKey}} + C';
...
z.string.ru.preferencesDeviceDetails = 'Настройки устройства';
z.string.ru.preferencesDevices = 'Устройства';
z.string.ru.preferencesHeadline = 'Настройки';
...
z.string.ru.preferencesAccountData = 'Разрешение на использование данных';
...
z.string.ru.preferencesAccountMarketingConsentDetail = 'Получайте новости и обновления от Wire по электронной почте.';
...
z.string.ru.preferencesAccountUsernameHint = 'Минимум 2 символа. Только a–z, 0–9 и _';
...
z.string.ru.preferencesOptionsAudioSomeDetail = 'Пинги и звонки';
...
z.string.ru.preferencesOptionsContactsDetail = 'Мы используем ваши контактные данные, чтобы соединить вас с другими пользователями. Мы анонимизируем всю информацию и не делимся ей с кем-либо еще.';
...
z.string.ru.searchTrySearch = 'Найдите людей по имени\nили имени пользователя';
...
z.string.ru.notificationSharedAudio = 'Поделился(-лась) аудио сообщением';
...
z.string.ru.notificationVoiceChannelActivate = 'Звонит';
...
z.string.ru.tooltipConversationPeople = 'Люди ({{shortcut}})';
...
z.string.ru.tooltipConversationVideoCall = 'Видеозвонок';
