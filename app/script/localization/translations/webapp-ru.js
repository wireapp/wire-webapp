...
z.string.ru.auth_posted_change_email = 'Изменить email';
z.string.ru.auth_posted_offline_detail = 'Проверьте подключение к интернету и повторите попытку.';
z.string.ru.auth_posted_offline_headline = 'Wire лучше, когда в сети.';
z.string.ru.auth_posted_pending_detail = 'Проверьте ваш email или повторите процедуру активации.';
...
z.string.ru.conversation_ping_you = ' отправили пинг';
...
z.string.ru.people_tabs_devices_headline = 'Wire дает каждому устройству уникальный отпечаток. Сравните их с {{user}}, чтобы верифицировать разговор.';
