...
z.string.hu.alert_upload_too_large = 'A kép mérete túl nagy. Maximális fájl méret {{number}} MB.';
z.string.hu.alert_gif_too_large = 'Animáció mérete túl nagy. Maximális méret {{number}} MB.';
...
z.string.hu.modal_clear_conversation_headline = 'Törli a tartalmat?';
...
z.string.hu.modal_new_device_headline_many = '{{user}}s elkezdtek használni új eszközöket';
z.string.hu.modal_new_device_headline_you = '"{{user}} elkezdett használni egy új eszközt';
...
z.string.hu.conversation_asset_upload_too_large = 'Fájlokat küldhet akár {{number}}';
...
z.string.hu.conversations_secondary_line_person_removed = '{{user}} eltávolított';
z.string.hu.conversations_secondary_line_people_added = '{{user}} partnerek lettek hozzáadva';
z.string.hu.conversations_secondary_line_person_added = '{{user}} hozzáadott';
z.string.hu.conversations_secondary_line_person_added_you = '{{user}} hozzáadta Önt';
...
z.string.hu.conversations_secondary_line_you_were_removed = 'Ön eltávolította';
...
z.string.hu.people_cancel_request_message = 'Távolítsa el {{user}} a csatlakozási kérelmet.';
...
z.string.hu.preferences_options_emoji_replace_checkbox = 'Cserélje ki a hangulatjeleket emojikra';
z.string.hu.preferences_options_previews_send_checkbox = 'Készítsen előnézetet az elküldendő linkeknek';
z.string.hu.preferences_options_previews_send_detail = 'Más partnerektől kapott linkek előnézeti képe továbbra is látható lesz.';
...
z.string.hu.system_notification_conversation_create = '{{user}} megkezdett egy beszélgetést';
...
z.string.hu.system_notification_member_join_one = '{{user1}} hozzáadta {{user2}} a beszélgetéshez';
