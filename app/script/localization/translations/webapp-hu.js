...
z.string.hu.modalNewDeviceHeadlineYou = '{{user}} elkezdtél használni egy új eszközt';
...
z.string.hu.modalSessionResetMessage_1 = 'Ha a probléma továbbra is fennáll,';
z.string.hu.modalSessionResetMessageLink = 'lépj kapcsolatba';
z.string.hu.modalSessionResetMessage_2 = 'velünk.';
...
z.string.hu.conversationYouDative = 'neked';
z.string.hu.conversationYouAccusative = 'téged';
...
z.string.hu.conversationCreateYou = ' beszélgetést kezdtél a következőkkel: {{users}}';
z.string.hu.conversationDeviceStartedUsingOne = ' elkezdett használni';
z.string.hu.conversationDeviceStartedUsingMany = ' elkezdtek használni';
...
z.string.hu.conversationMemberJoinYou = ' hozzáadtad a következőket: {{users}}';
z.string.hu.conversationMemberLeaveLeft = ' kilépett';
z.string.hu.conversationMemberLeaveLeftYou = ' kiléptél';
z.string.hu.conversationMemberLeaveRemoved = ' eltávolította a következőket: {{users}}';
z.string.hu.conversationMemberLeaveRemovedYou = ' eltávolítottad a következőket: {{users}}';
z.string.hu.conversationMessageDelivered = 'Kézbesítve';
z.string.hu.conversationRename = ' átnevezte a beszélgetést';
z.string.hu.conversationRenameYou = ' átnevezted a beszélgetést';
...
z.string.hu.conversationPingYou = ' kopogtál';
...
z.string.hu.conversationVoiceChannelDeactivateYou = ' hívást kezdeményeztél';
z.string.hu.conversationYesterday = 'Tegnap';
z.string.hu.conversationUnableToDecrypt_1 = 'egy üzenetet nem kaptál meg tőle: {{user}}.';
z.string.hu.conversationUnableToDecrypt_2 = '{{user}} eszközének azonosítója megváltozott. Kézbesítetlen üzenet.';
