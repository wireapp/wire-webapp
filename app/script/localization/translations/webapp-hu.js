...
z.string.hu.alert_upload_too_large =
  'A kép mérete túl nagy. Maximális fájl méret {{number}} MB.';
z.string.hu.alert_gif_too_large =
  'Animáció mérete túl nagy. Maximális méret {{number}} MB.';
...
z.string.hu.auth_verify_code_resend_timer =
  'Kérhet egy új kódot {{expiration}}.';
...
z.string.hu.auth_posted_retry =
  'Próbálkozzon újra és küldjön levelet {{email}}';
...
z.string.hu.modal_clear_conversation_headline =
  'Biztosan törli "{{user}}" beszélgetés tartalmát?';
...
z.string.hu.modal_too_long_message =
  'Ön {{number}} karakter hosszú üzenetet küldhet.';
z.string.hu.modal_leave_conversation_headline =
  'Elhagyja "{{user}}" beszélgetését?';
...
z.string.hu.modal_new_device_headline =
  '"{{user}} elkezdett használni egy új eszközt';
z.string.hu.modal_new_device_headline_many =
  '{{user}}s elkezdtek használni új eszközöket';
...
z.string.hu.modal_remove_device_headline = 'Távolítsa el "{{device}}"';
...
z.string.hu.conversation_create = ' megkezdett egy beszélgetést {{users}}';
z.string.hu.conversation_create_you = ' megkezdett egy beszélgetést {{users}}';
...
z.string.hu.conversation_device_user_devices = ' {{user}} eszközei';
...
z.string.hu.conversation_member_join = ' felvette {{users}}';
z.string.hu.conversation_member_join_you = ' felvette {{users}}';
...
z.string.hu.conversation_member_leave_removed = ' eltávolította {{users}}';
z.string.hu.conversation_member_leave_removed_you = ' eltávolította {{users}}';
...
z.string.hu.conversation_resume = 'Beszélgetés megkezdése vele: {{users}}';
...
z.string.hu.conversation_unable_to_decrypt_1 =
  'egy üzenetet tőle: {{user}} nem kapott meg.';
z.string.hu.conversation_unable_to_decrypt_2 =
  '{{user}} eszköz azonosítója megváltozott. Kézbesítetlen üzenet.';
...
z.string.hu.conversation_asset_upload_too_large =
  'Fájlokat küldhet akár {{number}}';
...
z.string.hu.conversation_delete_timestamp = '{{date}} törölve';
...
z.string.hu.collection_show_all = 'Összes megjelenítése {{number}}';
...
z.string.hu.conversations_connection_request_many =
  '{{number}} partner várakozik';
...
z.string.hu.people_remove_message =
  '{{user}} nem tud üzenetet küldeni és fogadni ebben a beszélgetésben.';
...
z.string.hu.warning_call_unsupported_incoming =
  '{{user}} hívja. Böngészője nem támogatja a hívásokat.';
...
z.string.hu.system_notification_conversation_create =
  '{{user}} megkezdett egy beszélgetést';
z.string.hu.system_notification_conversation_rename =
  '{{user}} átnevezte a beszélgetést erre {{name}}';
z.string.hu.system_notification_member_join_many =
  '{{user}} hozzáadott {{number}} partnert a beszélgetéshez';
z.string.hu.system_notification_member_join_one =
  '{{user1}} hozzáadta {{user2}} a beszélgetéshez';
z.string.hu.system_notification_member_leave_removed_you =
  '{{user}} eltávolította a beszélgetést';
...
z.string.hu.tooltip_conversations_archived =
  'Archívum megtekintése ({{number}})';
...
z.string.hu.init_received_self_user = 'Helló, {{user}}.';
...
z.string.hu.init_events_progress =
  'Üzenetek betöltése - {{number1}} {{number2}}';
