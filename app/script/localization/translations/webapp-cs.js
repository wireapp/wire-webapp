...
z.string.cs.modal_call_conversation_full_headline =
  'Příliš mnoho lidí pro volání';
z.string.cs.modal_call_conversation_full_message =
  'Volání přes konverzace funguje až do %no lidí.';
...
z.string.cs.modal_call_voice_channel_full_message =
  'Je zde místo pouze pro %no lidí.';
...
z.string.cs.modal_too_long_message =
  'Můžete posílat zprávy dlouhé až %no znaků.';
...
z.string.cs.conversation_unable_to_decrypt_1 =
  'zpráva od uživatele %@name nebyla přijata.';
z.string.cs.conversation_unable_to_decrypt_2 =
  'Identita uživatele %@name se změnila. Zpráva nedoručena.';
...
z.string.cs.conversation_asset_upload_too_large =
  'Můžete posílat soubory až do velikosti %no';
...
z.string.cs.conversations_no_conversations =
  'Zahájit konverzaci nebo přizvat další osoby.';
...
z.string.cs.people_remove_message =
  '%@.first_name nebude moci odesílat nebo přijímat zprávy v této konverzaci.';
...
z.string.cs.warning_call_unsupported_incoming =
  'Volá %s.first_name. Tento prohlížeč nepodporuje volání.';
...
z.string.cs.system_notification_conversation_create =
  '%s.first_name zahájil(a) rozhovor';
z.string.cs.system_notification_conversation_rename =
  '%s.first_name přejmenoval(a) rozhovor na %name';
z.string.cs.system_notification_member_join_many =
  '%s.first_name přidal(a) %no kontakty do konverzace';
z.string.cs.system_notification_member_join_one =
  '%s.first_name přidal(a) %@.first_name do konverzace';
z.string.cs.system_notification_member_leave_left =
  '%s.first_name opustil(a) konverzaci';
z.string.cs.system_notification_member_leave_removed_many =
  '%s.first_name odebral(a) %no kontaktů z konverzace';
z.string.cs.system_notification_member_leave_removed_one =
  '%s.first_name odstranil(a) %@.first_name z konverzace';
