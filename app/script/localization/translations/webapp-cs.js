...
z.string.cs.modalSessionResetMessage_1 = 'Pokud problém není vyřešen,';
z.string.cs.modalSessionResetMessageLink = 'kontaktujte';
z.string.cs.modalSessionResetMessage_2 = 'nás.';
...
z.string.cs.conversationUnableToDecrypt_1 = 'zpráva od uživatele {{user}} nebyla přijata.';
z.string.cs.conversationUnableToDecrypt_2 = 'Identita uživatele {{user}} se změnila. Zpráva nedoručena.';
...
z.string.cs.inviteHintSelected = 'Stiskněte {{metaKey}} + C pro kopírování';
z.string.cs.inviteHintUnselected = 'Vybrat a stisknout {{metaKey}} + C';
...
z.string.cs.peopleButtonAddPeople = 'Přidat kontakty';
