...
z.string.uk.preferences_devices_remove_detail = 'Видаліть цей пристрій, якщо ви більше не використовуєте його. Вашу історію повідомлень буде стерто на цьому пристрої, і ви повернетесь до діалогу вводу імені та паролю.'
...
z.string.uk.preferences_options_camera = 'Камера'
...
z.string.uk.preferences_options_microphone = 'Мікрофон'
...
z.string.uk.preferences_options_speakers = 'Гучномовець'
...
z.string.uk.warning_permission_denied_screen = 'Ви не можете поділитися скріншотами робочого столу, тому що ви не надали доступу до цієї функції в налаштуваннях вашого браузера.'
