...
z.string.es.auth_account_sign_in_email = 'Correo electrónico'
...
#Authentication: Misc
z.string.es.auth_placeholder_email = 'Correo electrónico'
...
z.string.es.modal_block_conversation_message = '%@.name no podrá ponerse en contacto con usted o invitarlo a una conversación de grupo.'
...
z.string.es.conversation_device_started_using = ' comenzaste a utilizar'
z.string.es.conversation_device_started_using_you = ' comenzaste a utilizar'
...
z.string.es.conversation_device_a_new_device = ' un nuevo dispositivo'
...
z.string.es.invite_detail = 'El enlace será válido para 2 semanas.'
...
z.string.es.people_tabs_devices_headline = 'Wire proporciona a cada dispositivo una huella digital única. Comparala con %@ y verifica tu conversación.'
...
z.string.es.people_tabs_device_detail_headline = 'Verifica que esta coincida con la huella digital que se muestra en el %bold%dispositivo de @.name's%end.'
...
z.string.es.people_block_message = '%@.first_name no podrá encontrarte o entrar en contacto contigo por Wire.'
...
z.string.es.people_unblock_message = '%@.first_name será capaz de encontrarte y entrar en contacto contigo por Wire otra vez. También recibirás mensajes de ellos mientras estén bloqueados.'
...
z.string.es.preferences_devices_remove_detail = 'Eliminar este dispositivo si ha dejado de usarlo. Se borrará el historial de mensajes y será desconectado.'
...
z.string.es.preferences_options_sound = 'Alertas de sonido'
z.string.es.preferences_options_sound_all = 'Todo'
z.string.es.preferences_options_sound_all_detail = 'Todos los sonidos'
z.string.es.preferences_options_sound_none = 'Ninguno'
z.string.es.preferences_options_sound_none_detail = 'Sshhh!'
z.string.es.preferences_options_sound_some = 'Algunos'
z.string.es.preferences_options_sound_some_detail = 'Pings y llamadas'
...
z.string.es.warning_permission_denied_screen = 'No puedes compartir tu pantalla porque el navegador no tiene acceso.'
