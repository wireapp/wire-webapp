...
z.string.ru.preferences_devices_remove_detail = 'Удалите это устройство, если Вы прекратили им пользоваться. История сообщений будет стерта, и Вы выйдите из аккаунта.'
