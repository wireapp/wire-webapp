...
z.string.fi.invite_detail = 'Linkkiä voidaan käyttää 2 viikkoa.'
...
z.string.fi.preferences_options_sound = 'Äänimerkit'
z.string.fi.preferences_options_sound_all = 'Kaikki'
z.string.fi.preferences_options_sound_all_detail = 'Kaikki äänet'
z.string.fi.preferences_options_sound_none = 'Ei mitään'
z.string.fi.preferences_options_sound_none_detail = 'Sshhh!'
z.string.fi.preferences_options_sound_some = 'Jotain'
z.string.fi.preferences_options_sound_some_detail = 'Pingit ja puhelut'
