...
z.string.fi.preferences_devices_remove_detail = 'Poista tämä laite jos olet lopettanut sen käyttämisen. Viestihistoriasi poistetaan ja sinut kirjataan ulos.'
