...
z.entity.DecryptErrorMessage = class DecryptErrorMessage extends z.entity.Message {
  ...
  constructor() {
    ...
    this.link = ko.pureComputed(() => {
      const string_id = this.is_remote_identity_changed() ? z.config.URL_PATH.DECRYPT_ERROR_2 : z.config.URL_PATH.DECRYPT_ERROR_1;
      return z.util.URLUtil.build_url(z.util.URLUtil.TYPE.WEBSITE, z.l10n.text(string_id));
    });
