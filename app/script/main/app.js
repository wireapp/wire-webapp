...
z.main.App = class App {
  ...
  _setupRepositories() {
    ...
    const serviceMiddleware = new z.event.preprocessor.ServiceMiddleware(repositories.user);
    const eventPreprocessors = [serviceMiddleware.processEvent.bind(serviceMiddleware)];
