...
import bazinga64 from '../../ext/js/bazinga64/bazinga64.js';
import lruCache from '../../ext/js/@wireapp/lru-cache/dist/lru-cache.bundle.js';
import priorityQueue from '../../ext/js/@wireapp/priority-queue/dist/priority-queue.bundle.js';
import dexie from '../../ext/js/dexie/dexie.js';
import dexieBatch from '../../ext/js/dexie-batch/dist/dexie-batch.js';
import storeEngine from '../../ext/js/@wireapp/store-engine/dist/store-engine.bundle.js';
import jquery from '../../ext/js/jquery/jquery.js';
...
import adapter from '../../ext/js/webrtc-adapter/adapter.js';
import amplify from '../../ext/js/amplify/amplify.js';
import antiscroll2 from '../../ext/js/antiscroll-2/antiscroll-2.js';
import highlight from '../../ext/js/highlightjs/highlight.pack.js';
import jsCookie from '../../ext/js/js-cookie/js.cookie.js';
import keyboard from '../../ext/js/keyboardjs/keyboard.js';
import knockout from '../../ext/js/knockout/knockout.debug.js';
...
import pakoDeflate from '../../ext/js/pako/pako_deflate.js';
...
import underscore from '../../ext/js/underscore/underscore.js';
import uuid from '../../ext/js/uuid.js/uuid.js';
...
import ByteBufferAB from '../../ext/js/bytebuffer/ByteBufferAB.js';
...
import markedGlobal from '../util/marked.js';
import MessageComparatorGlobal from '../util/MessageComparator.js';
import momentGlobal from '../util/moment.js';
