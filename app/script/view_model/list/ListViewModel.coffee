...
class z.ViewModel.list.ListViewModel
  ...
  ###
  constructor: (element_id, @call_view_model, @content_view_model, @connect_repository, @conversation_repository, @search_repository, @user_repository, @properties_repository) ->
    ...
    @conversations = new z.ViewModel.list.ConversationListViewModel 'conversations', @, @call_view_model, @content_view_model, @conversation_repository, @user_repository
