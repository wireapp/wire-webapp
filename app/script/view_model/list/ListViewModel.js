  ...
  */
  constructor(element_id, content_view_model, calling_repository, connect_repository, conversation_repository, search_repository, properties_repository, team_repository) {
    ...
    this.visible_list_items = ko.pureComputed(() => {
      ...
      return this.conversation_repository.conversations_calls().concat(connect_requests, this.conversation_repository.conversations_unarchived());
    });
  ...
  _iterate_active_conversation(reverse) {
    const is_connection_request_state = this.content_view_model.content_state() === z.ViewModel.content.CONTENT_STATE.CONNECTION_REQUESTS;
    ...
    const next_conversation_item = z.util.ArrayUtil.iterate_item(this.visible_list_items(), active_conversation_item, reverse);
