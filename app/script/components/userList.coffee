                    ...
                    <!-- ko if: $parent.mode === z.components.UserListMode.INFO -->
                      <div class="search-list-item-content-info">
                        ...
                        <!-- ko if: !$data.connected() && $data.mutual_friends_total() > 0 -->
                          <span class="search-list-item-content-friends ellipsis" data-bind="attr: {'data-ui-common-friends': mutual_friends_total()}, text: $parent.get_common_contacts_caption($data)"></span>
                        <!-- /ko -->
                      </div>
                    <!-- /ko -->
                  </div>
