  ...
  template: """
            <!-- ko ifnot: message_et.is_expired() -->
              ...
              <div class="link-preview-info">
                ...
                <a class="link-preview-info-link text-graphite label-nocase-xs ellipsis" data-uie-name="link-preview-url" target="_blank" rel="nofollow noopener noreferrer"
            ...
            <!-- ko if: message_et.is_expired() -->
              ...
              <div class="link-preview-info">
                ...
                <a class="link-preview-info-link label-nocase-xs ephemeral-message-obfuscated ellipsis" target="_blank" rel="nofollow noopener noreferrer"
