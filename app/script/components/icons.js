...
ko.components.register('timer-icon', {
  ...
  <svg width="15" height="16" viewBox="0 0 15 16">
    <path d="M7.5 2v1.08a6.5 6.5 0 1 1-2 0V2H5a1 1 0 1 1 0-2h3a1 1 0 1 1 0 2h-.5zm-1 12a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9zm0-1a3.5 3.5 0 0 1 0-7v3.5l2.48 2.47A3.49 3.49 0 0 1 6.5 13zm6.62-10.3l.7.71a1 1 0 0 1-1.4 1.42l-.71-.7a1 1 0 0 1 1.41-1.42z"></path>
  </svg>
  `,
});
