...
z.components.Availability = class Availability {
  constructor(params) {
    this.user = ko.unwrap(params.user);
  }
};

// Knockout registration of the availability component.
ko.components.register('availability', {
  template: `
    <!-- ko if: $data.availability() ===  -->
    ...
    <!-- /ko -->
  `,
  viewModel: z.components.Availability,
});
