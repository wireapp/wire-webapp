...
ko.components.register('availability-state', {
  template: `
      <!-- ko if: $data.availability() === z.user.AvailabilityType.AVAILABLE -->
        <svg data-uie-name="available" class="availability-icon" viewBox="0 0 10 10" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <circle cx="5" cy="5" r="5" stroke="none"></circle>
        </svg>
      <!-- /ko -->
      <!-- ko if: $data.availability() === z.user.AvailabilityType.AWAY -->
        <svg data-uie-name="away" class="availability-icon" viewBox="0 0 10 10" version="1.1" xmlns="http://www.w3.org/2000/svg">
          <circle cx="5" cy="5" r="4" stroke-width="1" fill="none"></circle>
        </svg>
      <!-- /ko -->
      <!-- ko if: $data.availability() === z.user.AvailabilityType.BUSY -->
        <svg data-uie-name="busy" class="availability-icon" viewBox="0 0 30 30" version="1.1" xmlns="http://www.w3.org/2000/svg">
