...
import {ClearContentModal} from './webapp/modals/clearContent.modal';
...
export class PageManager {
  ...
  public webapp = {
    ...
    modals: {
      ...
      clearContent: () => this.getOrCreate('webapp.modals.clearContent', () => new ClearContentModal(this.page)),
    },
    components: {
