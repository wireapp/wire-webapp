...
describe 'z.entity.User', ->
  ...
  describe 'picture_preview_url', ->
    it 'can generate a picture preview url', ->
      ...
      window.wire = auth: client: client_service

      picture_preview = ''
      expect(user_et.picture_preview_url()).toBe picture_preview

      picture_preview_url = "https://prod-nginz-https.wire.com/assets/bf4bc4c1-b295-4c0f-af0b-9db335cc64be?access_token=#{client_service.access_token}&conv_id=#{user_et.id}"
  ...
  describe 'picture_medium_url', ->
    it 'can generate a picture medium url', ->
      ...
      picture_medium_url = "https://prod-nginz-https.wire.com/assets/bf4bc4c1-b295-4c0f-af0b-9db335cc64be?access_token=#{client_service.access_token}&conv_id=#{user_et.id}"
