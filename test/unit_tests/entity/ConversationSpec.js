...
describe('Conversation', function() {
  ...
  describe('connection', function() {
    it('updates the participating user IDs with the user ID of the connector', function() {
      // @formatter:off
      /* eslint-disable comma-spacing, key-spacing, sort-keys, quotes */
      const payload_connection = {"status":"sent","conversation":"15a7f358-8eba-4b8e-bcf2-61a08eb53349","to":"b43b376d-7b5a-4d77-89be-81a02892db8c","from":"616cbbeb-1360-4e17-b333-e000662257bd","last_update":"2017-05-10T11:34:18.396Z","message":" "};
