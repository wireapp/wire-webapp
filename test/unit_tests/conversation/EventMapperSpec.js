...
describe('Event Mapper', () => {
  ...
  describe('mapJsonEvent', () => {
    ...
    it('skips messages which cannot be mapped', () => {
      // prettier-ignore
      /* eslint-disable comma-spacing, key-spacing, sort-keys, quotes */
      const good_message = {"conversation":conversationEt.id,"id":"4cec0f75-d963-486d-9401-415240ac2ad8","from":"532af01e-1e24-4366-aacf-33b67d4ee376","time":"2016-08-04T15:12:12.453Z","data":{"content":"Message with timestamp","nonce":"4cec0f75-d963-486d-9401-415240ac2ad8","previews":[]},"type":"conversation.message-add"};
      // prettier-ignore
      const bad_message = {"conversation":conversationEt.id,"id":"aeac8355-739b-4dfc-a119-891a52c6a8dc","from":"532af01e-1e24-4366-aacf-33b67d4ee376","data":{"content":"Knock, are you there? :)","nonce":"aeac8355-739b-4dfc-a119-891a52c6a8dc"},"type":"conversation.message-add"};
      /* eslint-enable comma-spacing, key-spacing, sort-keys, quotes */

      return event_mapper.mapJsonEvents([good_message, bad_message], conversationEt).then(messageEntities => {
  ...
  describe('_mapAssetImage', () => {
    it('detects a malformed asset key', () => {
      ...
      const assetEt = event_mapper._mapAssetImage(event, true);
  ...
  describe('_mapEventUnableToDecrypt', () => {
    it('maps a message from a decrypt error event', () => {
      ...
      const messageEt = event_mapper._mapEventUnableToDecrypt(event);
