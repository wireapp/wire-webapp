...
describe('z.message.MessageCategorization', function() {
  describe('category_from_event', function() {
    it('malformed events should have category of type UNDEFINED', function() {
      expect(z.message.MessageCategorization.category_from_event()).toBe(
        z.message.MessageCategory.UNDEFINED
      );
    });
    ...
    it('ephemeral message should have category of type NONE', function() {
      ...
      const category = z.message.MessageCategorization.category_from_event(
        JSON.parse(event)
      );
    ...
    it('text message with link should have category of type TEXT and LINK', function() {
      ...
      expect(category & z.message.MessageCategory.TEXT).toBe(
        z.message.MessageCategory.TEXT
      );
      expect(category & z.message.MessageCategory.LINK).toBe(
    ...
    it('text message with like should have category of type TEXT and LIKED', function() {
      ...
      expect(category & z.message.MessageCategory.LIKED).toBe(
        z.message.MessageCategory.LIKED
      );
    });
    ...
    it('image (gif) message should have category of type IMAGE and GIF', function() {
      ...
      expect(category & z.message.MessageCategory.IMAGE).toBe(
        z.message.MessageCategory.IMAGE
      );
      expect(category & z.message.MessageCategory.GIF).toBe(
        z.message.MessageCategory.GIF
      );
    });
