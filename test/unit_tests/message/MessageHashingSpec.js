...
describe('z.message.MessageHashing', () => {
  ...
  describe('getTextMessageHash', () => {
    it('correctly creates a markdown text bytes buffer.', async () => {
      ...
      const hashArray = await z.message.MessageHashing.getTextMessageHash(messageEntity);
  ...
  describe('getLocationMessageHash', () => {
    it('correctly creates a location bytes buffer.', async () => {
      ...
      const hashArray = await z.message.MessageHashing.getLocationMessageHash(messageEntity);
      const hashValue = z.util.StringUtil.bytesToHex(hashArray);
  ...
  describe('getAssetMessageHash', () => {
    it('correctly creates an asset bytes buffer.', async () => {
      ...
      const hashArray = await z.message.MessageHashing.getAssetMessageHash(messageEntity);
      const hashValue = z.util.StringUtil.bytesToHex(hashArray);
