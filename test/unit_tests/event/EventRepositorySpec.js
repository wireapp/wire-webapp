...
describe('Event Repository', function() {
  ...
  let websocket_service_mock = (function() {
  ...
  beforeEach(done =>
    ...
    .then(function(event_repository) {
      ...
      notification_service.get_last_notification_id_from_db = function() {
      ...
      notification_service.save_last_notification_id_to_db = () => Promise.resolve(z.event.NotificationService.prototype.PRIMARY_KEY_LAST_NOTIFICATION);
  ...
  describe('update_from_notification_stream', function() {
    beforeEach(function() {
      ...
      return spyOn(notification_service, 'get_last_notification_id_from_db').and.callThrough();
    });
    ...
    it('should skip fetching notifications if last notification ID not found in storage', function(done) {
      ...
      return event_repository.initialize_from_notification_stream()
      .then(function() {
    ...
    it('should buffer notifications when notification stream is not processed', function() {
      ...
      return expect(event_repository.web_socket_buffer.length).toBe(1);
    });

    return it('should handle buffered notifications after notifications stream was processed', function(done) {
      last_notification_id = z.util.create_random_uuid();
      let last_published_notification_id = z.util.create_random_uuid();
  ...
  describe('_handle_notification', function() {
    ...
    beforeEach(function() {
      last_notification_id = z.util.create_random_uuid();
      return event_repository.last_notification_id(last_notification_id);
    });

    it('should not update last notification id if transient is true', function(done) {
      let notification_payload = {id: z.util.create_random_uuid(), payload: [], transient: true};

      return event_repository._handle_notification(notification_payload).then(() => {
    ...
    it('should update last notification id if transient is false', function(done) {
      let notification_payload = {id: z.util.create_random_uuid(), payload: [], transient: false};
    ...
    return it('should update last notification id if transient is not present', function(done) {
      let notification_payload = {id: z.util.create_random_uuid(), payload: []};
  ...
  return describe('_handle_event', function() {
    beforeEach(function() {
      ...
      return spyOn(event_repository, '_distribute_event');
    });
    ...
    it('skips outdated "conversation.message-add" events arriving', function(done) {
      // @formatter:off
      let event = {"conversation":"9fe8b359-b9e0-4624-b63c-71747664e4fa","time":"2016-08-05T16:18:41.820Z","data":{"content":"Hello","nonce":"1cea64c5-afbe-4c9d-b7d0-c49aa3b0a53d"},"from":"532af01e-1e24-4366-aacf-33b67d4ee376","id":"74f.800122000b2d7182","type":"conversation.message-add"};
      // @formatter:on

      return event_repository._handle_event(event)
    ...
    it('skips outdated "conversation.knock" events', function(done) {
      // @formatter:off
      let event = {"data":{"nonce":"33a16765-2b23-42a1-b1cc-414d1baa9095"},"from":"d794bf14-96a0-43e9-be95-ae761d1acb4e","time":"2015-12-21T10:14:59.661Z","id":"a2b.800122000ad94450","type":"conversation.knock","conversation":"872eaa34-9673-44af-abaa-e1b6979a7cff"};
      // @formatter:on
    ...
    it('accepts conversation.rename events', function(done) {
      // @formatter:off
      let event = {"conversation":"64dcb45f-bf8d-4eac-a263-649a60d69305","time":"2016-08-09T11:57:37.498Z","data":{"name":"Renamed"},"from":"532af01e-1e24-4366-aacf-33b67d4ee376","id":"7.800122000b2f7cca","type":"conversation.rename"};
      // @formatter:on
    ...
    it('accepts conversation.member-join events', function(done) {
      // @formatter:off
      let event = {"conversation":"64dcb45f-bf8d-4eac-a263-649a60d69305","time":"2016-08-09T12:01:14.688Z","data":{"user_ids":["e47bfafa-03dc-43ed-aadb-ad6c4d9f3d86"]},"from":"532af01e-1e24-4366-aacf-33b67d4ee376","id":"8.800122000b2f7d20","type":"conversation.member-join"};
      // @formatter:on
    ...
    it('accepts conversation.member-leave events', function(done) {
      // @formatter:off
      let event = {"conversation":"64dcb45f-bf8d-4eac-a263-649a60d69305","time":"2016-08-09T12:01:56.363Z","data":{"user_ids":["e47bfafa-03dc-43ed-aadb-ad6c4d9f3d86"]},"from":"532af01e-1e24-4366-aacf-33b67d4ee376","id":"9.800122000b3d69bc","type":"conversation.member-leave"};
      // @formatter:on
    ...
    it('accepts conversation.voice-channel-deactivate (missed call) events', function(done) {
      // @formatter:off
      let event = {"conversation":"64dcb45f-bf8d-4eac-a263-649a60d69305","time":"2016-08-09T12:09:28.294Z","data":{"reason":"missed"},"from":"0410795a-58dc-40d8-b216-cbc2360be21a","id":"16.800122000b3d4ade","type":"conversation.voice-channel-deactivate"};
      // @formatter:on
