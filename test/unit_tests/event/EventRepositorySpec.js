...
describe('Event Repository', function() {
  ...
  describe('_handle_event', function() {
    ...
    it('skips outdated "conversation.asset-add" events', function(done) {
      ...
      const event = {
        data: {
          data: '/9j/4AAQSkZJRgABAQAAAQABAAD/.../Z',
          content_type: 'image/jpeg',
          id: '01c86ab7-4d38-4a4e-8e7e-e6d73a3c2b94',
          content_length: 1218,
          info: {
            original_width: 1094,
            public: true,
            width: 49,
            correlation_id: '48aa1bd4-fbb1-4cdc-bbbc-7160dc4d032e',
    ...
    it('skips outdated "conversation.knock" events', function(done) {
      /* eslint-disable comma-spacing, key-spacing, sort-keys, quotes */
      const event = {
        data: {nonce: '33a16765-2b23-42a1-b1cc-414d1baa9095'},
        from: 'd794bf14-96a0-43e9-be95-ae761d1acb4e',
