...
import {CurrentAvailableDeviceId} from 'src/script/media/MediaDevicesHandler';
...
describe('MediaStreamHandler', () => {
  let streamHandler: MediaStreamHandler | undefined;
  ...
  const mediaConstraintsHandler = new MediaConstraintsHandler(
    availableDevices as unknown as CurrentAvailableDeviceId,
