...
describe('MediaEmbeds', () => {
  ...
  const testLinkVariants = (site: string, regex: RegExp) => {
    ...
    expect(`https://${site}.com/`.match(regex)).toBe(null);
    expect(`${site}.com`.match(regex)).toBe(null);
    expect(`${site}.com/`.match(regex)).toBe(null);
    expect(`http://m.${site}.com`.match(regex)).toBe(null);
    expect(`http://m.${site}.com/`.match(regex)).toBe(null);
    expect(`https://m.${site}.com`.match(regex)).toBe(null);
    expect(`https://m.${site}.com/`.match(regex)).toBe(null);
    expect(`m.${site}.com`.match(regex)).toBe(null);
    expect(`m.${site}.com/`.match(regex)).toBe(null);
