...
window.OpenGraphMocks = {
  getHeiseMock: function() {
    return {
      ...
      image: {
        url:
          'http://www.heise.de/imgs/18/1/8/5/1/3/4/6/PIA20707-68c99730783b54fb.jpeg'
      },
      locale: 'de_DE',
      ...
      type: 'website',
      url:
        'http://www.heise.de/newsticker/meldung/Jupiter-Sonde-Juno-Das-erste-Foto-aus-dem-Orbit-3265536.html'
    };
  },
  ...
  getWireMock: function() {
    return {
      ...
      title:
        'Wire · Modern communication, full privacy. For iOS, Android, macOS, Windows and web.',
      type: 'website',
      url: 'https://wire.com/'
    };
  }
