...
z.string.ru.conversationsSecondaryLineEphemeralMentionGroup = 'Вас упомянули';
...
z.string.ru.notificationSettingsDisclaimer = 'Вы можете получать уведомления обо всем (включая аудио- и видеозвонки) или только когда вы были упомянуты.';
z.string.ru.notificationSettingsEverything = 'Все';
z.string.ru.notificationSettingsOnlyMentions = 'Только упоминания';
...
z.string.ru.warningCallUnsupportedOutgoing = 'Вы не можете позвонить, потому что ваш браузер не поддерживает вызовы.';
...
z.string.ru.warningNotFoundCamera = 'Вы не можете позвонить, потому что ваш компьютер нет имеет камеры.';
z.string.ru.warningNotFoundMicrophone = 'Вы не можете позвонить, потому что ваш компьютер нет имеет микрофона.';
z.string.ru.warningPermissionDeniedCamera = 'Вы не можете позвонить, потому что ваш браузер не имеет доступа к камере.';
z.string.ru.warningPermissionDeniedMicrophone = 'Вы не можете позвонить, потому что ваш браузер не имеет доступа к микрофону.';
...
z.string.ru.tooltipConversationsSilence = 'Выключить уведомления ({{shortcut}})';
