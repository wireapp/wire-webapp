...
export class Configuration {
  ...
  readonly OIDC_OAUTH_AUTHORIZATION_URI = env.OIDC_OAUTH_AUTHORIZATION_URI;
  readonly OIDC_OAUTH_CLIENT_ID = env.OIDC_OAUTH_CLIENT_ID;
  readonly OIDC_OAUTH_CLIENT_SECRET = env.OIDC_OAUTH_CLIENT_SECRET;
  readonly OIDC_OAUTH_TOKEN_URI = env.OIDC_OAUTH_TOKEN_URI;
  readonly URL = {
