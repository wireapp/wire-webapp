...
export class CallError extends Error {
  static readonly TYPE = CallErrorType;
  static readonly MESSAGE: Record<CallErrorType, string> = {
  ...
  readonly type: CallErrorType;

  constructor(type: CallErrorType, message?: string) {
    super();

    this.name = this.constructor.name;
    this.stack = new Error().stack;
    this.type = type;
    this.message = message || CallError.MESSAGE[type];
  }
}
