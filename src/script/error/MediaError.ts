...
export class MediaError extends Error {
  static readonly TYPE = MediaErrorType;
  static readonly MESSAGE: Record<MediaErrorType, string> = {
  ...
  constructor(type: MediaErrorType, message?: string) {
    super();

    this.name = this.constructor.name;
    this.stack = new Error().stack;
    this.type = type;
    this.message = message || MediaError.MESSAGE[type];
  }
}
