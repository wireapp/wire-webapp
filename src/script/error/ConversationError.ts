...
export class ConversationError extends Error {
  static readonly TYPE = ConversationErrorType;
  static readonly MESSAGE: Record<ConversationErrorType, string> = {
  ...
  constructor(type: ConversationErrorType, message?: string) {
    super();

    this.name = this.constructor.name;
    this.stack = new Error().stack;
    this.type = type;
    this.message = message || ConversationError.MESSAGE[type];
  }
}
