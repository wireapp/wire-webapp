...
const FullscreenVideoCall: React.FC<FullscreenVideoCallProps> = ({
  ...
  const {setElementToHide} = useHideElement(FullscreenVideoCallConfig.HIDE_CONTROLS_TIMEOUT, 'video-controls__button');
  ...
  return (
    <div id="video-calling" className="video-calling" ref={setElementToHide}>
