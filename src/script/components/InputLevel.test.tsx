...
import InputLevel, {InputLevelProps, MAX_AUDIO_BULLETS} from 'Components/InputLevel';
...
class InputLevelTestPage extends TestPage<InputLevelProps> {
  ...
  getActiveInputLevelBullets = () => this.get('li[data-uie-name="input-level-bullet-active"]');
}
