...
export const createConversationHeaderBtnGroupCss: CSSObject = {display: 'flex', gap: '8px'};
...
export const confirmConversationHeaderCss: CSSObject = {textAlign: 'center'};
export const confirmConversationTextCss: CSSObject = {margin: '1rem 0'};
export const confirmConversationButtonContainerCss: CSSObject = {gap: '0.5rem'};
...
export const createConversationStepRightContainerCss: CSSObject = {margin: '1rem 1.5rem', flex: 1};

// ParticipantsSelection§
export const participantsSelectionSearchCss = {margin: '20px'};
...
// CustomHistorySharingOption
export const customHistorySharingOptionContainerCss: CSSObject = {justifyContent: 'space-between'};
export const customHistorySharingOptionLeftSectionCss: CSSObject = {gap: '0.5rem'};
export const customHistorySharingOptionIconCss: CSSObject = {height: '24px', width: '9px'};
...
export const salesModalBodyCss: CSSObject = {display: 'flex', padding: '24px', flexDirection: 'column'};
export const salesModalBodyWrapperCss: CSSObject = {maxWidth: '66%'};
export const salesModalBodyHeaderCss: CSSObject = {color: 'var(--white)'};
export const salesModalBodyTextCss: CSSObject = {margin: '0.5rem 0', color: 'var(--white)'};
...
export const customHistorySharingFormContainerCss: CSSObject = {gap: '0.5rem', marginTop: '1rem'};
export const customHistorySharingButtonContainerCss: CSSObject = {gap: '0.5rem'};
export const customHistorySharingInputCss: CSSObject = {width: '5rem'};
export const customHistorySharingSelectCss: CSSObject = {display: 'block'};
export const customHistorySharingButtonCss: CSSObject = {flex: 1, margin: 0};
