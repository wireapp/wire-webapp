...
describe('UserHandleGenerator', () => {
  ...
  describe('validate_character', () => {
    ...
    it('returns false if character is not a string', () => {
      expect(validateCharacter(undefined as unknown as string)).toBeFalsy();
      expect(validateCharacter(null as unknown as string)).toBeFalsy();
      expect(validateCharacter({} as unknown as string)).toBeFalsy();
      expect(validateCharacter(1 as unknown as string)).toBeFalsy();
    });
  ...
  describe('validate_handle', () => {
    ...
    it('returns false for invalid handles', () => {
      ...
      expect(validateHandle('')).toBeFalsy();
      expect(validateHandle(1 as unknown as string)).toBeFalsy();
