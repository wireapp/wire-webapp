...
const ListWrapper = forwardRef<HTMLElement, LeftListWrapperProps>(
  ({id, header, sidebar, headerElement, onClose, children, hasHeader = true, footer, before, headerUieName}, ref) => {
