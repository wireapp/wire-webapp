...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'cells.restoreNodeModal.file.description': `This file {name} will be restored and available again to everyone in this conversation.`;
    'cells.restoreNodeModal.folder.description': `This folder {name} will be restored with all its contents and available again to everyone in this conversation.`;
