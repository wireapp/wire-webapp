...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'cells.newItemMenuModal.headlineFile': `New empty file`;
    'cells.newItemMenuModal.headlineFolder': `New folder`;
    'cells.newItemMenuModal.label': `Name`;
    'cells.newItemMenuModal.placeholderFile': `Empty file.txt`;
    'cells.newItemMenuModal.placeholderFolder': `Empty folder name`;
    ...
    'cells.error.description': `We couldn\'t load your files. Please try again later.`;
    'cells.error.heading': `Something went wrong`;
    'cells.heading': `All Files`;
    'cells.imageFullScreenModal.closeButton': `Close`;
    'cells.noFiles.description': `You\'ll find all files shared across your conversations here.`;
    'cells.noFiles.heading': `There are no files yet`;
    ...
    'cells.search.placeholder': `Search files`;
    'cells.shareFileModal.copyLink': `Copy link`;
    'cells.shareFileModal.disablePublicLink': `Disable public link`;
    'cells.shareFileModal.disablePublicLink.description': `Disable public link`;
    'cells.shareFileModal.enablePublicLink': `Create public link`;
    'cells.shareFileModal.enablePublicLink.description': `Upload and share your file via a public link. All recipients can view and download it.`;
    'cells.shareFileModalError.loadingLink': `Something went wrong, please try again later.`;
    'cells.shareFileModal.generatedPublicLink': `Generated public link`;
    'cells.shareFileModal.heading': `Share file via link`;
    'cells.shareFileModal.linkCopied': `Link copied`;
    'cells.shareFileModal.primaryAction': `Done`;
    'cells.tableRow.actions': `Actions`;
    'cells.tableRow.conversationName': `Conversation Name`;
    ...
    'cells.moveNodeModal.createFolder.hintText': `Cant find a suitable folder?`;
    'cells.moveNodeModal.createTitle': `Create folder`;
    'cells.moveNodeModal.emptyList': `There are no subfolders in this folder.`;
    'cells.moveNodeModal.moveButton': `Move here`;
    'cells.moveNodeModal.moveTitle': `Move to folder`;
    'cells.newItemMenu.button': `New`;
    'cells.newItemMenu.file': `Create an empty file`;
    'cells.newItemMenu.folder': `Create a folder`;
    'cells.recycleBin.breadcrumb': `Recycle bin`;
    'cells.recycleBin.moreMenu': `Open Recycle Bin`;
    'cells.restore.error': `Something went wrong, please try again later and refresh the list.`;
    'cells.restoreNodeModal.button': `Restore`;
    'cells.restoreNodeModal.file.headline': `Restore file?`;
    'cells.restoreNodeModal.folder.headline': `Restore folder?`;
    'cells.restoreNodeModal.file.description': `This file {name} will be restored and available to everyone in this conversation.`;
    'cells.restoreNodeModal.folder.description': `This folder {name} will be restored with all its contents and available to everyone in this conversation.`;
    ...
    'conversationDetailsGroupAdminInfo': `When this is on, the admin can add or remove people and services, update group settings, and change a participant’s role.`;
    ...
    'guestRoomConversationBadgeExternalAndGuestAndService': `[bold]Externals[/bold], [bold]guests[/bold], and [bold]services[/bold] are present`;
    'guestRoomConversationBadgeExternalAndService': `[bold]Externals[/bold] and [bold]services[/bold] are present`;
    ...
    'guestRoomConversationBadgeFederatedAndExternalAndGuestAndService': `[bold]Federated users[/bold], [bold]Externals[/bold], [bold]guests[/bold], and [bold]services[/bold] are present`;
    'guestRoomConversationBadgeFederatedAndExternalAndService': `[bold]Federated users[/bold], [bold]Externals[/bold] and [bold]services[/bold] are present`;
    'guestRoomConversationBadgeFederatedAndGuest': `[bold]Federated users[/bold] and [bold]Guests[/bold] as present`;
    'guestRoomConversationBadgeFederatedAndGuestAndService': `[bold]Federated users[/bold], [bold]Guests[/bold] and [bold]services[/bold] are present`;
    'guestRoomConversationBadgeFederatedAndService': `[bold]Federated users[/bold] and [bold]Services[/bold] are active`;
    'guestRoomConversationBadgeGuestAndService': `[bold]Guests[/bold] and [bold]services[/bold] are present`;
    'guestRoomConversationBadgeService': `[bold]Services[/bold] are active`;
    ...
    'modalConversationOptionsDisableServiceMessage': `Could not remove services. Please try again.`;
    ...
    'servicesRoomToggleInfoExtended': `Open this conversation to services. You can always change it later.`;
    'servicesRoomToggleName': `Allow Services`;
