...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'cellsDeletePermanentlyModal.fileDescription': `This will permanently delete the file {name} for all participants.`;
    'cellsDeletePermanentlyModal.folderDescription': `This will permanently delete the folder {name} and its contents for all participants.`;
    'cellsDeletePermanentlyModal.headline': `Delete permanently?`;
    ...
    'cellsMoveToRecycleBinModal.folderDescription': `The folder {name} and its contents will move to this conversation\'s recycling bin.`;
