...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'index.disclaimer': `This is NOT WIRE but an internal testing environment. Authorized for use by Wire employees only. Any public USE is PROHIBITED. The data of the users of this test environment is extensively recorded and analysed. To use the secure messenger Wire, please visit {link}`;
    ...
    'preferencesAccountTypingIndicatorsDetail': `When this is off, you won’t be able to see when other people are typing, and others won’t see when you are typing. This setting applies to all conversations on this device.`;
