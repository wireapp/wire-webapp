...
declare module 'I18n/en-US.json' {
  const translations: {
    ...
    'cameraStatusOff': `off`;
    'cameraStatusOn': `on`;
    'cellsDeletePermanentlyModal.button': `Delete`;
    'cellsDeletePermanentlyModal.fileDescription': `The file {name} will move to this conversation\'s recycling bin.`;
    'cellsDeletePermanentlyModal.folderDescription': `The folder {name} will move to this conversation\'s recycling bin.`;
    'cellsDeletePermanentlyModal.fileHeadline': `Delete file?`;
    'cellsDeletePermanentlyModal.folderHeadline': `Delete folder?`;
    'cellsMoveToRecycleBinModal.button': `Delete`;
    'cellsMoveToRecycleBinModal.fileDescription': `The file {name} will move to this conversation\'s recycling bin.`;
    'cellsMoveToRecycleBinModal.folderDescription': `The folder {name} will move to this conversation\'s recycling bin.`;
    'cellsMoveToRecycleBinModal.fileHeadline': `Delete file?`;
    'cellsMoveToRecycleBinModal.folderHeadline': `Delete folder?`;
    ...
    'cellsRestoreNodeModal.fileDescription': `This file {name} will be restored and available to everyone in this conversation.`;
    'cellsRestoreNodeModal.folderDescription': `This folder {name} will be restored with all its contents and available to everyone in this conversation.`;
