...
Run `yarn start` and Wire's web app will be available at: http://localhost:8888/login/#login

To login with your existing Wire account use: http://localhost:8888/login/?env=prod#login
