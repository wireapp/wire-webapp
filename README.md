...
1. Verify you have a `keys/crowdin.yaml` in place with your [username](https://crowdin.com/settings#account), your [Account API Key](https://crowdin.com/settings#api-key).
