...
1. Add string variable to "src/script/strings.ts" (source for the React part of our app) and text to "src/i18n/en-US.json" (source for the Knockout part of our app)
